...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.УправлениеДоступом") Тогда
		...
		// УНФ
		Элементы.ОграничиватьДоступНаУровнеЗаписейУниверсально.Видимость = ПроизводительныйВариантУНФ();
		// Конец УНФ
...
Процедура ОграничиватьДоступНаУровнеЗаписейПриИзмененииЗавершение(Ответ, Элемент) Экспорт
	...
	Если Не НаборКонстант.ОграничиватьДоступНаУровнеЗаписей Тогда
		// УНФ
		Если НаборКонстант.ИспользоватьГруппыДоступаКонтрагентов Тогда
			НаборКонстант.ИспользоватьГруппыДоступаКонтрагентов = Ложь;
			Подключаемый_ПриИзмененииРеквизита(Элементы.ИспользоватьГруппыДоступаКонтрагентов);
		КонецЕсли;
		Если НаборКонстант.ИспользоватьГруппыДоступаЛидов Тогда
			НаборКонстант.ИспользоватьГруппыДоступаЛидов = Ложь;
			Подключаемый_ПриИзмененииРеквизита(Элементы.ИспользоватьГруппыДоступаЛидов);
		КонецЕсли;
		// Конец УНФ
	КонецЕсли;
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ОграничиватьДоступНаУровнеЗаписей" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ГруппаОграниченияДоступаНаУровнеЗаписейУНФКонтрагенты.Доступность = ЕстьДоступность;
		Элементы.ГруппаОграниченияДоступаНаУровнеЗаписейУНФЛиды.Доступность = ЕстьДоступность;
	КонецЕсли;
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьГруппыДоступаКонтрагентов" ИЛИ РеквизитПутьКДанным = "" Тогда
		Элементы.СправочникГруппыДоступаКонтрагентовОткрытьСписок.Доступность = НаборКонстант.ИспользоватьГруппыДоступаКонтрагентов;
	КонецЕсли;
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьГруппыДоступаЛидов" ИЛИ РеквизитПутьКДанным = "" Тогда
		Элементы.СправочникГруппыДоступаЛидовОткрытьСписок.Доступность = НаборКонстант.ИспользоватьГруппыДоступаЛидов;
	КонецЕсли;
	// Конец УНФ
...
&НаСервере
Функция ПроизводительныйВариантУНФ()
