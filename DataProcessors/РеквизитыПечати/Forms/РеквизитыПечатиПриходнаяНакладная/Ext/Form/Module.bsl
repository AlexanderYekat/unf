...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(КонтекстПечати, Параметры.КонтекстПечати, "Организация, СтруктурнаяЕдиница,
		|ПодписьКладовщика, Контрагент, КонтактноеЛицоПодписант, СрокХранения, ВидОперации");
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КонтекстПечатиСрокХранения",
		"Видимость", (КонтекстПечати.ВидОперации = Перечисления.ВидыОперацийПриходнаяНакладная.ПриемНаОтветХранение));
...
&НаКлиенте
Процедура КонтекстПечатиСрокХраненияПриИзменении(Элемент)
	
	ЗафиксироватьИзменениеЗначенияРеквизита("СрокХранения");
...
&НаКлиенте
Процедура СохранитьПодписьКладовщика(Команда)
