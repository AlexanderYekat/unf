...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ЗаписьНаУслуги.Видимость = НЕ ЭтоРозница;
...
Процедура ОткрытьСозданныйСайт(ДанныеСозданияСайтаСтруктура)
	...
	Если ДанныеСозданияСайтаСтруктура.Свойство("НастройкаИнтеграции") Тогда
		ПоказатьЗначение(,ДанныеСозданияСайтаСтруктура.НастройкаИнтеграции);
	КонецЕсли;
...
Функция ПолучитьДанныеЗапросом(HTTPМетод, ТелоЗапроса, АдресЗапроса, ЗаголовкиЗапроса, 
	...
	HTTPСоединение = Новый HTTPСоединение(
		АдресЗапроса.Хост,
		АдресЗапроса.Порт,,, ИнтернетПрокси,
		1800,
...
Процедура ОбновитьВидимостьНастроек()
	...
	// запись на услуги
	Элементы.ЗаписьНаУслуги.Видимость = ТипСайта>=3 И Не ЭтоРозница;
	Элементы.ГруппаЗаписьНаУслуги.Видимость = ЗаписьНаУслуги И Не ЭтоРозница;
