...
Процедура ПриНачалеСохраненияНастройкиСинхронизацииНаСервере(ПродолжитьОжидание)
	...
	НастройкиСинхронизации.ДанныеЗаполнения.Вставить("СписокФизическихЛицДляВыгрузки", СписокФизическихЛицДляВыгрузки.Выгрузить());
...
&НаКлиенте
Процедура ВыгружатьКассировЧастичноПриИзменении(Элемент)
