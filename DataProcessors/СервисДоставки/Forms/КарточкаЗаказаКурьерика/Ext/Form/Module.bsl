...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//!!!!! УНФ, нет стиля ЦветТекстаПодсказки = ЦветаСтиля.ЦветТекстаСообщениеEDI; 
...
Процедура ПриОткрытии(Отказ)
	...
	Если РежимМастера = СервисДоставкиКлиентСервер.РежимМастераНовый() Тогда
		...
		//!!!!! УНФ Элементы.Курьер.ЦветТекста = ЦветТекстаПодсказки;
...
Функция КомментарийИзКонтактнойИнформации(ЗначениеКонтактнойИнформации)
	...
	Если УправлениеКонтактнойИнформациейКлиентСервер.ЭтоКонтактнаяИнформацияВJSON(ЗначениеКонтактнойИнформации) Тогда
		
		СтруктураКонтактнойИнформации = УправлениеКонтактнойИнформациейСлужебный.СтрокуJSONВСтруктуру(ЗначениеКонтактнойИнформации);
		СтруктураКонтактнойИнформации.Свойство("comment", Результат);
		
	ИначеЕсли УправлениеКонтактнойИнформациейКлиентСервер.ЭтоКонтактнаяИнформацияВXML(ЗначениеКонтактнойИнформации) Тогда
		
		СтруктураКонтактнойИнформации = УправлениеКонтактнойИнформациейСлужебный.КонтактнаяИнформацияВСтруктуруJSON(ЗначениеКонтактнойИнформации);
		СтруктураКонтактнойИнформации.Свойство("comment", Результат);
...
Функция ПредставлениеКонтактнойИнформации(ЗначениеКонтактнойИнформации)
	...
	Если УправлениеКонтактнойИнформациейКлиентСервер.ЭтоКонтактнаяИнформацияВJSON(ЗначениеКонтактнойИнформации) Тогда
		...
		СтруктураКонтактнойИнформации = УправлениеКонтактнойИнформациейСлужебный.СтрокуJSONВСтруктуру(ЗначениеКонтактнойИнформации);
		СтруктураКонтактнойИнформации.Свойство("value", Результат);
		
	ИначеЕсли УправлениеКонтактнойИнформациейКлиентСервер.ЭтоКонтактнаяИнформацияВXML(ЗначениеКонтактнойИнформации) Тогда
	
		Результат = УправлениеКонтактнойИнформациейСлужебный.ПредставлениеКонтактнойИнформации(ЗначениеКонтактнойИнформации);
...
Процедура УстановитьКонтрагентаВСвободнойФорме(ОчиститьРеквизиты = Ложь)
	...
	//!!!!! УНФ Элементы.ПолучательКонтрагент.ЦветТекста = ЦветТекстаПодсказки;
...
Процедура ПроверитьСуммыОплаты(Отказ = Ложь)
	...
	Если Не Оплачен
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстОшибки,, "СуммаДокумента");
		
	КонецЕсли;
	
	Если СуммаНаложенногоПлатежа + СуммаНаложенногоПлатежаДополнительный > СуммаДокумента Тогда
		
		Отказ = Истина;
		ТекстОшибки = НСтр("ru = 'Сумма оплаты не может превышать сумму заказа.'");
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстОшибки,, "СуммаНаложенногоПлатежа");
...
Процедура ПроверитьИнтервалДоставки(Отказ = Ложь)
	...
	Если НачалоТекущегоДня = НачалоДняДоставки 
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстОшибки,, "ВремяДоставкиС");
