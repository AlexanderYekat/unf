...
Процедура ПриОткрытии(Отказ)
	...
	Если ПакетнаяЗагрузка Тогда
		...
		УстановитьПорядковыйНомерПерехода(3);
	 	УстановитьВидимостьДоступностьПриСоздании_ПакетнаяЗагрузка(Параметры);
	КонецЕсли;

КонецПроцедуры

&НаКлиенте
Процедура УстановитьВидимостьДоступностьПриСоздании_ПакетнаяЗагрузка(Параметры)  
	...
	Если ПакетнаяЗагрузка Тогда 
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТабличныйДокумент", 
			"Видимость", НЕ ПакетнаяЗагрузка); 
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаНадписьДекорацияСопоставлениеДанных", 
			"Видимость", НЕ ПакетнаяЗагрузка); 
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КомандаДалее3", 
			"Видимость", НЕ ПакетнаяЗагрузка); 
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КомандаДалее", 
			"Видимость", НЕ ПакетнаяЗагрузка);

		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КомандаДалее1", 
			"Видимость", НЕ ПакетнаяЗагрузка);
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КомандаНазад", 
			"Видимость", НЕ ПакетнаяЗагрузка);
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КомандаНазад1", 
			"Видимость", НЕ ПакетнаяЗагрузка); 
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВыбратьСопоставлениеПоШаблону", 
			"Видимость", НЕ ПакетнаяЗагрузка);  
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЗагрузитьНастройкиИзФайла", 
			"Видимость", НЕ ПакетнаяЗагрузка);   
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СохранитьНастройкиВФайл", 
			"Видимость", НЕ ПакетнаяЗагрузка); 
