...
Функция СоздатьОбластьЗаголовок(ПараметрыФормирования, ТабличныйДокумент, МакетПолотно)
	...
	Для каждого Строка Из ПараметрыФормирования.ПредставлениеНоменклатуры Цикл
		...
		Если Строка.РеквизитНоменклатуры = "КартинкаНоменклатуры"
			Или Строка.РеквизитНоменклатуры = "КартинкаХарактеристики"
			Или Строка.РеквизитНоменклатуры = "ШтрихкодНоменклатурыКартинка"
			Или Строка.РеквизитНоменклатуры = "ШтрихкодХарактеристикиКартинка" Тогда
			
			// Принимаем расчет 5 пунктов = 1 символу
			ШиринаКолонкиПунктах = ПараметрыФормирования.КартинкаШирина;
			Ширина = ШиринаКолонкиПунктах / 5;
			
		Иначе
			
			Ширина = ?(Строка.Ширина = 0, 10, Строка.Ширина);
						
		КонецЕсли;
		
		ОбластьЗаголовок.Область("C" + Строка(НомерКолонки)).ШиринаКолонки = Ширина;
	...
	Для ИндексЦены = 1 По КоличествоЦен Цикл
		...
		ОбластьЕдиницыИзмерения = ОбластьЗаголовок.Область(1, НомерКолонки + 1, 1, НомерКолонки + 1);
		ОбластьЕдиницыИзмерения.ШиринаКолонки = 3;	
...
Функция СоздатьОбластьСтрока(ПараметрыФормирования, МакетПолотно)
	...
	Для каждого Строка Из ПараметрыФормирования.ПредставлениеНоменклатуры Цикл
		...
		Если Строка.Использование Тогда
			...
			Если Строка.РеквизитНоменклатуры = "КартинкаНоменклатуры"
				...
				ВыделениеОбласти.Имя = Строка.РеквизитНоменклатуры;
	...
	Для каждого СтрокаТаблицыВидовЦен Из ПараметрыФормирования.ТаблицаВидовЦен Цикл
		...
		Если ПараметрыФормирования.ВыводитьЦенуСЕдиницейИзмерения Тогда
		...
		Иначе
			...
			ВыделениеОбласти = ОбластьСтрока.Область(1, НомерКолонки + 1, 1, НомерКолонки + 2);
		...
		ВыделениеОбласти 			= ОбластьСтрока.Область(1, НомерКолонки - Вычитаемое, 1, НомерКолонки);
		ВыделениеОбласти.Заполнение	= ТипЗаполненияОбластиТабличногоДокумента.Параметр;
...
Процедура ВывестиГруппуВТабличныйДокументПолотно(КоллекцияСтрок, ПараметрыФормирования, ТабличныйДокумент)
	...
	ВыводитьКартинкиНоменклатуры = ПараметрыФормирования.ВыводитьКартинкиНоменклатуры;
	ВыводитьКартинкиХарактеристик = ПараметрыФормирования.ВыводитьКартинкиХарактеристик;
	ВыводитьШтрихкодНоменклатурыКартинкой = ПараметрыФормирования.ВыводитьШтрихкодНоменклатурыКартинкой;
	ВыводитьШтрихкодХарактеристикиКартинкой = ПараметрыФормирования.ВыводитьШтрихкодХарактеристикиКартинкой;
	...
	Для каждого Строка Из КоллекцияСтрок Цикл
		...
		Если ВыводитьКартинкиНоменклатуры Тогда
			
			Если ЗначениеЗаполнено(Строка.КартинкаНоменклатуры) Тогда
				
				ПараметрыФормирования.РазмерКартинокБайт = ПараметрыФормирования.РазмерКартинокБайт + Число(
					Строка.КартинкаНоменклатуры.Размер);
				
				ДанныеКартинки = РаботаСФайлами.ДвоичныеДанныеФайла(Строка.КартинкаНоменклатуры, Ложь);
				Если ЗначениеЗаполнено(ДанныеКартинки) Тогда
					
					ОбластьСтрока.Область("КартинкаНоменклатуры").Картинка = Новый Картинка(ДанныеКартинки);
					
				КонецЕсли;
				
			Иначе
				
				ОбластьСтрока.Область("КартинкаНоменклатуры").Картинка = Неопределено;
				
			КонецЕсли;
			
			ОбластьСтрока.Параметры.КартинкаНоменклатуры = "";
			
		КонецЕсли;
		
		Если ВыводитьШтрихкодНоменклатурыКартинкой Тогда
			
			Если ЗначениеЗаполнено(Строка.ШтрихкодНоменклатурыКартинка) Тогда

				ПараметрыШтрихкода = ГенерацияШтрихкода.ПараметрыГенерацииШтрихкода();
				ПараметрыШтрихкода.Штрихкод 				= Строка.ШтрихкодНоменклатурыКартинка;
				ПараметрыШтрихкода.УбратьЛишнийФон 			= Истина; 
				ПараметрыШтрихкода.Масштабировать 			= Истина; 
				
				ДанныеКартинки = ГенерацияШтрихкода.ИзображениеШтрихкода(ПараметрыШтрихкода);

				Если ЗначениеЗаполнено(ДанныеКартинки.ДвоичныеДанные) Тогда
					
					ПараметрыФормирования.РазмерКартинокБайт = ПараметрыФормирования.РазмерКартинокБайт + Число(
						ДанныеКартинки.ДвоичныеДанные.Размер());
					
					ОбластьСтрока.Область(
						"ШтрихкодНоменклатурыКартинка").Картинка = Новый Картинка(ДанныеКартинки.ДвоичныеДанные);
					
				КонецЕсли;
				
			Иначе
				
				ОбластьСтрока.Область("ШтрихкодНоменклатурыКартинка").Картинка = Неопределено;
				
			КонецЕсли;
			
			ОбластьСтрока.Параметры.ШтрихкодНоменклатурыКартинка = "";
			
		КонецЕсли;
		
		Если ВыводитьШтрихкодХарактеристикиКартинкой Тогда
			
			Если ЗначениеЗаполнено(Строка.ШтрихкодХарактеристикиКартинка) Тогда

				ПараметрыШтрихкода = ГенерацияШтрихкода.ПараметрыГенерацииШтрихкода();
				ПараметрыШтрихкода.Штрихкод 		= Строка.ШтрихкодХарактеристикиКартинка;
				ПараметрыШтрихкода.УбратьЛишнийФон 	= Истина;  
				ПараметрыШтрихкода.Масштабировать 	= Истина; 
				...
				Если ЗначениеЗаполнено(ДанныеКартинки.ДвоичныеДанные) Тогда
					...
					ОбластьСтрока.Область(
						"ШтрихкодХарактеристикиКартинка").Картинка = Новый Картинка(ДанныеКартинки.ДвоичныеДанные);
					
				КонецЕсли;
				
			Иначе
				
				ОбластьСтрока.Область("ШтрихкодХарактеристикиКартинка").Картинка = Неопределено;
				
			КонецЕсли;
			
			ОбластьСтрока.Параметры.ШтрихкодХарактеристикиКартинка = "";
			
		КонецЕсли;
		
		Если ВыводитьКартинкиХарактеристик Тогда
			
			Если ЗначениеЗаполнено(Строка.КартинкаХарактеристики) Тогда
				
				ПараметрыФормирования.РазмерКартинокБайт = ПараметрыФормирования.РазмерКартинокБайт + Число(
					Строка.КартинкаХарактеристики.Размер);
				
				ДанныеКартинки = РаботаСФайлами.ДвоичныеДанныеФайла(Строка.КартинкаХарактеристики, Ложь);
				Если ЗначениеЗаполнено(ДанныеКартинки) Тогда
					
					ОбластьСтрока.Область("КартинкаХарактеристики").Картинка = Новый Картинка(ДанныеКартинки);
					
				КонецЕсли;
				
			Иначе
				
				ОбластьСтрока.Область("КартинкаХарактеристики").Картинка = Неопределено;
				
			КонецЕсли;
			
			ОбластьСтрока.Параметры.КартинкаХарактеристики = "";
		...
		Если ПараметрыФормирования.СвободныйОстаток Тогда
			...
			Иначе
				...
				ОбластьСтрока.Параметры.СвободныйОстаток = Формат(Строка.СвободныйОстаток, "ЧЦ=15; ЧДЦ=3");
...
Процедура ВывестиГруппуВТабличныйДокументДвеКолонки(КоллекцияСтрок, ПараметрыФормирования, ТабличныйДокумент)
	...
	ОбластьГруппа		= ПараметрыФормирования.ОбластьГруппа;
	ОбластьСтрока		= ПараметрыФормирования.ОбластьСтрока;
	ВыводитьКартинки	= ПараметрыФормирования.ВыводитьКартинкиНоменклатуры;
	ОтмечатьНовинки		= ПараметрыФормирования.ИспользуетсяПризнакНовинка;
	...
	Для каждого Строка Из КоллекцияСтрок Цикл
		...
		Если ПерваяКолонка Тогда
			...
			ЗначенияПараметров.Вставить("ЕдиницаИзмерения", ?(ВидЦен = Неопределено, Неопределено,
				Строка.ЕдиницаЦена_1));
			ЗначенияПараметров.Вставить("Цена", ?(ВидЦен = Неопределено, Неопределено, Строка.Цена_1));

			СтруктураРасшифровки = ЗаполнитьРасшифровкуЦены(ПараметрыФормирования, ВидЦен, Строка.Номенклатура, ,
				ЗначенияПараметров.ЕдиницаИзмерения, ЗначенияПараметров.Цена);
		...
		Иначе
			...
			ЗначенияПараметров.ЕдиницаИзмерения1			= ?(ВидЦен = Неопределено, Неопределено,
				Строка.ЕдиницаЦена_1);
			ЗначенияПараметров.Цена1						= ?(ВидЦен = Неопределено, Неопределено, Строка.Цена_1);

			СтруктураРасшифровки = ЗаполнитьРасшифровкуЦены(ПараметрыФормирования, ВидЦен, Строка.Номенклатура, ,
				ЗначенияПараметров.ЕдиницаИзмерения1, ЗначенияПараметров.Цена1);
			...
			Если ОтмечатьНовинки Тогда 
				...
				ОбластьОбозначенияНовинки.Картинка = ?(ЗначенияПараметров.ЭтоНовинка, БиблиотекаКартинок.НовинкаСтикер,
					Неопределено);
				
				ОбластьОбозначенияНовинки1 = ОбластьСтрока.Область("Новинка1");
				ОбластьОбозначенияНовинки1.Картинка = ?(ЗначенияПараметров.ЭтоНовинка1,
					БиблиотекаКартинок.НовинкаСтикер, Неопределено);
	...
	Если ЗначенияПараметров.Количество() > 0 Тогда
		...
		Если ОтмечатьНовинки Тогда
			...
			ОбластьОбозначенияНовинки1 = ОбластьСтрока.Область("Новинка1");
			ОбластьОбозначенияНовинки1.Картинка = ?(ЗначенияПараметров.ЭтоНовинка1, БиблиотекаКартинок.НовинкаСтикер,
				Неопределено);
		...
		Если Колонка = 1 Тогда
			...
			Если ЗначениеЗаполнено(Строка.КартинкаНоменклатуры) Тогда
				...
				Если ЗначениеЗаполнено(ДанныеКартинки) Тогда
					...
					ОбластьСлайдДетали.Область("Картинка"
						+ СХарактеристикой).Картинка = Новый Картинка(ДанныеКартинки);
			...
			Иначе
				...
				ОбластьСлайдДетали.Область("Картинка"
					+ СХарактеристикой).Картинка = БиблиотекаКартинок.ЗапланированнаяИдея;
				
			КонецЕсли;
			
			ОбластьЯчеекСКартинкой = ТабличныйДокумент.Присоединить(ОбластьСлайдДетали);
			ОбластьЯчеекСКартинкой.ШиринаКолонки = ПараметрыФормирования.КартинкаШирина / 5;
...
Процедура ЭлементыИИерархияНоменклатуры(ПараметрыФормирования, СтруктураТаблицДанных) Экспорт
	...
	// 1. Получим СКД
	ИмяСхемыКД = ?(ПараметрыФормирования.ИспользоватьХарактеристики = Истина, "СКД_НоменклатураИХарактеристики",
		"СКД_Номенклатура");
	...
	ГруппировкаСтруктуры = КлючеваяГруппировкаВариантаНастроек(НастройкиКомпоновкиДанных, ИмяВариантаСКД);
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ПараметрыФормирования, "ПредставлениеНоменклатуры") Тогда
		
		Для Каждого Строка Из ПараметрыФормирования.ПредставлениеНоменклатуры Цикл
			
			Если ЗначениеЗаполнено(Строка.СлужебныйПолеКомпоновкиПуть) Тогда
				
				ВыбранноеПоле = ГруппировкаСтруктуры.Выбор.Элементы.Добавить(Тип("ВыбранноеПолеКомпоновкиДанных"));
				ВыбранноеПоле.Поле = Новый ПолеКомпоновкиДанных(Строка.СлужебныйПолеКомпоновкиПуть) 
	...
	Для Каждого Структура Из ПараметрыФормирования.ВидыЦен Цикл
		Если Структура.Использование Тогда
			МассивВидовЦен.Добавить(Структура.ВидЦен);
		КонецЕсли;
	КонецЦикла;
	
	// 2.1 Установим значения параметров
	УстановитьЗначениеПараметраВНастройкахСКД(НастройкиКомпоновкиДанных, "МассивВидовЦен", МассивВидовЦен);
...
Процедура ТаблицаЦен(ПараметрыФормирования, СтруктураТаблицДанных)
	...
	|	ЦеныНоменклатуры.ВидЦен.ПорядокОкругления КАК ПорядокОкругления,
	|	ЦеныНоменклатуры.ВидЦен.ОкруглятьВБольшуюСторону КАК ОкруглятьВБольшуюСторону,
	|	ВЫБОР
	|		КОГДА ЦеныНоменклатуры.ВидЦен.ВалютаЦены = &Валюта
	|			ТОГДА ЦеныНоменклатуры.Цена
	|		ИНАЧЕ ЕСТЬNULL(ЦеныНоменклатуры.Цена * КурсВалютыВидаЦен.Курс * &КратностьВалютыПЛ / (&КурсВалютыПЛ *
	|			КурсВалютыВидаЦен.Кратность), 0)
	|	КОНЕЦ КАК Цена,
	|	ЦеныНоменклатуры.ЕдиницаИзмерения КАК ЕдиницаИзмерения
	|ИЗ
	|	РегистрСведений.ЦеныНоменклатуры.СрезПоследних(&ПериодЦен, Актуальность
	...
	|		ПО (ЦеныНоменклатуры.ВидЦен.ВалютаЦены = КурсВалютыВидаЦен.Валюта)";
...
Процедура АдаптироватьПараметрыФормирования(ПараметрыФормирования)
	...
	НомерСтроки = 0;
	Для каждого СтруктураВидаЦен Из ПараметрыФормирования.ВидыЦен Цикл
		
		Если НЕ СтруктураВидаЦен.Использование Тогда
			Продолжить;
		КонецЕсли;
	...
	ВыводитьКартинкиНоменклатуры = (ПараметрыФормирования.ПредставлениеНоменклатуры.НайтиСтроки(
		Новый Структура("Использование, РеквизитНоменклатуры", Истина, "КартинкаНоменклатуры")).Количество() > 0);

	ВыводитьКартинкиХарактеристик = (ПараметрыФормирования.ПредставлениеНоменклатуры.НайтиСтроки(
		Новый Структура("Использование, РеквизитНоменклатуры", Истина, "КартинкаХарактеристики")).Количество() > 0);

	ВыводитьШтрихкодНоменклатурыКартинкой = (ПараметрыФормирования.ПредставлениеНоменклатуры.НайтиСтроки(
		Новый Структура("Использование, РеквизитНоменклатуры", Истина, "ШтрихкодНоменклатурыКартинка")).Количество()
		> 0);

	ВыводитьШтрихкодХарактеристикиКартинкой = (ПараметрыФормирования.ПредставлениеНоменклатуры.НайтиСтроки(
		Новый Структура("Использование, РеквизитНоменклатуры", Истина, "ШтрихкодХарактеристикиКартинка")).Количество()
		> 0);
	
	ПараметрыФормирования.Вставить("ВыводитьКартинкиНоменклатуры", ВыводитьКартинкиНоменклатуры);
	ПараметрыФормирования.Вставить("ВыводитьКартинкиХарактеристик", ВыводитьКартинкиХарактеристик);
	ПараметрыФормирования.Вставить("ВыводитьШтрихкодНоменклатурыКартинкой", ВыводитьШтрихкодНоменклатурыКартинкой);
	ПараметрыФормирования.Вставить("ВыводитьШтрихкодХарактеристикиКартинкой", ВыводитьШтрихкодХарактеристикиКартинкой);
	ПараметрыФормирования.Вставить("РазмерКартинокБайт",			0);
	
	ПараметрыФормирования.Вставить("ИспользоватьХарактеристики", ПолучитьФункциональнуюОпцию("ИспользоватьХарактеристики"));
...
Процедура СформироватьПрайсЛистОрганизации(ПараметрыФормирования, ФоновоеЗаданиеАдресХранилища = "") Экспорт
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ПрайсЛистОрганизации";
...
Функция КлючеваяГруппировкаВариантаНастроек(НастройкиКомпоновкиДанных, ИмяВариантаСКД)
	
	Если ИмяВариантаСКД = "ИерархияКатегорий" Тогда
		Возврат НастройкиКомпоновкиДанных.Структура[0].Структура[0].Структура[0];
	Иначе
		Возврат НастройкиКомпоновкиДанных.Структура[0].Структура[0];
	КонецЕсли;
