...
#Область РаботаСОборудованиемРозливаИСМП

&НаКлиенте
Процедура ОткрытьРаботаСОборудованиемРозливаИСМП(Команда)
	
	ОценкаПроизводительностиКлиент.ЗамерВремени("РегистрСведений.КегиНаОборудованииРозливаИСМП.Форма.ФормаСписка.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов("ОбщаяФорма.СписокКегНаОборудованииРозливаИСМП", Неопределено);
	
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьРаботаСОборудованиемРозливаИСМПОтработайте(Команда)
	
	ОценкаПроизводительностиКлиент.ЗамерВремени("РегистрСведений.КегиНаОборудованииРозливаИСМП.Форма.ФормаСписка.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов("ОбщаяФорма.СписокКегНаОборудованииРозливаИСМП", "ВсеТребующиеДействия");
	
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьРаботаСОборудованиемРозливаИСМПОжидайте(Команда)
	
	ОценкаПроизводительностиКлиент.ЗамерВремени("РегистрСведений.КегиНаОборудованииРозливаИСМП.Форма.ФормаСписка.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов("ОбщаяФорма.СписокКегНаОборудованииРозливаИСМП", "ВсеТребующиеОжидания");
...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	ЭлементыПоМетаданным.Вставить(
		Элементы.ГруппаПодключениеКегаКОборудованиюРозливаИСМП,
...
Процедура ОбновитьСпискиДокументовИСМП()
	...
	ДобавитьДокумент(
		...
		НСтр("ru='Кеги на оборудовании розлива ИС МП'"),
		Ложь,    // Оформите
		Истина,  // Отработайте
		Истина);  // Ожидайте
