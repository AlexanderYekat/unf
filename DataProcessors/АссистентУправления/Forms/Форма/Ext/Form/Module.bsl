...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьВидимостьРерулярныеПлатежи(Элементы.ЗаголовокОповещениеОРегулярныхПлатежах);
	УстановитьВидимостьРерулярныеПлатежи(Элементы.ГруппаОповещениеОРегулярныхПлатежах);
