...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ОстатокУПоставщика = НоменклатураВДокументахСервер.ОстатокНоменклатурыПоставщика(Объект.Ссылка); 
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи) 
	...
	Если ОстатокУПоставщика >= 0 Тогда
		НоменклатураВДокументахСервер.ЗаписатьЗначениеОстаткаНоменклатурыПоставщика(Объект.Ссылка, ОстатокУПоставщика);
	КонецЕсли;
...
Процедура ДобавитьДополнительныйРеквизит(Команда)
	...
	ПараметрыФормы.Вставить("ТекущийНаборСвойств", НаборСвойств_Справочник_НоменклатураПоставщиков);
