...
Процедура ЗаполнитьТаблицуТиповДокументовПоРазделуУчета(ТаблицаТипов, РазделУчета, СтруктураТаблицНастроек = Неопределено) Экспорт
	...
	Если РазделУчета = "Продажа" Тогда
		...
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ЗаказПокупателя"));
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.РасходнаяНакладная"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.РасходныйОрдер"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ПередачаТоваровМеждуОрганизациями"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ПриходнаяНакладная"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.АктОРасхожденияхПолученный"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.КорректировкаРеализации"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		Если Не ПолучитьФункциональнуюОпцию("ИспользоватьКорректировкиРеализаций") Тогда
			НоваяСтрока.НеПоказыватьНастройку = Истина;
		КонецЕсли;
	...
	Если РазделУчета = "Розница" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ОтчетОРозничныхПродажах"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ЧекККМ"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ЧекККМВозврат"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
	...
	Если РазделУчета = "Закупка" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ПриходныйОрдер"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		Если Не ПолучитьФункциональнуюОпцию("ИспользоватьОрдерныйСклад") Тогда
			НоваяСтрока.НеПоказыватьНастройку = Истина;
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.АктОРасхождениях"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.КорректировкаПоступления"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		Если Не ПолучитьФункциональнуюОпцию("ИспользоватьКорректировкиПоступлений") Тогда
			НоваяСтрока.НеПоказыватьНастройку = Истина;
		КонецЕсли;
	...
	Если РазделУчета = "Склад" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ПеремещениеЗапасов"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ПеремещениеПоЯчейкам"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ИнвентаризацияЗапасов"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ОприходованиеЗапасов"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.СписаниеЗапасов"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ПересортицаЗапасов"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.КомплектацияЗапасов"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ЗаказНаПеремещение"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
	...
	Если РазделУчета = "Производство" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.СборкаЗапасов"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.РаспределениеЗатрат"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
	...
	Если РазделУчета = "ПередачаНаКомиссию" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ОтчетКомиссионера"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
		
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ОтчетКомиссионераОСписании"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
	...
	Если РазделУчета = "ПриемНаКомиссию" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ОтчетКомитенту"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
	...
	Если РазделУчета = "ПередачаВПереработку" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ОтчетПереработчика"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
	...
	Если РазделУчета = "ПереработкаДавальческогоСырья" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ОтчетОПереработке"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		НоваяСтрока.НеПоказыватьНастройку = НеПоказыватьНастройку;
	...
	Если РазделУчета = "Прочее" Тогда
		...
		НоваяСтрока = ТаблицаТипов.Добавить();
		НоваяСтрока.Показатель = ОбщегоНазначения.СтроковоеПредставлениеТипа(Тип("ДокументСсылка.ВводНачальныхОстатков"));
		НоваяСтрока.ТипДокумента = НоваяСтрока.Показатель;
		ДобавитьСтрокуВТаблицу(ТаблицаНастроекАвторасчет, НоваяСтрока);
