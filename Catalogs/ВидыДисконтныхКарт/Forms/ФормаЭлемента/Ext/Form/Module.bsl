...
Процедура УправлениеВидимостьюНаСервере()
	...
	Если Объект.СтарыйМеханизмСкидок Тогда
		Элементы.ГруппаВариантСовместногоПримененияТолькоСкидок.Видимость = Истина;
		Элементы.ГруппаВариантСовместногоПримененияСкидокИБонусов.Видимость = Ложь;
	Иначе
		...
		Элементы.ГруппаВариантСовместногоПримененияТолькоСкидок.Видимость = НЕ ЗначениеЗаполнено(Объект.БонуснаяПрограмма);
		Элементы.ГруппаВариантСовместногоПримененияСкидокИБонусов.Видимость = ЗначениеЗаполнено(Объект.БонуснаяПрограмма);			
	КонецЕсли;
...
Процедура ПерейтиКНастройке(Бонусов = Ложь)
	...
	Иначе
		ИмяФормыНастройки = "Обработка.ВидыСкидокНаценокРучныеИАвтоматические.Форма";
	КонецЕсли;
...
Процедура УстановитьВраиантСовместногоПримененияСкидок()
	...
	Если ЗначениеЗаполнено(Объект.БонуснаяПрограмма) Тогда
		...
		Если ВариантСовместногоПримененияБонусов.Пустая() Тогда
			...
			Константы.ВариантыСовместногоПримененияНачисленийБонусов.Установить(ВариантСовместногоПримененияБонусов);
		КонецЕсли;
	Иначе
		ВариантСовместногоПримененияБонусов = Перечисления.ВариантыСовместногоПримененияСкидокНаценок.ПустаяСсылка();
	КонецЕсли;
КонецПроцедуры
