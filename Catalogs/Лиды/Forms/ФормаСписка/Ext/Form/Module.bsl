...
Процедура УправлениеФормой()
	...
	Если МожноРедактировать Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ОбщаяКомандаНапомнить", 
			"Видимость",
			Элементы.ФормаСписок.Пометка);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ОбщаяКомандаСоздатьЗадачуСотрудника", 
			"Видимость",
			Элементы.ФормаСписок.Пометка);
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			...
			"Видимость",
			Элементы.ФормаКанбан.Пометка И ПравоДоступа("Редактирование", Метаданные.Документы.ЗадачаСотрудника));
	...
	Элементы.ПодменюОрганайзер.Видимость = Элементы.ФормаСписок.Пометка;
...
Процедура УстановитьОтборПоРезультату()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"СписокКонтекстноеМенюСправочникТегиРедактироватьТеги", 
		"Видимость",
		ОтборНеУстановлен И МожноРедактировать);
