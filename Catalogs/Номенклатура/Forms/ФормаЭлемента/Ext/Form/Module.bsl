...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ЗначениеЗаполнено(ШтрихКодДляУстановкиПослеЗаписи) Тогда
		...
		ЗаписьШтрихкода.Штрихкод = ШтрихКодДляУстановкиПослеЗаписи;
...
Процедура ЗаполнитьСписокТипов()
	...
	Если МобильноеПриложениеВызовСервера.НужноОграничитьФункциональность() Или ОбщегоНазначенияУНФ.ЭтоРозница() Тогда
