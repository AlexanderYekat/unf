...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗапретитьВводДробногоКоличества = Параметры.ЗапретитьВводДробногоКоличества;
	...
	Если ЗапретитьВводДробногоКоличества Тогда
		Элементы.Количество.ФорматРедактирования = "ЧДЦ=0";
	КонецЕсли;
...
Процедура ОК(Команда)
	...
	СтруктураЗакрытия.Вставить("ЗапретитьВводДробногоКоличества", ЗапретитьВводДробногоКоличества);
	...
	СтруктураЗакрытия.Вставить("НоменклатураПоставщика", НоменклатураПоставщика);
