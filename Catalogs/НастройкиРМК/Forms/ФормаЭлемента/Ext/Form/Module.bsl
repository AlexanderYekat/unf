...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ИмяСтраницы") Тогда
		...
		ИначеЕсли Параметры.ИмяСтраницы = "СтруктурныеЕдиницы" Тогда
			ЭтаФорма.ТекущийЭлемент = Элементы.СтраницаСтруктурныеЕдиницы;
		Иначе
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьНовоеРМК") Тогда
		...
		Если МассивКассККМ.Количество() = 0 Тогда
			МассивКассККМ = Новый Массив;
			МассивКассККМ.Добавить(Справочники.КассыККМ.ПустаяСсылка());
		КонецЕсли;
		...
		МассивПараметров.Добавить(ПараметрКассыККМ);
		ПараметрыВыбораКассККМ = Новый ФиксированныйМассив(МассивПараметров);
		
		Элементы.РаспределениеНоменклатурыКассаККМ.ПараметрыВыбора = ПараметрыВыбораКассККМ;
		
	Иначе
		
		Элементы.ДекорацияПредупреждениеНовогоРМК.Видимость = Ложь;
...
&НаКлиенте
Процедура БыстрыеТоварыНоменклатураОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	
	Если ТипЗнч(ВыбранноеЗначение) = Тип("Структура") Тогда
		
		СтандартнаяОбработка = Ложь;
		
		СтрокаТабличнойЧасти = Элементы.БыстрыеТовары.ТекущиеДанные;
