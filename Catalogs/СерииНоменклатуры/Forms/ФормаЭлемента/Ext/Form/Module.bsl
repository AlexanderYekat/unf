...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НаборСвойств_Справочник_СерииНоменклатуры = УправлениеСвойствами.НаборСвойствПоИмени("Справочник_СерииНоменклатуры");
	...
	Если Объект.Продан Тогда
		...
		ДанныеГарантии = Справочники.СерииНоменклатуры.СрокДействияГарантии(Объект.Ссылка, ДатаПроверки);
...
Процедура ДобавитьДополнительныйРеквизит(Команда)
	...
	ПараметрыФормы.Вставить("ТекущийНаборСвойств", НаборСвойств_Справочник_СерииНоменклатуры);
