	...
	Если ФормаВладельца <> Неопределено Тогда 
		...
		Если Не СтруктураПроверки.ИзменениеВозможно Тогда
			...
			Если СтруктураПроверки.ЕстьДвиженияПоНоменклатуре Тогда
				ТекстСообщения = НСтр("ru = 'Номенклатура участвует в движениях. Установка политики с типом - Управление остатками, невозможна.'");
			Иначе
				ТекстСообщения = НСтр("ru = 'Серии данной номенклатуры участвуют в движениях. Изменение на политику другого типа невозможно.'");
			КонецЕсли;
