...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("БонуснаяПрограмма") Тогда
		СписокВидовКарт = ВидыДисконтныхКартПоПрограмме(Параметры.БонуснаяПрограмма);
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			Список, "Владелец", СписокВидовКарт, ВидСравненияКомпоновкиДанных.ВСписке);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "ГруппаОтборВидКарты", "Видимость", Ложь);
	КонецЕсли;
	// Конец БонуснаяПрограмма
...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если Элементы.ГруппаОтборВидКарты.Видимость Тогда
...
&НаСервере
Функция ВидыДисконтныхКартПоПрограмме(БонуснаяПрограмма)
	...
	|				ТОГДА НЕ ВидыДисконтныхКарт.БонуснаяПрограмма = &БонуснаяПрограмма
	|			ИНАЧЕ ВидыДисконтныхКарт.БонуснаяПрограмма = &БонуснаяПрограмма
	|		КОНЕЦ");
	...
	СписокВидовКарт.ЗагрузитьЗначения(Результат.ВыгрузитьКолонку("Ссылка"));
	
	Возврат СписокВидовКарт;
