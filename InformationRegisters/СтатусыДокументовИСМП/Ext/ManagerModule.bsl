...
Функция Архивировать(ДокументыКАрхивированию) Экспорт
	...
	СписокЗапросов.Добавить(
		...
		|ГДЕ
		|	КегиНаОборудованииРозливаИСМП.Статус     В (&СтатусыУдалитьПриАрхивировании)
		|	И КегиНаОборудованииРозливаИСМП.Документ В (&Документы)",
		"КегиНаОборудовании");

	СтатусыУдалитьПриАрхивировании = Новый Массив();
	СтатусыУдалитьПриАрхивировании.Добавить(Перечисления.СтатусыПодключенияКОборудованиюРозливаИСМП.Отключено);
	СтатусыУдалитьПриАрхивировании.Добавить(Перечисления.СтатусыПодключенияКОборудованиюРозливаИСМП.ПодключеноВоВнешнейСистеме);
