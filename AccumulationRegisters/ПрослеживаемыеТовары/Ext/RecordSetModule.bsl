...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|		ДвиженияПрослеживаемыеТоварыПередЗаписью.Комплектующие КАК Комплектующие, 
	...
	|		ДвиженияПрослеживаемыеТоварыПриЗаписи.Комплектующие, 
	|		0,
	|		ВЫБОР
	...
	|	ДвиженияПрослеживаемыеТоварыИзменение.Комплектующие 
	|
	|ИМЕЮЩИЕ
	...
	Если ТипЗнч(Отбор.Регистратор.Значение) = Тип("ДокументСсылка.ПриходнаяНакладная") И НЕ Отказ Тогда
		ПрослеживаемостьУНФ.УстановитьСвойстваРНПТ(Выгрузить(), Неопределено);
	КонецЕсли; 
