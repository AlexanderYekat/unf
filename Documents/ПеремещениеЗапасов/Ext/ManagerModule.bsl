...
Процедура ПоляЗагрузкиДанныхИзВнешнегоИсточника(ТаблицаПолейЗагрузки, НастройкиЗагрузкиДанных) Экспорт
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
		...
		НСтр("ru = 'Штрихкод'"), ОписаниеТиповСтрока200, ОписаниеТиповКолонка, ИмяГруппыПолей,
		1, , ОбязательноеЗаполнениеГруппыНоменклатуры, ЭтоЗапасы); 
		
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
		ТаблицаПолейЗагрузки, "Артикул",
		НСтр("ru = 'Артикул'"), ОписаниеТиповСтрока25, ОписаниеТиповКолонка, ИмяГруппыПолей,
		2, , ОбязательноеЗаполнениеГруппыНоменклатуры); 
		
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
		ТаблицаПолейЗагрузки, "Код",
		НСтр("ru = 'Номенклатура (код)'"), ОписаниеТиповСтрока11, ОписаниеТиповКолонка, ИмяГруппыПолей,
		2, , ОбязательноеЗаполнениеГруппыНоменклатуры);

	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
		ТаблицаПолейЗагрузки, "НоменклатураНаименование",
		НСтр("ru = 'Номенклатура (наименование)'"), ОписаниеТиповСтрока100, ОписаниеТиповКолонка, ИмяГруппыПолей,
		3, , ОбязательноеЗаполнениеГруппыНоменклатуры);  
		
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
		ТаблицаПолейЗагрузки, "НоменклатураНаименованиеПолное",
		НСтр("ru = 'Номенклатура (полное наименование)'"), ОписаниеТиповСтрока1000, ОписаниеТиповКолонка, ИмяГруппыПолей,
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "РодительКод",
		НСтр("ru = 'Код'", ОбщегоНазначения.КодОсновногоЯзыка()), ОписаниеТиповСтрока11, ОписаниеТиповКолонка, ИмяГруппыПолей, 1);
		
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "РодительНаименование", 
		НСтр("ru = 'Группа (наименование)'", ОбщегоНазначения.КодОсновногоЯзыка()), ОписаниеТиповСтрока100, 
		ОписаниеТиповКолонка, ИмяГруппыПолей, 2);	
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьХарактеристики") Тогда
		...
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
			...
			ОписаниеТиповСтрока150, ОписаниеТиповКолонка, ИмяГруппыПолей, 1);
			
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
			ТаблицаПолейЗагрузки, "ХарактеристикаАртикул", 
			НСтр("ru = 'Характеристика (артикул)'", ОбщегоНазначения.КодОсновногоЯзыка()), 
			ОписаниеТиповСтрока25, ОписаниеТиповКолонка, ИмяГруппыПолей, 2);   
			
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(
			ТаблицаПолейЗагрузки, "ХарактеристикаКод", 
			НСтр("ru = 'Характеристика (код)'"), 
			ОписаниеТиповСтрока11, ОписаниеТиповКолонка, ИмяГруппыПолей, 3);
...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	Документы.ПеремещениеЗапасов.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании);
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ПодключаемыеКоманды") Тогда
		...
		КомандаСозданияНаОсновании = МодульСозданиеНаОсновании.ДобавитьКомандуСозданияНаОсновании(КомандыСозданияНаОсновании, Метаданные.Документы.ПеремещениеЗапасов);
...
Процедура СформироватьТаблицаЗапасы(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства)
	...
	|	ТаблицаЗапасы.СкладУправляющейСистемыОтправитель КАК СкладУправляющейСистемыОтправитель,
	|	ТаблицаЗапасы.СкладУправляющейСистемыПолучатель КАК СкладУправляющейСистемыПолучатель,
	|	СУММА(ВЫБОР
	...
	|	ТаблицаЗапасы.СкладУправляющейСистемыОтправитель,
	|	ТаблицаЗапасы.СкладУправляющейСистемыПолучатель,
	|	ТаблицаЗапасы.КоррСчетУчета,
	|	ТаблицаЗапасы.СчетУчета,
	|	ТаблицаЗапасы.СодержаниеПроводки";
	...
	Для Каждого СтрокаТаблицаЗапасы Из СтруктураДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаЗапасы Цикл
		...
		Если КоличествоТребуетсяРезерв > 0 Тогда
			...
			Если Не СтрокаТаблицаЗапасы.СкладУправляющейСистемыОтправитель Тогда
			...
			Если Не СтрокаТаблицаЗапасы.СкладУправляющейСистемыПолучатель Тогда
		...
		Если КоличествоТребуетсяСвободныйОстаток > 0 Тогда
			...
			Если СтрокаТаблицаЗапасы.СкладУправляющейСистемыПолучатель Тогда
				Продолжить;
			КонецЕсли;
...
Процедура СформироватьТаблицаЗапасыНаСкладах(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства)
	...
	|	И НЕ ТаблицаЗапасы.СкладУправляющейСистемыОтправитель
	|	И НЕ ТаблицаЗапасы.ПеремещениеВРозницеСуммовойУчет
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|	И НЕ ТаблицаЗапасы.СкладУправляющейСистемыПолучатель
...
Процедура СформироватьТаблицаЗапасыКПоступлениюНаСклады(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства)
	...
	|	ТаблицаЗапасы.ЯчейкаКПоступлению КАК Ячейка
	|ИЗ
	|	ВременнаяТаблицаЗапасы КАК ТаблицаЗапасы
	|ГДЕ
...
Процедура СформироватьТаблицаСуммовойУчетВРознице(ДокументСсылкаПеремещениеЗапасов, СтруктураДополнительныеСвойства)
	...
	|	И НЕ ТаблицаДокумента.СкладУправляющейСистемыПолучатель
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	...
	|	И НЕ ТаблицаДокумента.СкладУправляющейСистемыОтправитель
	|	
	|	СГРУППИРОВАТЬ ПО
	|		ТаблицаДокумента.Период,
	|		ТаблицаДокумента.НомерСтроки,
...
Функция ТекстЗапросаИнициализироватьДанные() 
	...
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ИспользоватьОрдернуюСхемуПриПеремещении
	|				И ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоПрочимДокументам)
	|			ТОГДА ПеремещениеЗапасов.Ссылка
	|		КОГДА ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ИспользоватьОрдернуюСхемуПриПеремещении
	|				И ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоСкладскимОрдерам)
	|			ТОГДА ПеремещениеЗапасов.ДокументПоступления
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ДокументПоступления,
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасов.СтруктурнаяЕдиница.ИспользоватьОрдернуюСхемуПриПеремещении
	|				И ПеремещениеЗапасов.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоПрочимДокументам)
	|			ТОГДА ПеремещениеЗапасов.Ссылка
	|		КОГДА ПеремещениеЗапасов.СтруктурнаяЕдиница.ИспользоватьОрдернуюСхемуПриПеремещении
	|				И ПеремещениеЗапасов.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоСкладскимОрдерам)
	|			ТОГДА ПеремещениеЗапасов.ДокументОтгрузки
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ДокументОтгрузки,
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ОрдерныйСклад
	|				И ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ИспользоватьОрдернуюСхемуПриПоступлении
	|				И ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ИспользоватьОрдернуюСхемуПриПеремещении
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ОрдерныйСкладКПоступлению,
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасов.СтруктурнаяЕдиница.ОрдерныйСклад
	|				И ПеремещениеЗапасов.СтруктурнаяЕдиница.ИспользоватьОрдернуюСхемуПриОтгрузке
	|				И ПеремещениеЗапасов.СтруктурнаяЕдиница.ИспользоватьОрдернуюСхемуПриПеремещении
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК ОрдерныйСкладКОтгрузке,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.ПоСкладуВЦелом) КАК ОрдерныйСкладКОтгрузкеПоСкладуВЦелом,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.ПоСкладуВЦелом) КАК ОрдерныйСкладКПоступлениюПоСкладуВЦелом,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоПрочимДокументам) КАК ОрдерныйСкладКПоступлениюПоПрочимДокументам,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиница.ОрдерныйСклад
	|		И ПеремещениеЗапасов.СтруктурнаяЕдиница.ИспользоватьОрдернуюСхемуПриОтгрузке КАК ОрдернаяСхемаПриОтгрузке,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ОрдерныйСклад
	|		И ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.ИспользоватьОрдернуюСхемуПриПоступлении КАК ОрдернаяСхемаПриПоступлении,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиница.СкладУправляющейСистемы КАК СкладУправляющейСистемыОтправитель,
	|	ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель.СкладУправляющейСистемы КАК СкладУправляющейСистемыПолучатель
	...
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиница.УчетОстатковПоЯчейкам
	|			ТОГДА ПеремещениеЗапасовЗапасы.Ячейка
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ЯчейкаКРасходу,
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасовЗапасы.Ссылка.СтруктурнаяЕдиницаПолучатель.УчетОстатковПоЯчейкам
	|			ТОГДА ПеремещениеЗапасовЗапасы.ЯчейкаПолучатель
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ЯчейкаКПоступлению,
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасовЗапасы.Ячейка = ЗНАЧЕНИЕ(Справочник.Ячейки.ПустаяСсылка)
	|			ТОГДА ПеремещениеЗапасовЗапасы.Ссылка.Ячейка
	|		ИНАЧЕ ПеремещениеЗапасовЗапасы.Ячейка
	|	КОНЕЦ КАК Ячейка,
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасовЗапасы.ЯчейкаПолучатель = ЗНАЧЕНИЕ(Справочник.Ячейки.ПустаяСсылка)
	|			ТОГДА ПеремещениеЗапасовЗапасы.Ссылка.ЯчейкаПолучатель
	|		ИНАЧЕ ПеремещениеЗапасовЗапасы.ЯчейкаПолучатель
	...
	|	НЕОПРЕДЕЛЕНО,
	|	НЕОПРЕДЕЛЕНО,
	|	ПеремещениеЗапасовСпецоснастка.Ссылка.Ячейка,
	|	ПеремещениеЗапасовСпецоснастка.Ссылка.ЯчейкаПолучатель
	|ИЗ
	...
	|	НЕОПРЕДЕЛЕНО,
	|	НЕОПРЕДЕЛЕНО,
	|	ПеремещениеЗапасовИнвентарьИХозяйственныеПринадлежности.Ссылка.Ячейка,
	|	ПеремещениеЗапасовИнвентарьИХозяйственныеПринадлежности.Ссылка.ЯчейкаПолучатель
	|ИЗ
	...
	|	ВременнаяТаблицаШапка.ОрдернаяСхемаПриОтгрузке КАК ОрдерныйСклад,
	|	ВременнаяТаблицаШапка.ОрдернаяСхемаПриПоступлении КАК КоррОрдерныйСклад,
	|	ВЫБОР
	...
	|	ПеремещениеЗапасовЗапасы.Ячейка КАК Ячейка,
	|	ПеремещениеЗапасовЗапасы.ЯчейкаПолучатель КАК КоррЯчейка,
	|	ВЫБОР
	|		КОГДА ПеремещениеЗапасовЗапасы.Партия.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПартий.ОтветственноеХранение)
	|				ИЛИ ПеремещениеЗапасовЗапасы.Партия.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПартий.ТоварыНаКомиссии)
	|				ИЛИ ПеремещениеЗапасовЗапасы.Партия.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПартий.ДавальческоеСырье)
	...
	|		ИНАЧЕ ЗНАЧЕНИЕ(Документ.ЗаказПокупателя.ПустаяСсылка)
	|	КОНЕЦ КАК КоррЗаказПокупателя,
	|	ПеремещениеЗапасовЗапасы.Количество КАК КоличествоДокумент,
	...
	|					ИНАЧЕ ПеремещениеЗапасовЗапасы.Резерв * ЕСТЬNULL(ПеремещениеЗапасовЗапасы.ЕдиницаИзмерения.Коэффициент, 1)
	|				КОНЕЦ
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК Резерв,
	|	0 КАК СуммаБезНДС,
	...
	|	ПеремещениеЗапасовЗапасы.ПрослеживаемыйТовар КАК ПрослеживаемыйТовар,
	|	ВременнаяТаблицаШапка.ДокументОтгрузки КАК ДокументОтгрузки,
	|	ВременнаяТаблицаШапка.ОрдерныйСкладКПоступлению КАК ОрдерныйСкладКПоступлению,
	|	ВременнаяТаблицаШапка.ОрдерныйСкладКОтгрузке КАК ОрдерныйСкладКОтгрузке,
	|	ВременнаяТаблицаШапка.ОрдерныйСкладКОтгрузкеПоСкладуВЦелом КАК ОрдерныйСкладКОтгрузкеПоСкладуВЦелом,
	|	ВременнаяТаблицаШапка.ОрдерныйСкладКПоступлениюПоСкладуВЦелом КАК ОрдерныйСкладКПоступлениюПоСкладуВЦелом,
	|	ВременнаяТаблицаШапка.ДокументПоступления КАК ДокументПоступления,
	|	ПеремещениеЗапасовЗапасы.ЯчейкаКРасходу КАК ЯчейкаКРасходу,
	|	ПеремещениеЗапасовЗапасы.ЯчейкаКПоступлению КАК ЯчейкаКПоступлению,
	|	ВременнаяТаблицаШапка.ОрдерныйСкладКПоступлениюПоПрочимДокументам КАК ОрдерныйСкладКПоступлениюПоПрочимДокументам,
	|	ВременнаяТаблицаШапка.СкладУправляющейСистемыОтправитель КАК СкладУправляющейСистемыОтправитель,
	|	ВременнаяТаблицаШапка.СкладУправляющейСистемыПолучатель КАК СкладУправляющейСистемыПолучатель
...
Процедура ВыполнитьКонтроль(ДокументСсылкаПеремещениеЗапасов, ДополнительныеСвойства, Отказ, УдалениеПроведения = Ложь) Экспорт
	...
	Если СтруктураВременныеТаблицы.ДвиженияЗапасыНаСкладахИзменение
		...
		Если НЕ МассивРезультатов[8].Пустой() Тогда 
			...
			КонтрольОстатковУНФ.ЗапасыКПоступлению(ДокументОбъектПеремещениеЗапасов, ВыборкаИзРезультатаЗапроса, Отказ);
		КонецЕсли;
		...
		Если НЕ МассивРезультатов[9].Пустой() Тогда 
			...
			КонтрольОстатковУНФ.СерииНоменклатурыКПоступлению(ДокументОбъектПеремещениеЗапасов, ВыборкаИзРезультатаЗапроса, Отказ);
		КонецЕсли;
		...
		Если НЕ МассивРезультатов[10].Пустой() Тогда 
			...
			КонтрольОстатковУНФ.ЗапасыКРасходу(ДокументОбъектПеремещениеЗапасов, ВыборкаИзРезультатаЗапроса, Отказ);
		КонецЕсли;
		...
		Если НЕ МассивРезультатов[11].Пустой() Тогда 
			...
			КонтрольОстатковУНФ.СерииНоменклатурыКРасходуПоДокументам(ДокументОбъектПеремещениеЗапасов, ВыборкаИзРезультатаЗапроса, Отказ);
		КонецЕсли;
...
Функция ДанныеДокументовБланкТоварногоНаполнения(МассивОбъектов, ЭтоОтправитель)
	...
	|	ВЫБОР
	|		КОГДА &ЭтоОтправитель = ИСТИНА
	|			ТОГДА ПеремещениеЗапасов.СтруктурнаяЕдиница
	|		ИНАЧЕ ПеремещениеЗапасов.СтруктурнаяЕдиницаПолучатель
	|	КОНЕЦ КАК ПредставлениеСклада,
	|	ВЫБОР
	|		КОГДА &ЭтоОтправитель = ИСТИНА
	|			ТОГДА ПеремещениеЗапасов.Ячейка
	|		ИНАЧЕ ПеремещениеЗапасов.ЯчейкаПолучатель
	|	КОНЕЦ КАК ПредставлениеЯчейки,
	...
	|		ВЫБОР
	|			КОГДА &ЭтоОтправитель = ИСТИНА
	|				ТОГДА ПеремещениеЗапасов.Запасы.Ячейка
	|			ИНАЧЕ ПеремещениеЗапасов.Запасы.ЯчейкаПолучатель
	|		КОНЕЦ КАК Ячейка,
	...
	|	) КАК ТаблицаЗапасы,
	|	ПеремещениеЗапасов.ЗаказПокупателя.СерииНоменклатуры.(
	|		Серия КАК Серия,
	|		КлючСвязи КАК КлючСвязи
...
Функция ДанныеДокументовМХ18(МассивОбъектов)
	...
	Для каждого ОбъектПечати Из МассивОбъектов Цикл
		...
		|	ПеремещениеЗапасовЗапасы.НомерСтроки КАК НомерСтроки,
		|	ВЫБОР
		|		КОГДА (ВЫРАЗИТЬ(ПеремещениеЗапасовЗапасы.Номенклатура.НаименованиеПолное КАК СТРОКА(1000))) = """"
		|			ТОГДА ПеремещениеЗапасовЗапасы.Номенклатура.Наименование
		|		ИНАЧЕ ВЫРАЗИТЬ(ПеремещениеЗапасовЗапасы.Номенклатура.НаименованиеПолное КАК СТРОКА(1000))
		|	КОНЕЦ КАК ПредставлениеНоменклатуры,
		|	ПеремещениеЗапасовЗапасы.Характеристика КАК Характеристика,
		...
		|		ИНАЧЕ ПеремещениеЗапасовЗапасы.Номенклатура.ЕдиницаИзмерения.Наименование
		...
		|	ВЫБОР
		|		КОГДА НациональнаяВалюта.Значение = &ВалютаВидаЦен
		|			ТОГДА УчетныеЦены.Цена
		|		ИНАЧЕ ВЫРАЗИТЬ(УчетныеЦены.Цена * ДанныеВалютыВидаЦен.Курс / ДанныеВалютыВидаЦен.Кратность КАК ЧИСЛО(15, 2))
		|	КОНЕЦ / ВЫБОР
		|		КОГДА ПеремещениеЗапасовЗапасы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
		|				И ПечатьПользовательскихЕдиницИзмерения.Значение <> ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
		...
		|		ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(УчетныеЦены.Цена, 0) * ПеремещениеЗапасовЗапасы.Количество * ДанныеВалютыВидаЦен.Курс / ДанныеВалютыВидаЦен.Кратность КАК ЧИСЛО(15, 2))
		|	КОНЕЦ КАК Сумма,
		|	ВЫБОР
		|		КОГДА ПеремещениеЗапасовЗапасы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
		|			ТОГДА ПеремещениеЗапасовЗапасы.Количество * ЕСТЬNULL(ВесИОбъемЕдиницТоваров.Вес, 0)
		|		ИНАЧЕ ПеремещениеЗапасовЗапасы.Количество * ЕСТЬNULL(ПеремещениеЗапасовЗапасы.Номенклатура.Вес, 0)
		|	КОНЕЦ КАК МассаБрутто,
		|	ВЫБОР
		|		КОГДА ПеремещениеЗапасовЗапасы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
		|			ТОГДА ПеремещениеЗапасовЗапасы.Количество * ЕСТЬNULL(ВесИОбъемЕдиницТоваров.Объем, 0)
		|		ИНАЧЕ ПеремещениеЗапасовЗапасы.Количество * ЕСТЬNULL(ПеремещениеЗапасовЗапасы.Номенклатура.Объем, 0)
		|	КОНЕЦ КАК Объем
		|ИЗ
		|	Документ.ПеремещениеЗапасов.Запасы КАК ПеремещениеЗапасовЗапасы
		...
		|		ПО ПеремещениеЗапасовЗапасы.Номенклатура = ВесИОбъемЕдиницТоваров.Номенклатура
		|			И ПеремещениеЗапасовЗапасы.ЕдиницаИзмерения = ВесИОбъемЕдиницТоваров.ЕдиницаИзмерения,
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "М11") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "М11", НСтр("ru = 'М-11'"), ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, "М11"));
		
	КонецЕсли;
	
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ТОРГ13") Тогда
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ТОРГ13", НСтр("ru = 'ТОРГ-13'"), ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, "ТОРГ13"));
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ТТН") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ТТН", НСтр("ru = 'Товарно-транспортная накладная'"), Обработки.ПечатьТТН.ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, ПараметрыПечати));
		
	КонецЕсли;
	
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПеремещениеЗапасов") Тогда
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ПеремещениеЗапасов", НСтр("ru = 'Перемещение запасов'"), ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, "ПеремещениеЗапасов"));
...
Процедура СформироватьТаблицаСерииНоменклатуры(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	|				И ВременнаяТаблицаЗапасы.ОрдерныйСкладКОтгрузкеПоСкладуВЦелом)
	|	И НЕ(ВременнаяТаблицаЗапасы.ОрдерныйСклад
	|				И ВременнаяТаблицаЗапасы.ОрдерныйСкладКПоступлениюПоПрочимДокументам)
	|	И НЕ ВременнаяТаблицаЗапасы.СкладУправляющейСистемыОтправитель
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	СерииНоменклатуры.ПолитикаУчетаСерийПриход,
	|	ВременнаяТаблицаЗапасы.Номенклатура,
	|	ВременнаяТаблицаЗапасы.Характеристика,
	...
	|				И ВременнаяТаблицаЗапасы.ОрдерныйСкладКПоступлениюПоСкладуВЦелом)
	|	И НЕ(ВременнаяТаблицаЗапасы.КоррОрдерныйСклад
	|				И ВременнаяТаблицаЗапасы.ОрдерныйСкладКПоступлениюПоПрочимДокументам)
	|	И НЕ ВременнаяТаблицаЗапасы.СкладУправляющейСистемыПолучатель
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	ЗНАЧЕНИЕ(ВидДвиженияНакопления.Расход) КАК ВидДвижения,
	|	СерииНоменклатуры.Серия КАК Серия,
	|	СерииНоменклатуры.ОстаткиСерийНоменклатурыПриход КАК ОстаткиСерийНоменклатуры,
	|	СерииНоменклатуры.ПолитикаУчетаСерийПриход КАК ПолитикаУчетаСерий,
	|	ВременнаяТаблицаЗапасы.Номенклатура КАК Номенклатура,
	|	ВременнаяТаблицаЗапасы.Характеристика КАК Характеристика,
	|	ВременнаяТаблицаЗапасы.Партия КАК Партия,
	|	ВременнаяТаблицаЗапасы.Организация КАК Организация,
	|	ВременнаяТаблицаЗапасы.КоррСтруктурнаяЕдиница КАК СтруктурнаяЕдиница,
	|	ВременнаяТаблицаЗапасы.КоррЯчейка КАК Ячейка,
	|	ВременнаяТаблицаЗапасы.ВидОперации КАК ВидОперации,
	|	СерииНоменклатуры.Количество КАК Количество,
	|	ВременнаяТаблицаЗапасы.ОрдерныйСклад КАК ОрдерныйСклад,
	...
	|ГДЕ
	|	НЕ ВременнаяТаблицаЗапасы.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПеремещениеЗапасов.СписаниеНаРасходы)
	|	И ВременнаяТаблицаЗапасы.КоррОрдерныйСклад
	...
	ТипДокумента = ОбщегоНазначения.СтроковоеПредставлениеТипа(ТипЗнч(ДокументСсылка));
	МассивДоступныхПолитик = СерииНоменклатурыУНФ.МассивПолитикСДоступомКДокументу(ТипДокумента, ДокументСсылка.ВидОперации);
	...
	РезультатЗапросаКПоступлению = МассивРезультатов[2].Выгрузить();
	...
	РезультатЗапросаККРасходу= МассивРезультатов[3].Выгрузить();
