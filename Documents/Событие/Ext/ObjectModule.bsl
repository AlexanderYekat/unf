...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ИсключаяСвойства = ИсключащиесяСвойстваПриЗаполнении(ДанныеЗаполнения);
...
Процедура ЗаполнитьПоЛид(Лид)
	...
	СтрокаЛид.ТипПолучателяЭлектронногоПисьма
		= ПредопределенноеЗначение("Перечисление.ТипыПолучателейЭлектронногоПисьма.Кому");
...
Функция ИсключащиесяСвойстваПриЗаполнении(ДанныеЗаполнения)
