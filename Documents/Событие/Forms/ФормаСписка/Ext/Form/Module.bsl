...
&НаКлиенте
Перем ВремяЗадержкиОбработчиковОжиданияПриАктивизацииСписка; // см СписокПриАктивизацииСтроки
...
Процедура ПриОткрытии(Отказ)
	...
	ИзначальноеЗаполнениеКлиентскихПеременных();
...
&НаКлиенте
Процедура ИзначальноеЗаполнениеКлиентскихПеременных()
	
	ВремяЗадержки = ДокументыУНФКлиент.ВремяЗадержкиОбработчиковОжидания();
	Если ТипЗнч(ВремяЗадержки) = Тип("Число") Тогда
		ВремяЗадержкиОбработчиковОжиданияПриАктивизацииСписка = ВремяЗадержки;
	Иначе
		ВремяЗадержкиОбработчиковОжиданияПриАктивизацииСписка = 0.7;
	КонецЕсли;
