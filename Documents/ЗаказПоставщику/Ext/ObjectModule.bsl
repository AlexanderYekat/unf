...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Справочники.ПроцессыСостоянийЗаказов.ОбработкаПроверкиЗаполнения(Ссылка, СостояниеЗаказа, ВариантЗавершения, ПроверяемыеРеквизиты);
...
Процедура ЗаполнитьПоСтруктуре(ДанныеЗаполнения) Экспорт
	...
	ИначеЕсли ДанныеЗаполнения.Свойство("РасчетПотребностей") Тогда
