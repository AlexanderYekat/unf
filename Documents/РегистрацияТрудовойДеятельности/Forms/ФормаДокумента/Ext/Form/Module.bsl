				...
				Если КадровыеДаннныеСотрудника <> Неопределено Тогда
					...
					Если ТекущиеДанные.ДатаМероприятия < ПерсонифицированныйУчетКлиентСервер.ДатаПостановленияЕФС1_2023() Тогда
						Если ТекущиеДанные.ЯвляетсяСовместителем Тогда
							Если КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.БессрочныйТрудовойДоговор")
								Или КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорДо6Месяцев")
								Или КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорБолее6Месяцев") Тогда
								
								Если КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.БессрочныйТрудовойДоговор") Тогда
									ТекущиеДанные.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.БессрочныйТрудовойДоговорПоСовместительству");
								ИначеЕсли КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорДо6Месяцев") Тогда
									ТекущиеДанные.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорПоСовместительствуДо6Месяцев");
								ИначеЕсли КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорБолее6Месяцев") Тогда
									ТекущиеДанные.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорПоСовместительствуБолее6Месяцев");
								КонецЕсли;
							КонецЕсли;
						Иначе
							Если КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.БессрочныйТрудовойДоговорПоСовместительству")
								Или КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорПоСовместительствуДо6Месяцев")
								Или КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорПоСовместительствуБолее6Месяцев") Тогда
								
								Если КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.БессрочныйТрудовойДоговорПоСовместительству") Тогда
									ТекущиеДанные.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.БессрочныйТрудовойДоговор");
								ИначеЕсли КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорПоСовместительствуДо6Месяцев") Тогда
									ТекущиеДанные.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорДо6Месяцев");
								ИначеЕсли КадровыеДаннныеСотрудника.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорПоСовместительствуБолее6Месяцев") Тогда
									ТекущиеДанные.СрочночтьТрудовогоДоговора = ПредопределенноеЗначение("Перечисление.СрочностиТрудовогоДоговора.СрочныйТрудовойДоговорБолее6Месяцев");
								КонецЕсли;
							КонецЕсли;
						КонецЕсли;
					КонецЕсли;
