...
Процедура СформироватьКадровыйПриказ(ОписаниеПечатнойФормы, МассивОбъектов, ОбъектыПечати) Экспорт
	...
	|ИЗ Документ.УвольнениеУНФ КАК ОбщиеСведенияОбУвольнение
	...
	|ИЗ Документ.УвольнениеУНФ.Сотрудники КАК СведенияОСотрудниках
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.ПолныйПутьКМакету = "Документ.УвольнениеУНФ.ПФ_MXL_Т8";
