...
Процедура ЗаполнитьТаблицуПредставленийНоменклатурыТоварыИзНатуральногоМеха()
	...
	ЭтотОбъект.ПредставлениеКИЗ.Загрузить(РегистрыСведений.ПулКодовМаркировкиСУЗ.ЗаполнитьТаблицуПредставленийКИЗ(Объект.ШтрихкодыУпаковок.Выгрузить()));
	КоличествоСтрокПредставлениеКИЗ = ЭтотОбъект.ПредставлениеКИЗ.Количество();
