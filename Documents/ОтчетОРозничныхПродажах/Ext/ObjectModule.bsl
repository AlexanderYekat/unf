...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения, СтратегияЗаполнения)
	...
	Если ЭтоНовый() Тогда
		ОптимизированнаяСхемаДвижений = Истина;
	КонецЕсли;
...
Процедура ДобавитьРеквизитыВДополнительныеСвойстваДляПроведения(СтруктураДополнительныеСвойства)
	...
	СтруктураДополнительныеСвойства.ДляПроведения.Вставить("СтруктурнаяЕдиница", СтруктурнаяЕдиница);
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	СерииНоменклатурыУНФ.ПроверитьЗаполнениеСерийНоменклатуры(Отказ, ДанныеДляПроверкиСерийНоменклатуры.Запасы, 
		ДанныеДляПроверкиСерийНоменклатуры.СерииНоменклатуры, ДополнительныеПараметры);
