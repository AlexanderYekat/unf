...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	АрхивацияЗапрещена = ПолучитьФункциональнуюОпцию("ИспользоватьПредоплатуВЧекахККМ")
					 ИЛИ ПолучитьФункциональнуюОпцию("ИспользоватьРассрочкуПлатежаВЧекахККМ");
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ФормаДокументОтчетОРозничныхПродажахЗаархивироватьЧекиККМ",
		"Видимость",
		Не АрхивацияЗапрещена);
...
Процедура СброситьВсеОтборы(Команда)
	РаботаСОтборамиКлиент.СброситьОтборПоПериоду(ЭтотОбъект, "ОтчетыОРозничныхПродажах", "Дата");
	СброситьВсеМеткиОтбораНаСервере();
КонецПроцедуры

&НаСервере
Процедура СброситьВсеМеткиОтбораНаСервере()
	РаботаСОтборами.УдалитьМеткиОтбораСервер(ЭтотОбъект, ОтчетыОРозничныхПродажах,,"ОтчетыОРозничныхПродажах");
КонецПроцедуры
