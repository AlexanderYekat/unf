...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	Документы.РасходнаяНакладная.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании);
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ПодключаемыеКоманды") Тогда
		...
		КомандаСозданияНаОсновании = МодульСозданиеНаОсновании.ДобавитьКомандуСозданияНаОсновании(КомандыСозданияНаОсновании, Метаданные.Документы.РасходнаяНакладная);
...
Функция ПрослеживаемаяОперация(Операция) Экспорт	
	Возврат Перечисления.ВидыОперацийРасходнаяНакладная.ПрослеживаемаяОперация(Операция);	
КонецФункции
...
Процедура СформироватьТаблицаЗапасы(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|				ИЛИ ТаблицаЗапасы.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)
	...
	|			ТОГДА ТаблицаЗапасы.ЗаказПокупателя
	|		КОГДА ТаблицаЗапасы.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПередачаНаКомиссию)
	|				И ТаблицаЗапасы.НеУчитыватьЗаказыПриПередачеНаКомиссию
	|			ТОГДА ЗНАЧЕНИЕ(Документ.ЗаказПокупателя.ПустаяСсылка)
	...
	Если ДокументСсылкаРасходнаяНакладная.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ПродажаПокупателю 
		...
		ИЛИ ДокументСсылкаРасходнаяНакладная.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером 
...
Процедура СформироватьТаблицаЗапасыВРазрезеГТД(СтруктураДополнительныеСвойства)
	...
	|	И ТаблицаЗапасыНаСкладах.ВидОперации В (ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПродажаПокупателю), ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПередачаНаКомиссию), ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВозвратПоставщику), ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)) 
	|
	|СГРУППИРОВАТЬ ПО
	...
	|	И (ТаблицаЗапасыНаСкладах.Партия = ЗНАЧЕНИЕ(Справочник.ПартииНоменклатуры.ПустаяСсылка)
	|			ИЛИ ТаблицаЗапасыНаСкладах.Партия.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыПартий.СобственныеЗапасы))
	|	И ТаблицаЗапасыНаСкладах.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)
	|
	|СГРУППИРОВАТЬ ПО
	|	ТаблицаЗапасыНаСкладах.Период,
	|	ТаблицаЗапасыНаСкладах.Организация,
	...
	|	И ТаблицаЗапасыНаСкладах.ВидОперации В (ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПродажаПокупателю), ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПередачаНаКомиссию), ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВозвратКомитенту), ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)) 
	|
	|СГРУППИРОВАТЬ ПО
	|	ТаблицаЗапасыНаСкладах.Период,
	|	ТаблицаЗапасыНаСкладах.Организация,
...
Процедура СформироватьТаблицаЗапасыПродажа(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	Выкуп = ДокументСсылкаРасходнаяНакладная.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером; 
		...
		Если КоличествоТребуетсяРезерв > 0 Тогда
			...
			Иначе
				...
				Если Выкуп Тогда 
					...
					СтрокаТаблицыПриход.СтруктурнаяЕдиница = СтрокаТаблицаЗапасы.Контрагент;
					...
					СтрокаТаблицыРасход.КоррДокумент = Неопределено;
					СтрокаТаблицыРасход.ПодразделениеПродажи = Неопределено;
					СтрокаТаблицыРасход.Ответственный = Неопределено;
					
					СтрокаТаблицыПриход.ЗаказПродажи = Неопределено;
					СтрокаТаблицыПриход.КоррДокумент = Неопределено;
					СтрокаТаблицыПриход.ПодразделениеПродажи = Неопределено;
			...
			Иначе
				...
				Если Выкуп Тогда 
					...
					Если НЕ ПолучитьФункциональнуюОпцию("РезервированиеЗапасов")
						...
						СтрокаТаблицыПриход.ЗаказПокупателя = Неопределено;
					Иначе
						СтрокаТаблицыПриход.ЗаказПокупателя = СтрокаТаблицаЗапасы.ЗаказПокупателя;
					КонецЕсли;
...
Процедура СформироватьТаблицаЗапасыВозврат(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	Для н = 0 По СтруктураДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаЗапасы.Количество() - 1 Цикл
		...
		Если КоличествоТребуетсяСвободныйОстаток > 0 Тогда
			...
			// Запасы.
			Если Окр((СтрокаТаблицаЗапасы.Сумма + СуммаКСписанию), 2, 1) <> 0
				ИЛИ Окр((СтрокаТаблицаЗапасы.СуммаБезНДС + СуммаБезНДСКСписанию), 2, 1) <> 0 Тогда
				...
				РасчетнаяСуммаБезНДС = -(СтрокаТаблицыРасход.СуммаБезНДС + СуммаБезНДСКСписанию);
				СтрокаТаблицыРасход.СуммаБезНДС = РасчетнаяСуммаБезНДС;
...
Процедура СформироватьТаблицаПродажи(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|	ИЛИ ТаблицаПродажи.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)) 
...
Процедура СформироватьТаблицаЗапасыКРасходуСоСкладов(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|	ТаблицаЗапасыКРасходуСоСкладов.ДокументПоступления КАК ДокументОснование,
	|	ТаблицаЗапасыКРасходуСоСкладов.ЯчейкаКРасходу КАК Ячейка,
	...
	|	ТаблицаЗапасыКРасходуСоСкладов.ДокументПоступления,
	|	ТаблицаЗапасыКРасходуСоСкладов.ЯчейкаКРасходу,
...
Процедура СформироватьТаблицаЗапасыИАгентскиеУслугиПринятые(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|		ИНАЧЕ ЗНАЧЕНИЕ(Перечисление.ТипыПриемаПередачиТоваров.ПоступлениеВПереработку)
	...
	|	И ТаблицаЗапасыИАгентскиеУслугиПринятые.ВидОперации В (ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВозвратКомитенту), ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВозвратИзПереработки))
	|
	|СГРУППИРОВАТЬ ПО
	...
	|	ТаблицаЗапасыИАгентскиеУслугиПринятые.Заказ,
	|	ТаблицаЗапасыИАгентскиеУслугиПринятые.СчетУчета,
	|	ЗНАЧЕНИЕ(Перечисление.ТипыПриемаПередачиТоваров.ОтветственноеХранение),
	|	СУММА(ТаблицаЗапасыИАгентскиеУслугиПринятые.Количество),
	|	СУММА(ТаблицаЗапасыИАгентскиеУслугиПринятые.СуммаРасчетовПринятыеПереданные),
	|	СУММА(ТаблицаЗапасыИАгентскиеУслугиПринятые.СуммаРасчетовПринятыеПереданные),
	|	0,
	|	&ВалютаУпрУчета,
	|	СУММА(ТаблицаЗапасыИАгентскиеУслугиПринятые.СуммаРасчетовПринятыеПереданные),
	|	ВЫРАЗИТЬ(&ПриемЗапасов КАК СТРОКА(100))
	|ИЗ
	|	ВременнаяТаблицаЗапасы КАК ТаблицаЗапасыИАгентскиеУслугиПринятые
	|ГДЕ
	|	ТаблицаЗапасыИАгентскиеУслугиПринятые.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас)
	|	И ТаблицаЗапасыИАгентскиеУслугиПринятые.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВозвратСОтветХранения)
	|
	|СГРУППИРОВАТЬ ПО
	|	ТаблицаЗапасыИАгентскиеУслугиПринятые.Период,
	|	ТаблицаЗапасыИАгентскиеУслугиПринятые.Организация,
	...
	Запрос.УстановитьПараметр("ПриемЗапасовТоварыНаКомиссии", СодержанияПроводок.ПриемЗапасов());
	Запрос.УстановитьПараметр("ИспользуютсяАгентскиеУслуги", ПолучитьФункциональнуюОпцию("АгентскиеУслуги"));
	Запрос.УстановитьПараметр("ТекстАгентскаяУслуга", СодержанияПроводок.РеализацияАгентскойУслуги());
...
Процедура СформироватьТаблицаЗапасыПереданные(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|	ВЫБОР
	|		КОГДА ТаблицаЗапасыПереданные.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)
	|				И ТаблицаЗапасыПереданные.НеУчитыватьЗаказыПриПередачеНаКомиссию
	|			ТОГДА НЕОПРЕДЕЛЕНО
	|		ИНАЧЕ ТаблицаЗапасыПереданные.Заказ
	|	КОНЕЦ,
	...
	|ГДЕ
	|	ТаблицаЗапасыПереданные.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Запас)
	|	И ТаблицаЗапасыПереданные.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)
	|
	|СГРУППИРОВАТЬ ПО
	|	ТаблицаЗапасыПереданные.Период,
	|	ТаблицаЗапасыПереданные.Организация,
...
Процедура СформироватьТаблицаЗаказыПокупателей(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|			ИЛИ ТаблицаЗаказыПокупателей.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером))
	...
	|	И НЕ ТаблицаЗаказыПокупателей.ПродажаПодарка
	|	И ТаблицаЗаказыПокупателей.Заказ ССЫЛКА Документ.ЗаказПокупателя
	|	И ТаблицаЗаказыПокупателей.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)
	|	И (НЕ ТаблицаЗаказыПокупателей.ЭтоДоставка
	|			ИЛИ ЕСТЬNULL(ОстаткиДоставки.Количество, 0) > 0)
	|
	|СГРУППИРОВАТЬ ПО
...
Процедура СформироватьТаблицаДоходыИРасходы(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|			ИЛИ ТаблицаДоходыИРасходы.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером))
	...
	Запрос.УстановитьПараметр("Доставка", СодержанияПроводок.Доставка());
...
Процедура СформироватьТаблицаРасчетыСПокупателями(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	Если ДокументСсылкаРасходнаяНакладная.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ПродажаПокупателю
		Или ДокументСсылкаРасходнаяНакладная.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером Тогда 
...
//
Процедура СформироватьТаблицаБонусныеБаллы(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	
	Запрос = Новый Запрос;
	Запрос.МенеджерВременныхТаблиц = СтруктураДополнительныеСвойства.ДляПроведения.СтруктураВременныеТаблицы.МенеджерВременныхТаблиц;
	Запрос.Текст = РаботаСБонусами.СформироватьТекстЗапросаПоБонуснымБаллам(Истина);
...
Процедура СформироватьТаблицаРасчетыСПоставщиками(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	РеквизитыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументСсылкаРасходнаяНакладная,
	...
	ПолучатьРеквизитыРасчетов = Ложь;
	Если РеквизитыДокумента.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ВозвратПоставщику Тогда
	...
	Иначе
		...
		РасчетыПроведениеДокументов.СформироватьПустуюВременнуюТаблицуРасчетов(ДокументСсылкаРасходнаяНакладная,
...
Процедура СформироватьТаблицаДоходыИРасходыОтложенные(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|	ИЛИ ТаблицаДокумента.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)) 
	...
	|	ИЛИ ВременнаяТаблицаШапка.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)) 
...
Процедура СформироватьТаблицаУправленческий(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|			ИЛИ ТаблицаУправленческий.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером))
	...
	|	ТаблицаУправленческий.Организация,
	|	ЗНАЧЕНИЕ(Справочник.СценарииПланирования.Фактический),
	|	ТаблицаУправленческий.СчетУчетаАвансовПоставщику,
	|	ВЫБОР
	|		КОГДА ТаблицаУправленческий.СчетУчетаАвансовПоставщику.Валютный
	|			ТОГДА ТаблицаУправленческий.ВалютаРасчетов
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ,
	|	ВЫБОР
	...
	|			ИЛИ &ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером))
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|ГДЕ
	|	ТаблицаУправленческий.СуммаКурсовойРазницы <> 0
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЕСТЬNULL(СУММА(ТаблицаУправленческий.СуммаНДС), 0) КАК СуммаНДС,
	|	ЕСТЬNULL(СУММА(ТаблицаУправленческий.СуммаНДСВал), 0) КАК СуммаВалНДС
	|ИЗ
	|	ВременнаяТаблицаЗапасы КАК ТаблицаУправленческий
	|ГДЕ
	|	ТаблицаУправленческий.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВозвратПоставщику)
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЕСТЬNULL(ТаблицаУправленческий.НДСВключатьВСтоимость, ИСТИНА) КАК НДСВключатьВСтоимость
	|ИЗ
	|	ВременнаяТаблицаЗапасы КАК ТаблицаУправленческий";
	...
	Запрос.УстановитьПараметр("СторнированиеПоставки", СодержанияПроводок.СторнированиеПоставки());
	Запрос.УстановитьПараметр("ВосстановлениеАванса", СодержанияПроводок.ВосстановлениеАванса());
	Запрос.УстановитьПараметр("ОтражениеВыручки", СодержанияПроводок.Выручка());
	Запрос.УстановитьПараметр("ОтражениеДоставки", СодержанияПроводок.Доставка());
	Запрос.УстановитьПараметр("ВозникновениеАвансаПокупателя", СодержанияПроводок.ВозникновениеАвансаПокупателя());
	Запрос.УстановитьПараметр("СторнированиеНДС", СодержанияПроводок.СторнированиеНДСПриобретения());
	...
	ДокументОснование = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументСсылкаРасходнаяНакладная, "ДокументОснование");
	ЕстьДокументОснование = ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПриходнаяНакладная");
	...
	ТаблицаДокумента.Свернуть("Период, Организация, СценарийПланирования, СчетДт, ВалютаДт, СчетКт, ВалютаКт,
		|ЭтоВозвратВзаиморасчеты, ЭтоВозвратНДС, ТипРасчетов, Содержание",
		"СуммаВалДт, СуммаВалКт, Сумма");
	
	ВыборкаСуммыНДС = РезультатЗапроса[1].Выбрать();
	
	Если ВыборкаСуммыНДС.Следующий() Тогда	
		СуммаНДС = ВыборкаСуммыНДС.СуммаНДС;
		СуммаВалНДС = ВыборкаСуммыНДС.СуммаВалНДС;
	Иначе
		СуммаНДС = 0;
		СуммаВалНДС = 0;
	КонецЕсли;

	ВыборкаНДСВключатьВСтоимость = РезультатЗапроса[2].Выбрать();
	
	Если ВыборкаНДСВключатьВСтоимость.Следующий() Тогда	
		НДСВключатьВСтоимость = ВыборкаНДСВключатьВСтоимость.НДСВключатьВСтоимость;
	Иначе
		НДСВключатьВСтоимость = Истина;
	КонецЕсли;

	ТаблицаРасчетыСПоставщиками =
		СтруктураДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаРасчетыСПоставщиками.Скопировать();
	ТаблицаРасчетыСПоставщиками.Колонки.Добавить("СуммаВалНДС");
	
	МассивКоэффициентовСумма = ТаблицаРасчетыСПоставщиками.ВыгрузитьКолонку("Сумма");
	МассивКоэффициентовСуммаВал = ТаблицаРасчетыСПоставщиками.ВыгрузитьКолонку("СуммаВал");
	МассивСуммНДС = УправлениеНебольшойФирмойСервер.РаспределитьПропорционально(СуммаНДС, МассивКоэффициентовСумма);
	МассивСуммВалНДС =
		УправлениеНебольшойФирмойСервер.РаспределитьПропорционально(СуммаВалНДС, МассивКоэффициентовСуммаВал);
	
	Для Индекс = 0 По ТаблицаРасчетыСПоставщиками.Количество() - 1 Цикл
		Если МассивСуммНДС <> Неопределено Тогда
			ТаблицаРасчетыСПоставщиками[Индекс].СуммаНДС = МассивСуммНДС[Индекс];		
			Если Не НДСВключатьВСтоимость Тогда	
				ТаблицаРасчетыСПоставщиками[Индекс].Сумма =
					ТаблицаРасчетыСПоставщиками[Индекс].Сумма - ТаблицаРасчетыСПоставщиками[Индекс].СуммаНДС;		
			КонецЕсли;
		КонецЕсли;
		Если МассивСуммВалНДС <> Неопределено Тогда
			ТаблицаРасчетыСПоставщиками[Индекс].СуммаВалНДС = МассивСуммВалНДС[Индекс];		
			Если Не НДСВключатьВСтоимость Тогда	
				ТаблицаРасчетыСПоставщиками[Индекс].СуммаВал =
					ТаблицаРасчетыСПоставщиками[Индекс].СуммаВал - ТаблицаРасчетыСПоставщиками[Индекс].СуммаВалНДС;		
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;	
	
	Для Каждого СтрокаДокумента Из ТаблицаДокумента Цикл
		Если СтрокаДокумента.ЭтоВозвратВзаиморасчеты Тогда
			
			СтрокаРасчетов = ТаблицаРасчетыСПоставщиками.Найти(СтрокаДокумента.ТипРасчетов, "ТипРасчетов");
			...
			Если СтрокаРасчетов <> Неопределено Тогда
				...
				СуффиксСуммы = ?(СтрокаДокумента.ЭтоВозвратНДС, "НДС", "");
				НоваяПроводка.Сумма = СтрокаРасчетов["Сумма" + СуффиксСуммы];
				Если НоваяПроводка.СчетДт.Валютный Тогда
					НоваяПроводка.СуммаВалДт = СтрокаРасчетов["СуммаВал" + СуффиксСуммы]; 
				КонецЕсли;	
				Если НоваяПроводка.СчетКт.Валютный Тогда
					НоваяПроводка.СуммаВалКт = СтрокаРасчетов["СуммаВал" + СуффиксСуммы]; 
				КонецЕсли;	
			КонецЕсли;
...
Процедура СформироватьТаблицаОплатаДокументов(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	МассивДоступныхОпераций.Добавить(Перечисления.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером); 
	МассивДоступныхОпераций.Добавить(Перечисления.ВидыОперацийРасходнаяНакладная.ВозвратПоставщику);
...
Процедура СформироватьТаблицуВзаиморасчетовПоОперацииВозвратаАвто(Запрос)
	...
	|				И ТИПЗНАЧЕНИЯ(Документ) = ТИП(Документ.ПриходнаяНакладная)
	|				И Документ <> ЗНАЧЕНИЕ(Документ.ПриходнаяНакладная.ПустаяСсылка)) КАК РасчетыСПоставщикамиОстатки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ТаблицаДокумента.Курс,
	|	ТаблицаДокумента.Кратность,
	|	ЗНАЧЕНИЕ(Перечисление.СпособыЗачетаИРаспределенияПлатежей.Авто),
	|	ВЫБОР
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.НомерЗапроса КАК НомерЗапроса,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.НомерСтроки КАК НомерСтроки,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.ВидДвижения КАК ВидДвижения,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.ТипРасчетов КАК ТипРасчетов,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.СодержаниеПроводки КАК СодержаниеПроводки,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Дата КАК Дата,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Организация КАК Организация,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Контрагент КАК Контрагент,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.СчетУчета КАК СчетУчета,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Договор КАК Договор,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Документ КАК Документ,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Заказ КАК Заказ,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Валюта КАК Валюта,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Валюта КАК ВалютаПлатежа,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Курс КАК Курс,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Кратность КАК Кратность,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Сумма КАК Сумма,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.СуммаВал КАК СуммаВал,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.СуммаРег КАК СуммаРег,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.СуммаДляОстатка КАК СуммаДляОстатка,
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.СуммаВалДляОстатка КАК СуммаВалДляОстатка,
	|	ЗНАЧЕНИЕ(Перечисление.СпособыЗачетаИРаспределенияПлатежей.Авто) КАК СпособЗачета,
	...
	|ПОМЕСТИТЬ ВременнаяТаблицаРасчетыСПоставщиками
	|ИЗ
	|	ВременнаяТаблицаРасчетыСПоставщикамиПредварительная КАК ВременнаяТаблицаРасчетыСПоставщикамиПредварительная
	|ГДЕ
	|	(ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.Сумма > 0
	|			ИЛИ ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.СуммаВал > 0
	|			ИЛИ ВременнаяТаблицаРасчетыСПоставщикамиПредварительная.СуммаРег > 0)";
...
Процедура ПоляЗагрузкиДанныхИзВнешнегоИсточника(ТаблицаПолейЗагрузки, НастройкиЗагрузкиДанных) Экспорт
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Резерв", НСтр("ru = 'Резерв'"),
		ОписанияТиповПолей.ОписаниеТиповСтрока25, ОписанияТиповПолей.ОписаниеТиповЧисло15_3, , , , ,
	...
	// Склад
	ВидимостьСклада = (ПолучитьФункциональнуюОпцию("УчетПоНесколькимСкладам") И НастройкиЗагрузкиДанных.Свойство(
		"ПоложениеСклада") И НастройкиЗагрузкиДанных.ПоложениеСклада
...
Процедура СформироватьТаблицаСерииНоменклатуры(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	...
	|ВЫБРАТЬ  
	|	ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход),
	|	ЗНАЧЕНИЕ(Перечисление.ОперацииСерийНоменклатуры.Возврат),
	|	ВременнаяТаблицаЗапасы.Период,
	|	ВременнаяТаблицаЗапасы.Период,
	...
	|		ПО ВременнаяТаблицаЗапасы.КлючСвязи = СерииНоменклатуры.КлючСвязи
	|ГДЕ
	|	ВременнаяТаблицаЗапасы.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
// Таблицы значений сохраняет в свойствах структуры "ДополнительныеСвойства".
//
Процедура СформироватьТаблицаПромокоды(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
...
// Таблицы значений сохраняет в свойствах структуры "ДополнительныеСвойства".
//
Процедура СформироватьТаблицаПрименениеПромокодов(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
...
Процедура СформироватьТаблицаДоступностьПромокодов(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства)
	Запрос = Новый Запрос;
	Запрос.МенеджерВременныхТаблиц = СтруктураДополнительныеСвойства.ДляПроведения.СтруктураВременныеТаблицы.МенеджерВременныхТаблиц;
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ПараметрыУсловий.Ссылка КАК УсловиеПрименения
	|ПОМЕСТИТЬ втПромокодыИзЗаказа
	|ИЗ
	|	ВременнаяТаблицаАвтоСкидкиНаценки КАК СкидкиНаценки
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВременнаяТаблицаЗапасы КАК ВременнаяТаблицаЗапасы
	|		ПО (ВременнаяТаблицаЗапасы.КлючСвязи = СкидкиНаценки.КлючСвязи)
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.АвтоматическиеСкидки.УсловияПредоставления КАК УсловияСкидок
	|		ПО (УсловияСкидок.Ссылка = СкидкиНаценки.СкидкаНаценка)
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.УсловияПредоставленияСкидокНаценок КАК ПараметрыУсловий
	|		ПО (ПараметрыУсловий.Ссылка = УсловияСкидок.УсловиеПредоставления)
	|			И (ПараметрыУсловий.УсловиеПредоставления = ЗНАЧЕНИЕ(Перечисление.УсловияПредоставленияСкидокНаценок.ЗаПромокод))
	|ГДЕ
	|	НЕ ВременнаяТаблицаЗапасы.Заказ = ЗНАЧЕНИЕ(Документ.ЗаказПокупателя.ПустаяСсылка)
	|
	|СГРУППИРОВАТЬ ПО
	|	СкидкиНаценки.СкидкаНаценка,
	|	ПараметрыУсловий.Ссылка
	...
	|	И НЕ ТаблицаПромокоды.УсловиеПредоставленияСкидки В
	|				(ВЫБРАТЬ
	|					ПромокодыУжеПогашеныВЗаказе.УсловиеПрименения
	|				ИЗ
	|					втПромокодыИзЗаказа КАК ПромокодыУжеПогашеныВЗаказе)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства) Экспорт
	...
	Если  НЕ СтруктураДополнительныеСвойства.УчетВалютныхОпераций
		...
		И ДокументСсылкаРасходнаяНакладная.ВалютаДокумента = СтруктураДополнительныеСвойства.НациональнаяВалюта
	...
	Если НЕ РеквизитыДокумента.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ПродажаПокупателю
		И НЕ РеквизитыДокумента.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером Тогда 
	...
	// Бонусы
	СформироватьТаблицаБонусныеБаллы(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства);
	СформироватьТаблицаНачисленияБонусныхБаллов(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства);
 	// Промокоды
	СформироватьТаблицаПромокоды(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства); // Регистрация новых выданных промокодов
	СформироватьТаблицаПрименениеПромокодов(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства); // Гашение примененных промокодов
	СформироватьТаблицаДоступностьПромокодов(ДокументСсылкаРасходнаяНакладная, СтруктураДополнительныеСвойства); // Оборот скидок, предоставленных по примененным промокодам
...
Функция ТекстЗапросаИнициализироватьДанныеДокумента()
	...
	|	ВЫБОР
	|		КОГДА РасходнаяНакладная.Кратность = 0
	|			ТОГДА 1
	|		ИНАЧЕ РасходнаяНакладная.Кратность
	|	КОНЕЦ КАК Кратность,
	|	ВЫБОР
	|		КОГДА РасходнаяНакладная.Курс = 0
	|			ТОГДА 1
	|		ИНАЧЕ РасходнаяНакладная.Курс
	|	КОНЕЦ КАК Курс,
	...
	|	РасходнаяНакладная.ДоговорКомиссии КАК ДоговорКомиссии
	...
	|	РасходнаяНакладнаяЗапасы.ПродажаПодарка КАК ПродажаПодарка,
	|	ВЫБОР
	|		КОГДА РасходнаяНакладнаяЗапасы.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоСкладскимОрдерам)
	|			ТОГДА РасходнаяНакладнаяЗапасы.ДокументПоступления
	|		КОГДА РасходнаяНакладнаяЗапасы.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов = ЗНАЧЕНИЕ(Перечисление.ВидыУчетаОрдерныхСкладов.УчетОстатковПоПрочимДокументам)
	|			ТОГДА РасходнаяНакладнаяЗапасы.Ссылка
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ДокументПоступления,
	|	РасходнаяНакладнаяЗапасы.СтруктурнаяЕдиница.УчетОстатковПоЯчейкам КАК УчетОстатковПоЯчейкам,
	|	РасходнаяНакладнаяЗапасы.ЦенаПередачи КАК ЦенаПередачи,
	|	РасходнаяНакладнаяЗапасы.СуммаПередачи КАК СуммаПередачи,
	|	РасходнаяНакладнаяЗапасы.СуммаНДСПередачи КАК СуммаНДСПередачи
	...
	|	ВЫБОР
	|		КОГДА ВЫРАЗИТЬ(ВременнаяТаблицаШапка.ДокументОснование.Ссылка КАК Документ.ПриходнаяНакладная) ЕСТЬ NULL
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	...
	|	ВЫБОР
	|		КОГДА ВТРасходнаяНакладнаяЗапасы.Номенклатура.СчетУчетаНДСПоРеализации = ЗНАЧЕНИЕ(ПланСчетов.Управленческий.ПустаяСсылка)
	|			ТОГДА ЗНАЧЕНИЕ(ПланСчетов.Управленческий.Продажи_НДС)
	|		ИНАЧЕ ВТРасходнаяНакладнаяЗапасы.Номенклатура.СчетУчетаНДСПоРеализации
	|	КОНЕЦ КАК СчетУчетаНДСПоРеализации,
	|	ВЫБОР
	|		КОГДА ВТРасходнаяНакладнаяЗапасы.Номенклатура.СчетУчетаНДСПоПриобретеннымЦенностям = ЗНАЧЕНИЕ(ПланСчетов.Управленческий.ПустаяСсылка)
	|			ТОГДА ЗНАЧЕНИЕ(ПланСчетов.Управленческий.НДСПоПриобретеннымЦенностям)
	|		ИНАЧЕ ВТРасходнаяНакладнаяЗапасы.Номенклатура.СчетУчетаНДСПоПриобретеннымЦенностям
	|	КОНЕЦ КАК СчетУчетаНДСПоПриобретеннымЦенностям,
	|	ВЫБОР
	|		КОГДА ВТРасходнаяНакладнаяЗапасы.Номенклатура.СчетУчетаНДСПоПриобретеннымЦенностям = ЗНАЧЕНИЕ(ПланСчетов.Управленческий.ПустаяСсылка)
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ВТРасходнаяНакладнаяЗапасы.Номенклатура.СчетУчетаНДСПоПриобретеннымЦенностям.Валютный
	...
	|				И ВТРасходнаяНакладнаяЗапасы.СтруктурнаяЕдиница.ИспользоватьОрдернуюСхемуПриОтгрузке
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	...
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК КоррЗаказ,
	|	ВТРасходнаяНакладнаяЗапасы.Количество КАК КоличествоДокумент,
	|	ВТРасходнаяНакладнаяЗапасы.ЕдиницаИзмерения КАК ЕдиницаИзмеренияДокумент,
	|	ВЫБОР
	|		КОГДА ТИПЗНАЧЕНИЯ(ВТРасходнаяНакладнаяЗапасы.ЕдиницаИзмерения) = ТИП(Справочник.ЕдиницыИзмерения)
	|			ТОГДА ВТРасходнаяНакладнаяЗапасы.Количество * ВТРасходнаяНакладнаяЗапасы.ЕдиницаИзмерения.Коэффициент
	|		ИНАЧЕ ВТРасходнаяНакладнаяЗапасы.Количество
	|	КОНЕЦ КАК Количество,
	|	ВЫБОР
	|		КОГДА ТИПЗНАЧЕНИЯ(ВТРасходнаяНакладнаяЗапасы.ЕдиницаИзмерения) = ТИП(Справочник.ЕдиницыИзмерения)
	|			ТОГДА ВТРасходнаяНакладнаяЗапасы.Резерв * ВТРасходнаяНакладнаяЗапасы.ЕдиницаИзмерения.Коэффициент
	|		ИНАЧЕ ВТРасходнаяНакладнаяЗапасы.Резерв
	|	КОНЕЦ КАК Резерв,
	...
	|	ВТРасходнаяНакладнаяЗапасы.ПродажаПодарка КАК ПродажаПодарка,
	|	ВТРасходнаяНакладнаяЗапасы.ДокументПоступления КАК ДокументПоступления,
	|	ВЫБОР
	|		КОГДА ВТРасходнаяНакладнаяЗапасы.УчетОстатковПоЯчейкам
	|			ТОГДА ВТРасходнаяНакладнаяЗапасы.Ячейка
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ЯчейкаКРасходу,
	|	ВТРасходнаяНакладнаяЗапасы.СтруктурнаяЕдиница.ВидУчетаОрдерныхСкладов КАК ВидУчета,
	|	ВТРасходнаяНакладнаяЗапасы.СтавкаНДС.Ставка КАК СтавкаНДССтавка,
	|	ВременнаяТаблицаШапка.ДоговорКомиссии КАК ДоговорКомиссии,
	|	ВТРасходнаяНакладнаяЗапасы.ЦенаПередачи КАК ЦенаПередачи,
	|	ВТРасходнаяНакладнаяЗапасы.СуммаПередачи КАК СуммаПередачи,
	|	ВТРасходнаяНакладнаяЗапасы.СуммаНДСПередачи КАК СуммаНДСПередачи
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.НомерСтроки КАК НомерСтроки,
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.Ссылка.Дата КАК Период,
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.Ссылка.ДисконтнаяКарта КАК БонуснаяКарта,
	|	РасходнаяНакладнаяЗапасы.Номенклатура КАК Номенклатура,
	|	РасходнаяНакладнаяЗапасы.Характеристика КАК Характеристика,
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.КоличествоБонусныхБаллов КАК Количество,
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.ДатаНачисления КАК ДатаНачисления,
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.ДатаСписания КАК ДатаСгорания,
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.Ссылка КАК Ссылка,
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.СкидкаНаценка КАК АналитикаНачисленияБонусов
	...
	|		ПО РасходнаяНакладнаяБонусныеБаллыКНачислению.Ссылка = РасходнаяНакладнаяЗапасы.Ссылка
	|			И РасходнаяНакладнаяБонусныеБаллыКНачислению.КлючСвязи = РасходнаяНакладнаяЗапасы.КлючСвязи
	|ГДЕ
	|	РасходнаяНакладнаяБонусныеБаллыКНачислению.Ссылка = &Ссылка
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	РасходнаяНакладнаяПредоплата.НомерСтроки КАК НомерСтроки,
	|	НАЧАЛОПЕРИОДА(РасходнаяНакладнаяПредоплата.Ссылка.Дата, ДЕНЬ) КАК Период,
	|	РасходнаяНакладнаяПредоплата.Документ КАК БонуснаяКарта,
	|	РасходнаяНакладнаяПредоплата.СуммаРасчетов КАК Количество,
	|	0 КАК КСписанию,
	|	РасходнаяНакладнаяПредоплата.Ссылка КАК Ссылка
	...
	|	И РасходнаяНакладнаяПредоплата.ОплатаБонусами = ИСТИНА
	|	И РасходнаяНакладнаяПредоплата.Заказ В (ЗНАЧЕНИЕ(Документ.ЗаказПокупателя.ПустаяСсылка), ЗНАЧЕНИЕ(Документ.ЗаказПоставщику.ПустаяСсылка), НЕОПРЕДЕЛЕНО)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	И НЕ РасходнаяНакладнаяСерииНоменклатуры.Серия = ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ИЗ
	|	Документ.РасходнаяНакладная.ПримененныеПромокоды КАК ВыданныйПромокод
	...
	|ИЗ
	|	Документ.РасходнаяНакладная.ПримененныеПромокоды КАК ПредъявленныеПромокоды
...
Процедура ВыполнитьКонтроль(ДокументСсылкаРасходнаяНакладная, ДополнительныеСвойства, Отказ, УдалениеПроведения = Ложь) Экспорт
	...
	Если СтруктураВременныеТаблицы.ДвиженияЗапасыИзменение
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.ЗапасыНаСкладах.Остатки(&МоментКонтроля, Организация В (&МассивОрганизаций)
		...
		|	ЕСТЬNULL(ДвиженияЗапасыИзменение.КоличествоИзменение, 0) + ЕСТЬNULL(ЗапасыОстатки.КоличествоОстаток, 0) КАК
		|		ОстатокЗапасы,
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.Запасы.Остатки(&МоментКонтроля, Организация В (&МассивОрганизаций)) КАК
		|			ЗапасыОстатки
		...
		|	ЕСТЬNULL(ДвиженияЗапасыПереданныеИзменение.КоличествоИзменение, 0) +
		|		ЕСТЬNULL(ЗапасыПереданныеОстатки.КоличествоОстаток, 0) КАК ОстатокЗапасыПереданные,
		|	ЕСТЬNULL(ЗапасыПереданныеОстатки.КоличествоОстаток, 0) КАК КоличествоОстатокЗапасыПереданные,
		|	ЕСТЬNULL(ДвиженияЗапасыПереданныеИзменение.СуммаРасчетовИзменение, 0) +
		|		ЕСТЬNULL(ЗапасыПереданныеОстатки.СуммаРасчетовОстаток, 0) КАК СуммаРасчетовЗапасыПереданные,
		...
		|	ЕСТЬNULL(ДвиженияЗапасыПринятыеИзменение.КоличествоИзменение, 0) + ЕСТЬNULL(ЗапасыПринятыеОстатки.КоличествоОстаток,
		|		0) КАК ОстатокЗапасыПринятые,
		|	ЕСТЬNULL(ЗапасыПринятыеОстатки.КоличествоОстаток, 0) КАК КоличествоОстатокЗапасыПринятые,
		|	ЕСТЬNULL(ДвиженияЗапасыПринятыеИзменение.СуммаРасчетовИзменение, 0) +
		|		ЕСТЬNULL(ЗапасыПринятыеОстатки.СуммаРасчетовОстаток, 0) КАК СуммаРасчетовЗапасыПринятые,
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ЗапасыИАгентскиеУслугиПринятые.Остатки(&МоментКонтроля,) КАК
		|			ЗапасыПринятыеОстатки
		...
		|	ЕСТЬNULL(ДвиженияЗаказыПокупателейИзменение.КоличествоИзменение, 0) +
		|		ЕСТЬNULL(ЗаказыПокупателейОстатки.КоличествоОстаток, 0) КАК ОстатокЗаказыПокупателей,
		...
		|	ЕСТЬNULL(ДвиженияЗаказыПоставщикамИзменение.КоличествоИзменение, 0) +
		|		ЕСТЬNULL(ЗаказыПоставщикамОстатки.КоличествоОстаток, 0) КАК ОстатокЗаказыПоставщикам,
		...
		|	ЕСТЬNULL(ДвиженияПотребностьВЗапасахИзменение.КоличествоИзменение, 0) +
		|		ЕСТЬNULL(ПотребностьВЗапасахОстатки.КоличествоОстаток, 0) КАК ОстатокПотребностьВЗапасах,
		...
		|	ЕСТЬNULL(ДвиженияЗапасыВРазрезеГТДИзменение.КоличествоИзменение, 0) +
		|		ЕСТЬNULL(ЗапасыВРазрезеГТДОстатки.КоличествоОстаток, 0) КАК ОстатокЗапасыВРазрезеГТД,
		...
		|	ПРЕДСТАВЛЕНИЕССЫЛКИ(ДвиженияЗапасыПринятыеВРазрезеГТДИзменение.СтранаПроисхождения) КАК
		|		СтранаПроисхожденияПредставление,
		|	ПРЕДСТАВЛЕНИЕССЫЛКИ(ДвиженияЗапасыПринятыеВРазрезеГТДИзменение.НомерГТД) КАК НомерГТДПредставление,
		|	ПРЕДСТАВЛЕНИЕССЫЛКИ(ЗапасыПринятыеВРазрезеГТДОстатки.Номенклатура.ЕдиницаИзмерения) КАК
		|		ЕдиницаИзмеренияПредставление,
		|	ЕСТЬNULL(ДвиженияЗапасыПринятыеВРазрезеГТДИзменение.КоличествоИзменение, 0) +
		|		ЕСТЬNULL(ЗапасыПринятыеВРазрезеГТДОстатки.КоличествоОстаток, 0) КАК ОстатокЗапасыПринятые,
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.ЗапасыПринятыеВРазрезеГТД.Остатки(&МоментКонтроля, (Организация, Номенклатура,
		|			Характеристика, Партия, СтранаПроисхождения, НомерГТД) В
		|			(ВЫБРАТЬ
		...
		|			ИЗ
		|				ДвиженияЗапасыПринятыеВРазрезеГТДИзменение КАК ДвиженияЗапасыПринятыеВРазрезеГТДИзменение)) КАК
		|			ЗапасыПринятыеВРазрезеГТДОстатки
		...
		|		И
		|			ДвиженияЗапасыПринятыеВРазрезеГТДИзменение.СтранаПроисхождения = ЗапасыПринятыеВРазрезеГТДОстатки.СтранаПроисхождения
		...
		|	ЕСТЬNULL(ДвиженияПодарочныеСертификатыИзменение.СуммаИзменение, 0) +
		|		ЕСТЬNULL(ПодарочныеСертификатыОстатки.СуммаОстаток, 0) КАК ОстатокПодарочныеСертификаты,
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПодарочныеСертификаты.Остатки(&МоментКонтроля,) КАК
		|			ПодарочныеСертификатыОстатки
		...
		|	ДвиженияПрослеживаемыеТоварыИзменение.Номенклатура.ТоварнаяНоменклатураВЭД.ЕдиницаИзмерения КАК
		|		ЕдиницаИзмеренияПрослеживаемостиПредставление,
		|	ЕСТЬNULL(ДвиженияПрослеживаемыеТоварыИзменение.КоличествоИзменение, 0) +
		|		ЕСТЬNULL(ПрослеживаемыеТоварыОстатки.КоличествоОстаток, 0) КАК ОстатокКоличество,
		|	ЕСТЬNULL(ДвиженияПрослеживаемыеТоварыИзменение.КоличествоПрослеживаемостиИзменение, 0) +
		|		ЕСТЬNULL(ПрослеживаемыеТоварыОстатки.КоличествоПрослеживаемостиОстаток, 0) КАК ОстатокКоличествоПрослеживаемости,
		|	ЕСТЬNULL(ПрослеживаемыеТоварыОстатки.КоличествоОстаток, 0) КАК ОстатокКоличествоТекущий,
		|	ЕСТЬNULL(ПрослеживаемыеТоварыОстатки.КоличествоПрослеживаемостиОстаток, 0) КАК
		|		ОстатокКоличествоПрослеживаемостиТекущий
		|ИЗ
		|	ДвиженияПрослеживаемыеТоварыИзменение КАК ДвиженияПрослеживаемыеТоварыИзменение
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрослеживаемыеТовары.Остатки(&МоментКонтроля,) КАК
		|			ПрослеживаемыеТоварыОстатки
		...
		Если НЕ МассивРезультатов[0].Пустой()
			...
			ИЛИ НЕ МассивРезультатов[15].Пустой() Тогда
		...
		Если НЕ МассивРезультатов[13].Пустой() Тогда
			...
			КонтрольОстатковУНФ.ЗапасыКРасходу(ДокументОбъектРасходнаяНакладная, ВыборкаИзРезультатаЗапроса, Отказ);
		КонецЕсли;
		...
		Если НЕ МассивРезультатов[14].Пустой() Тогда
			...
			КонтрольОстатковУНФ.СерииНоменклатурыКРасходуПоДокументам(ДокументОбъектРасходнаяНакладная, ВыборкаИзРезультатаЗапроса, Отказ);
		КонецЕсли;
		
		// Отрицательный остаток по запасам с учетом резервов к передаче
		Если НЕ МассивРезультатов[15].Пустой() И НЕ Отказ Тогда
			ВыборкаИзРезультатаЗапроса = МассивРезультатов[15].Выбрать();
			КонтрольОстатковУНФ.РезервыКПередачиСУчетомОстатковПоЗапасамНаСкладах(ДокументОбъектРасходнаяНакладная, ВыборкаИзРезультатаЗапроса, Отказ);
		КонецЕсли;
...
Функция ВТРасходнаяНакладнаяЗапасы(Знач РасходнаяНакладная) Экспорт
	...
	|	ИЛИ РасходнаяНакладная.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)) 
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
...
Функция УниверсальныйЗапросПоДаннымДокумента(МассивОбъектов, ИспользоватьФаксимиле, ИспользоватьНаборы)
	...
	|		КОГДА РасходнаяНакладная.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером)
	...
	|	РасходнаяНакладная.ТекстУсловийСчетаЗаказа КАК ТекстДополнительныхУсловий,
	|	РасходнаяНакладная.ДокументОснование КАК ДокументОснование,
	|	РасходнаяНакладная.Ответственный КАК Ответственный,
	...
	|			КОГДА РасходнаяНакладная.Запасы.ЕдиницаИзмерения ССЫЛКА Справочник.ЕдиницыИзмерения
	|					И ПечатьПользовательскихЕдиницИзмерения.Значение <> ЗНАЧЕНИЕ(Перечисление.ПечатьПользовательскихЕдиницИзмерения.ФормироватьПечатныйДокументВПользовательскойЕдинице)
	|				ТОГДА РасходнаяНакладная.Запасы.Количество * РасходнаяНакладная.Запасы.ЕдиницаИзмерения.Коэффициент
	|			ИНАЧЕ РасходнаяНакладная.Запасы.Количество
	...
	|		ВЫРАЗИТЬ(РасходнаяНакладная.Запасы.Цена * РасходнаяНакладная.Запасы.Количество КАК ЧИСЛО(15, 2)) КАК СуммаБезСкидки
	|	) КАК ТаблицаЗапасы,
...
Функция ДанныеДокументовРегУчет(МассивОбъектов, ИспользоватьФаксимиле, ПечатнаяФормаТолькоВРублях = Истина, Ошибки = Неопределено) Экспорт
	...
	|				И НЕ РасходнаяНакладная.Организация = РасходнаяНакладная.Организация.ГоловнаяОрганизация
	...
	|				ИЛИ РасходнаяНакладная.ЭтоУниверсальныйДокумент
	|					И РасходнаяНакладная.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ВозвратПоставщику)
	|				ИЛИ РасходнаяНакладная.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийРасходнаяНакладная.ПередачаНаКомиссию)
	|			ТОГДА 2
	|		ИНАЧЕ 1
	|	КОНЕЦ КАК СтатусУПД,
	...
	|	РасходнаяНакладная.Вес КАК Вес,
	|	РасходнаяНакладная.Объем КАК Объем,
	|	РасходнаяНакладная.ДанныеОТранспортировке КАК ДанныеОТранспортировке,
	|	РасходнаяНакладная.СопроводительныеДокументы КАК СопроводительныеДокументы,
	|	РасходнаяНакладная.Запасы.(
	|		НомерСтроки КАК НомерСтроки,
	...
	|	РасходнаяНакладная.СтавкаНДСДоставки КАК СтавкаНДСДоставки,
	|	РасходнаяНакладная.СуммаНДСДоставки КАК СуммаНДСДоставки,
	|	РасходнаяНакладная.ЭтоУниверсальныйДокумент КАК ЭтоУниверсальныйДокумент,
	...
	|	РасходнаяНакладнаяЗапасы.СуммаВключаетНДС
	|ИЗ
	...
	|	РасходнаяНакладнаяСведенияПрослеживаемости.Номенклатура КАК Номенклатура,
	...
	|					КОГДА ВременнаяТаблица_РасходнаяНакладнаяЗапасы.СуммаВключаетНДС
	|						ТОГДА ВЫРАЗИТЬ((ВременнаяТаблица_РасходнаяНакладнаяЗапасы.Сумма - ВременнаяТаблица_РасходнаяНакладнаяЗапасы.СуммаНДС) / ВременнаяТаблица_РасходнаяНакладнаяЗапасы.Количество КАК ЧИСЛО(15, 2))
	|					ИНАЧЕ ВременнаяТаблица_РасходнаяНакладнаяЗапасы.Цена
	|				КОНЕЦ
	|		ИНАЧЕ РасходнаяНакладнаяСведенияПрослеживаемости.Сумма
	|	КОНЕЦ КАК СтоимостьБезНалога
	|ИЗ
	|	ВременнаяТаблица_РасходнаяНакладнаяЗапасы КАК ВременнаяТаблица_РасходнаяНакладнаяЗапасы
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.РасходнаяНакладная.СведенияПрослеживаемости КАК РасходнаяНакладнаяСведенияПрослеживаемости
	|		ПО ВременнаяТаблица_РасходнаяНакладнаяЗапасы.Ссылка = РасходнаяНакладнаяСведенияПрослеживаемости.Ссылка
	|			И ВременнаяТаблица_РасходнаяНакладнаяЗапасы.ИдентификаторСтроки = РасходнаяНакладнаяСведенияПрослеживаемости.ИдентификаторСтроки";
	
	МассивРезультатов = Запрос.ВыполнитьПакет();
	Результат = МассивРезультатов[0].Выгрузить();
	
	ТЗСтрок = МассивРезультатов[3].Выгрузить();
	ТзСтрокСведенияПрослеживаемости = МассивРезультатов[4].Выгрузить();
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "М15") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "М15", НСтр("ru = 'М15 (Накладная на отпуск материалов)'"), ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, "М15", ПараметрыПечати));
		
	КонецЕсли;
	
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ТТН") Тогда
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ТТН", НСтр("ru = '1-Т (Товарно-транспортная накладная)'"), Обработки.ПечатьТТН.ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, ПараметрыПечати));
		
	КонецЕсли;
	
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ТоварныйЧек") Тогда
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ТоварныйЧек", НСтр("ru = 'Товарный чек'"), ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, "ТоварныйЧек", ПараметрыПечати));
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ГарантийныйТалон") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ГарантийныйТалон", НСтр("ru = 'Гарантийный талон'"), ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, "ГарантийныйТалон", ПараметрыПечати));
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	ЗначениеВидимости.Добавить(Перечисления.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером); 
	...
	ЗначениеВидимостиУПД.Добавить(Перечисления.ВидыОперацийРасходнаяНакладная.ВыкупТоваровКомиссионером); 
