...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Элементы.ВидУчета.Видимость                  = ОбщегоНазначенияИСКлиентСерверПовтИсп.ВидПродукцииПоддерживаетОбъемноСортовойУчет(Объект.ВидПродукции);
...
Процедура ПриИзмененииВидаПродукции(Элемент, ПерезаполнитьПоОснованию)
	...
	Если Не ОбщегоНазначенияИСКлиентСерверПовтИсп.ВидПродукцииПоддерживаетОбъемноСортовойУчет(Объект.ВидПродукции) Тогда
