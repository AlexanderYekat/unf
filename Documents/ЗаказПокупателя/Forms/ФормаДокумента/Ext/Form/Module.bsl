...
Функция ПолучитьСрокОплатыПокупателя(Договор)
	...
	Результат = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Договор, "СрокОплатыПокупателя");
...
&НаСервере
Функция НомераИдентичныхСтрокВТабличнойЧасти(АдресЗапасовВХранилище, ИмяТабличнойЧасти = "Запасы") //BG
