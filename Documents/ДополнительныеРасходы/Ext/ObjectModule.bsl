...
Процедура РаспределитьТабЧастьРасходыПоКоличеству() Экспорт
	...
	НОД = Документы.ДополнительныеРасходы.ПолучитьНОДДляМассива(Запасы.ВыгрузитьКолонку("Количество"), 1000);
...
Процедура РаспределитьТабЧастьРасходыПоСумме() Экспорт
	...
	НОД = Документы.ДополнительныеРасходы.ПолучитьНОДДляМассива(Запасы.ВыгрузитьКолонку("Сумма"), 100);
