...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(Ссылка) = Тип("ДокументСсылка.ОтчетКомиссионера")
		И ВидОперации = Перечисления.ВидыОперацийОтчетКомиссионера.ОтчетКомиссионераОВозвратах 
		Или (Параметры.Свойство("ИмяТабличнойЧасти") И Параметры.ИмяТабличнойЧасти = "ЗапасыВозвраты") Тогда
...
Процедура ПеренестиВДокументВыполнить()
	...
	Для Каждого СтрокаТабличнойЧасти Из ТаблицаЗапасов Цикл
		...
		Если СтрокаТабличнойЧасти.Количество = 0 Тогда
			...
			ТекстСообщения = СтрШаблон(НСтр("ru = 'Заполните количество в строке № %1.'"), Строка(НомерСтроки));
			ТекстПутьКДанным = СтрШаблон("ТаблицаЗапасов[%1].Количество", СтрокаТабличнойЧасти.ПолучитьИдентификатор());
