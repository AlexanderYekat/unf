...
Функция РаспределеннаяТаблицаЗапасы(ДокументСсылкаОтчетКомиссионера, ДополнительныеСвойства = Неопределено, ИмяТаблицы = "Запасы") Экспорт 
	...
	Для Каждого СтрокаКРаспределению Из ТаблицаКРаспределению Цикл
		...
		Если ЭтоВозврат Тогда
			...
			ПараметрыОтбораОстатки.Цена = СтрокаКРаспределению.Цена;
...
Процедура ПоляЗагрузкиДанныхИзВнешнегоИсточника(ТаблицаПолейЗагрузки, НастройкиЗагрузкиДанных) Экспорт
	...
	ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "КоличествоВозвращено", НСтр(
		...
		ОписанияТиповПолей.ОписаниеТиповЧисло15_3Отрицательный, , , Ложь);
...
Процедура СопоставитьЗагружаемыеДанныеИзВнешнегоИсточника(ПараметрыСопоставления, АдресРезультата) Экспорт
	...
	Для каждого СтрокаТаблицыФормы Из ТаблицаСопоставленияДанных Цикл
		...
		Если СтрокаТаблицыФормы.СуммаВозвращено <> 0 И СтрокаТаблицыФормы.СуммаВозвращено_ВходящиеДанные = "" 
			И ЗагрузкаИзФайлаOzon Тогда   
		...
		Если СтрокаТаблицыФормы.Доплата <> 0 И СтрокаТаблицыФормы.Доплата_ВходящиеДанные = "" 
			И ЗагрузкаИзФайлаOzon Тогда   
		...
		Если ЗагрузкаИзФайлаOzon Тогда 
			...
			Если СтрокаТаблицыФормы.Количество < 0 
				ИЛИ  СтрокаТаблицыФормы.СуммаВозвращено > 0 Тогда
	...
	Попытка
		...
		Для Каждого СтрокаТаблицы Из ТаблицаСопоставленияДанных Цикл
			...
			Если ЗагрузкаВПриложениеВозможна Тогда
				...
				Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(СтрокаТаблицы, "Доплата_ВходящиеДанные")
					И ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(СтрокаТаблицы, "Сумма_ВходящиеДанные") Тогда 	
