...
Функция ФиксируемыеРеквизиты(Документ = Неопределено)
	...
	ДобавитьФиксируемыйРеквизит(ФиксируемыеРеквизиты, Группа, "Составитель");
...
Функция ОсобенностиВыгрузки(Документ) Экспорт
	...
	Результат.Вставить("Версия_2_36", СЭДОФСС.ВерсияЧислом(Документ.ВерсияСпецификации) >= СЭДОФСС.ВерсияЧислом("2.36"));
	Возврат Результат;
КонецФункции
