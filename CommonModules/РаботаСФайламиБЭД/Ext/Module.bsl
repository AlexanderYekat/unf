...
Функция ДвоичныеДанныеФайлов(ПрисоединенныеФайлы, КонтекстДиагностики = Неопределено) Экспорт
	...
	Если ОбщегоНазначенияКлиентСервер.СравнитьВерсии(ТекущаяВерсияБСП, "3.1.10.0") >= 0 Тогда
		Возврат РаботаСФайлами.ДвоичныеДанныеФайлов(ПрисоединенныеФайлы);
	КонецЕсли;
...
// Возвращаемое значение:
//  Булево
Функция ЭтоPDF(Расширение) Экспорт
...
// Добавляет штамп ЭП в данные файла pdf, возвращает адрес во временном хранилище с обработанным файлом.
// 
// Параметры:
...
// 
// Возвращаемое значение:
//  Неопределено,Строка - адрес во временном хранилище
// 
Функция ДобавитьШтампЭПВФайлPDF(ДвоичныеДанныеФайлаPdf, ШтампЭП, УникальныйИдентификатор) Экспорт
