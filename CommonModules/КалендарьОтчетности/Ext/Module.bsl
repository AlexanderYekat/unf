...
Функция ЗарегистрироватьНовыеСобытияКалендаряОтчетностиКИсполнению(Организация = Неопределено) Экспорт
	...
	|									И КалендарьПодготовкиОтчетности.СобытиеКалендаря.УпрощенныйЗачетФиксированныхВзносов
	|								ТОГДА ИСТИНА
	...
	//Запрос.УстановитьПараметр("ДатаОплатыВзносыИПДоходы", РасчитатьДатуОплатыВзносыИПДоходы());     
	//Запрос.УстановитьПараметр("ДатаОплатыВзносыИПДоходыПрошлыйГод", РасчитатьДатуОплатыВзносыИПДоходы(Истина));
	//Запрос.УстановитьПараметр("ДатаФиксВзносыЭтотГод", РасчитатьДатуОплатыВзносыИПДоходыФиксированные());  
	//Запрос.УстановитьПараметр("ДатаФиксВзносыПрошлыйГод", РасчитатьДатуОплатыВзносыИПДоходыФиксированные(Истина));	
