...
Процедура СохранитьСтатусОтправкиРеглОтчета(Форма) Экспорт
	...
	ЭтоОтчетМинобороны = Форма.СтруктураРеквизитовФормы.мСохраненныйДок.ИсточникОтчета = "РегламентированныйОтчетИсполнениеКонтрактовГОЗ"
		Или Форма.СтруктураРеквизитовФормы.мСохраненныйДок.ИсточникОтчета = "РегламентированныйОтчетКассовыйПланГОЗ";
...
Процедура ДополнитьРеквизитыСтатистическогоОтчетаДляЗагрузкиСправочников(Форма) Экспорт
	...
	ИсточникОтчета =
		СформироватьСтрокуИсточникОтчета(Форма.ИмяФормы, Форма.СтруктураРеквизитовФормы["ИмяМакетаАтрибутовВыгрузки"]);
...
Функция СформироватьСтрокуИсточникОтчета(ИмяФормы, ИмяМакетаАтрибутов) Экспорт
	
	ДопАтрибуты = СформироватьСтруктуруДопАтрибутов(ИмяФормы, ИмяМакетаАтрибутов);
