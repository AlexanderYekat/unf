...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДокументыСПолемОрганизация.Добавить("Документ.КадровоеПеремещениеУНФ");
	ДокументыСПолемОрганизация.Добавить("Документ.НачислениеЗарплатыУНФ");
	...
	ДокументыСПолемОрганизация.Добавить("Документ.ПоложениеОПремировании");
	...
	ДокументыСПолемОрганизация.Добавить("Документ.ПриемНаРаботуУНФ");
	...
	ДокументыСПолемОрганизация.Добавить("Документ.УвольнениеУНФ");
	...
	ДокументыСПолемОрганизация.Добавить("Документ.АктОРасхождениях");
	ДокументыСПолемОрганизация.Добавить("Документ.АктОРасхожденияхПолученный");
	ДокументыСПолемОрганизация.Добавить("Документ.УведомлениеОбИсчисленныхСуммахНалогов");
	ДокументыСПолемОрганизация.Добавить("Документ.ОперацияПоЕдиномуНалоговомуСчету"); 
	ДокументыСПолемОрганизация.Добавить("Документ.ЗаявлениеОЗачетеВСчетПредстоящейОбязанности"); 
	ДокументыСПолемОрганизация.Добавить("Документ.СверкаВзаиморасчетов");
	ДокументыСПолемОрганизация.Добавить("Документ.ЗакрытиеПланируемыхОплат");
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ЕжедневныйОтчет", "Дата",
		"УправленческийУчет");
...
Процедура ПередПроверкойЗапретаИзменения(Объект,
	...
	Если Объект.ДополнительныеСвойства.Свойство("ИгнорироватьПроверкуДатыЗапрета") Тогда
		ПроверкаЗапретаИзменения = Ложь;
	КонецЕсли;
