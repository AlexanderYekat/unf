...
Процедура ПриОпределенииСправочниковХраненияФайлов(ТипВладелецФайла, ИменаСправочников) Экспорт
	...
	// ИнтеграцияГОСИС
	ИнтеграцияГИСМУНФ.ПриОпределенииСправочниковХраненияФайлов(ТипВладелецФайла, ИменаСправочников);
...
Процедура ПриСозданииФайла(Файл) Экспорт
	...
	ОбсужденияУНФ.ПриСозданииФайла(Файл);
...
Процедура ПриОтправкеФайловПочтой(ПараметрыОтправки, ФайлыДляОтправки, ВладелецФайлов, УникальныйИдентификатор) Экспорт
	...
	ПараметрыОтправки.Вставить("Предмет", ВладелецФайлов);
...
Процедура ПриСозданииФормыСпискаФайлов(Форма) Экспорт
	...
	ЗадачиСотрудника.ПриСозданииФормыСпискаФайлов(Форма);
	РаботаСБуферомОбмена.ПриСозданииФормыСпискаФайлов(Форма);
