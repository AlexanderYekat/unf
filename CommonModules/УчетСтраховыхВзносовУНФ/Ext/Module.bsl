...
Процедура СформироватьВТПревышениеПредельнойВеличиныДохода(НачалоПериода, ОкончаниеПериода, МенеджерВременныхТаблиц) Экспорт 
	...
	ПолучитьТаблицуСрезаПоследних(Запрос.МенеджерВременныхТаблиц, "ПредельнаяВеличинаБазыСтраховыхВзносовУНФ", ИзмеренияДаты, , Истина);
	...
	|	КОНЕЦ КАК СуммаПревысившаяПределФОМС
 	...
 	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТПредельнаяВеличинаБазыСтраховыхВзносовУНФСрезПоследних КАК Предел
	...
	|;
 	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ВТПредельнаяВеличинаБазыСтраховыхВзносовУНФСрезПоследних
	|;
 	|
 	|////////////////////////////////////////////////////////////////////////////////
...
Процедура СформироватьВТКодыВидовТарифаСтраховыхВзносов(МенеджерВременныхТаблиц) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка КАК ВидТарифаСтраховыхВзносов,
	|	ВидыТарифовСтраховыхВзносовУНФ.КодФНС КАК КодФНС,
	|	ВидыТарифовСтраховыхВзносовУНФ.КодПФР2011 КАК КодПФР,
	|	ВидыТарифовСтраховыхВзносовУНФ.КодФСС2011 КАК КодФСС,
	|	2011 КАК ГодС,
	|	2011 КАК ГодПо
	...
	|	ВидыТарифовСтраховыхВзносовУНФ.КодПФР2012,
	|	ВидыТарифовСтраховыхВзносовУНФ.КодФСС2012,
	|	2012,
	|	2100
	|ИЗ
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ";
...
Процедура СформироватьВТРасширенныхСведенийОДоходах(НачалоПериода, ОкончаниеПериода, Организация, МенеджерВременныхТаблиц, ЕстьОтборПоФизическимЛицам = Ложь, ИсключатьДоходыРегистратора = Ложь, Регистратор = Неопределено) Экспорт
	...
	Запрос = Новый Запрос;
	Запрос.МенеджерВременныхТаблиц = МенеджерВременныхТаблиц;
	ОсновнойТариф = РегламентированнаяОтчетностьПереопределяемый.СсылкаНаОбъектПоИдентификатору("Справочник.ВидыТарифовСтраховыхВзносовУНФ", "ОбщийНалоговыйРежим");
	МалоеПредпринимательство = РегламентированнаяОтчетностьПереопределяемый.СсылкаНаОбъектПоИдентификатору("Справочник.ВидыТарифовСтраховыхВзносовУНФ", "ДляСубъектовМалогоПредпринимательства");
	ОтраслиПострадавшихОтКоронавируснойИнфекции = РегламентированнаяОтчетностьПереопределяемый.СсылкаНаОбъектПоИдентификатору("Справочник.ВидыТарифовСтраховыхВзносовУНФ", "ДляОтраслейПострадавшихОтКоронавируснойИнфекции");
	...
	Запрос.УстановитьПараметр("Патент", РегламентированнаяОтчетностьПереопределяемый.СсылкаНаОбъектПоИдентификатору("Справочник.ВидыТарифовСтраховыхВзносовУНФ", "ИндивидуальныйПредпринимательПрименяющийПатент")); 
	Запрос.УстановитьПараметр("ИсключаемыйРегистратор", ?(ИсключатьДоходыРегистратора, Регистратор, Неопределено)); 
	Запрос.УстановитьПараметр("ДатаОбъединенияВзносов",	'20230101');
	...
	МассивВидовДохода.Добавить(Справочники.ВидыДоходовПоСтраховымВзносамУНФ.ПособияЗаСчетФСС);
	МассивВидовДохода.Добавить(Справочники.ВидыДоходовПоСтраховымВзносамУНФ.ПособияЗаСчетФСС_НС);
	...
	МассивВидовДохода.Добавить(Справочники.ВидыДоходовПоСтраховымВзносамУНФ.НеОблагаетсяЦеликом);
	МассивВидовДохода.Добавить(Справочники.ВидыДоходовПоСтраховымВзносамУНФ.ОблагаетсяЦеликом);
	МассивВидовДохода.Добавить(Справочники.ВидыДоходовПоСтраховымВзносамУНФ.МатпомощьПриРожденииРебенка);
	МассивВидовДохода.Добавить(Справочники.ВидыДоходовПоСтраховымВзносамУНФ.Матпомощь);
	...
	|	СписокСотрудников.Организация КАК ГоловнаяОрганизация,
	...
	|ГДЕ
	|	СведенияОДоходах.ВидДохода <> ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.ПустаяСсылка)
	...
	|ИЗ
	|	РегистрНакопления.РасчетыСФондамиПоСтраховымВзносамУНФ.Обороты(
	...
	ТаблицаСрезаПоследнихИзВТ(Запрос.МенеджерВременныхТаблиц, "ТарифыСтраховыхВзносовУНФ", ПараметрыСрезаПоследних("ВТПериодыРасширенныхСведенийОДоходах",""), , Истина);
	ТаблицаСрезаПоследнихИзВТ(Запрос.МенеджерВременныхТаблиц, "ПрименяемыеТарифыСтраховыхВзносовУНФ", ПараметрыСрезаПоследних("ВТПериодыФизЛицОрганизаций","ГоловнаяОрганизация"), , Истина);
	
	ТекстЗапроса =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ВЫБОР
	|		КОГДА ТарифыСтраховыхВзносов.Период < &ДатаОбъединенияВзносов
	|			ТОГДА ТарифыСтраховыхВзносов.ПФР
	|		ИНАЧЕ ТарифыСтраховыхВзносов.СтавкаЕдиногоТарифа
	|	КОНЕЦ КАК ПФР,
	...
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(ТарифыСтраховыхВзносов.ВидТарифа.ЯвляетсяТарифомДляМСП, ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0)) = ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0)
	|			ТОГДА 3000
	|		ИНАЧЕ ГОД(ТарифыСтраховыхВзносов.ВидТарифа.ЯвляетсяТарифомДляМСП)
	|	КОНЕЦ КАК ГодНачалаТарифаКакМСП,
	|	ВЫБОР
	|		КОГДА ТарифыСтраховыхВзносов.Период < &ДатаОбъединенияВзносов
	|			ТОГДА ТарифыСтраховыхВзносов.ПФР + ТарифыСтраховыхВзносов.ФСС + ТарифыСтраховыхВзносов.ФФОМС + ТарифыСтраховыхВзносов.ТФОМС
	|		ИНАЧЕ ТарифыСтраховыхВзносов.СтавкаЕдиногоТарифа
	|	КОНЕЦ КАК СуммарныйТариф,
	...
	|ИЗ
	|	ВТТарифыСтраховыхВзносовУНФСрезПоследних КАК ТарифыСтраховыхВзносов
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ВидТарифа,
	|	РасчетныйПериод
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	НАЧАЛОПЕРИОДА(ПрименяемыеТарифыСтраховыхВзносовУНФ.Период, МЕСЯЦ) КАК Период,
	|	ПрименяемыеТарифыСтраховыхВзносовУНФ.ГоловнаяОрганизация КАК Организация,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(ПрименяемыеТарифыСтраховыхВзносовУНФ.ВидТарифа, &ОбщийНалоговыйРежим) = &Патент
	|			ТОГДА &ОбщийНалоговыйРежим
	|		КОГДА ЕСТЬNULL(ПрименяемыеТарифыСтраховыхВзносовУНФ.ВидТарифа, &ОбщийНалоговыйРежим) = &ДляОтраслейПострадавшихОтКоронавируснойИнфекции
	|				И (ПрименяемыеТарифыСтраховыхВзносовУНФ.Период < &НачалоПониженногоТарифаИзЗаЭпидемии
	|					ИЛИ ПрименяемыеТарифыСтраховыхВзносовУНФ.Период > &ОкончаниеПониженногоТарифаИзЗаЭпидемии)
	|			ТОГДА &ОбщийНалоговыйРежим
	|		ИНАЧЕ ЕСТЬNULL(ПрименяемыеТарифыСтраховыхВзносовУНФ.ВидТарифа, &ОбщийНалоговыйРежим)
	|	КОНЕЦ КАК ВидТарифаСтраховыхВзносов
	|ПОМЕСТИТЬ ВТИспользуемыеТарифы
	|ИЗ
	|	ВТПрименяемыеТарифыСтраховыхВзносовУНФСрезПоследних КАК ПрименяемыеТарифыСтраховыхВзносовУНФ
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ДанныеУчетаВзносов.ПериодРегистрации КАК ПериодРегистрации,
	|	ДанныеУчетаВзносов.ФизическоеЛицо КАК ФизическоеЛицо,
	|	ДанныеУчетаВзносов.Организация КАК Организация,
	...
	|	ВЫБОР
	|		КОГДА ГОД(СписокФизЛиц.ДатаРожденияФизЛица) < 1967
	|				ИЛИ СписокФизЛиц.ДатаРожденияФизЛица = &ПустаяДата
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ КАК НачислятьНакопительнуюЧасть,
	|	СписокФизЛиц.ФизическоеЛицо.Наименование КАК ФизическоеЛицоНаименование,
	|	ЕСТЬNULL(ДоходыПоФизлицам.ВидДохода, ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.ПустаяСсылка)) КАК ВидДохода,
	...
	|	ВЫБОР
	|		КОГДА ДоходыПоФизлицам.Период >= &ДатаОбъединенияВзносов
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ЕСТЬNULL(ДоходыПоФизлицам.ВидДохода.ВходитВБазуФОМС, ЛОЖЬ)
	|	КОНЕЦ КАК ВходитВБазуФОМС,
	...
	|				ТОГДА ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.Трудовой)
	|			ИНАЧЕ ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.ГражданскоПравовой)
	|		КОНЕЦ, ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.ПустаяСсылка)) КАК ТипДоговора,
	|	ЕСТЬNULL(ВЫБОР
	|			КОГДА ДоходыПоФизлицам.ВидДохода В (&ВидыДохода)
	|				ТОГДА ИСТИНА
	|			ИНАЧЕ ЛОЖЬ
	...
	|					И ДоходыПоФизлицам.Период < &ДатаОбъединенияВзносов
	|				ТОГДА ДоходыПоФизлицам.Сумма - ДоходыПоФизлицам.Скидка
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК БазаФСС,
	|	СУММА(ВЫБОР
	...
	Если Запрос.Выполнить().Выгрузить()[0].Количество > 0 Тогда
		// Формируем список лет для чтения МРОТ (подпункт 17 пункта 1 статьи 427 НК РФ).
		ИзмеренияДаты = Новый ТаблицаЗначений();
		ИзмеренияДаты.Колонки.Добавить("Период", Новый ОписаниеТипов("Дата",,,Новый КвалификаторыДаты()));
		...
		// получаем временные таблицы, используя общие алгоритмы
		ПолучитьТаблицуСрезаПоследних(Запрос.МенеджерВременныхТаблиц, "МРОТ", ИзмеренияДаты, , Истина);		
		...
		|			И СведенияОДоходах.Организация = МесяцыТарифаМСП.Организация
		|			И СведенияОДоходах.ФизическоеЛицо = МесяцыТарифаМСП.ФизическоеЛицо
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТМРОТСрезПоследних КАК МинимальнаяОплатаТрудаРФ
...
Процедура СформироватьВТРасширенныеСведенияОДоходахИВзносах(НачалоПериода, ОкончаниеПериода, Организация, МенеджерВременныхТаблиц, ЕстьОтборПоФизическимЛицам = Ложь) Экспорт 
	...
	Запрос.УстановитьПараметр("КонецОтчетногоПериода", ОкончаниеПериода);
	Запрос.УстановитьПараметр("Организация", Организация);
	Запрос.УстановитьПараметр("ОбщийНалоговыйРежим", РегламентированнаяОтчетностьПереопределяемый.СсылкаНаОбъектПоИдентификатору("Справочник.ВидыТарифовСтраховыхВзносовУНФ", "ОбщийНалоговыйРежим")); 
	Запрос.УстановитьПараметр("УпрощенныйНалоговыйРежим", РегламентированнаяОтчетностьПереопределяемый.СсылкаНаОбъектПоИдентификатору("Справочник.ВидыТарифовСтраховыхВзносовУНФ", "УпрощенныйНалоговыйРежим")); 
	Запрос.УстановитьПараметр("ЕНВД", РегламентированнаяОтчетностьПереопределяемый.СсылкаНаОбъектПоИдентификатору("Справочник.ВидыТарифовСтраховыхВзносовУНФ", "ЕНВД")); 
	...
	|	ВТСведенияОДоходах КАК СведенияОДоходах
	|ГДЕ
	|	СведенияОДоходах.ВидДохода <> ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.НеЯвляетсяОбъектом)
	|
	|СГРУППИРОВАТЬ ПО
	|	СведенияОДоходах.ФизическоеЛицо,
	|	СведенияОДоходах.НачислятьНакопительнуюЧасть,
	...
	|	СУММА(ВЫБОР
	|			КОГДА СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.НеЯвляетсяОбъектом)
	|				ТОГДА 0
	|			ИНАЧЕ СведенияОДоходах.Сумма
	|		КОНЕЦ) КАК НачисленоВсего,
	|	СУММА(ВЫБОР
	|			КОГДА СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеОткрытия)
	|					ИЛИ СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеАудиовизуальныеПроизведения)
	|					ИЛИ СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеДругиеМузыкальныеПроизведения)
	|					ИЛИ СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеЛитературныеПроизведения)
	|					ИЛИ СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеМузыкальноСценическиеПроизведение)
	|					ИЛИ СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеНаучныеТруды)
	|					ИЛИ СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеСкульптуры)
	|					ИЛИ СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеГрафическиеПроизведения)
	|					ИЛИ СведенияОДоходах.ВидДохода = ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.АвторскиеИсполнениеПроизведений)
...
Процедура СформироватьВТСоответствиеТарифаИВидаЗЛКатегории(МенеджерВременныхТаблиц)Экспорт
	...
	"ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка КАК ВидТарифаСтраховыхВзносов,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.НР) КАК КатегорияЗастрахованныхЛиц,
	|	1 КАК Порядок,
	|	2010 КАК ГодС,
	|	2100 КАК ГодПо
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ОбщийНалоговыйРежим""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.НР),
	|	1,
	|	2011,
	|	2100
	|ИЗ
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""УпрощенныйНалоговыйРежим""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""СельХозПроизводители""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""НародныеХудожественныеПромыслы""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ОрганизацияИнвалидов""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""РезидентТехникоВнедренческойЗоны""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""СМИ""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ХозОбществаБюджетныхВУЗов""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ITОрганизации""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""УпрощенныйНалоговыйРежимПроизводство""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ЕСХН""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ИЦС),
	|	6,
	|	2010,
	|	2100
	|ИЗ
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""УчастникПроектаИнновационныйЦентрСколково""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.СХ),
	|	2,
	|	2010,
	|	2014
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ХМН),
	|	2,
	|	2011,
	|	2014
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ООИ),
	|	3,
	|	2011,
	|	2014
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ТВЭЗ),
	|	3,
	|	2011,
	|	2019
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.СМИ),
	|	3,
	|	2011,
	|	2014
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ХО),
	|	3,
	|	2011,
	|	2019
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ОДИТ),
	|	3,
	|	2011,
	|	2019
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ПНЭД),
	|	3,
	|	2011,
	|	2018
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ЕСХН),
	|	4,
	|	2010,
	|	2014
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.АСБ),
	|	1,
	|	2012,
	|	2018
	|ИЗ
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""НекоммерческиеОрганизации""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""БлаготворительныеОрганизации""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ОрганизацииОказывающиеИнжиниринговыеУслуги""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ДляФармацевтовАптек""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ЧЭС),
	|	3,
	|	2012,
	|	2027
	|ИЗ
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ДляЧленовЭкипажейМорскихСудовПодФлагомРФ""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ИндивидуальныйПредпринимательПрименяющийПатент""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.КВ),
	|	6,
	|	2020,
	|	2020
	|ИЗ
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ДляОтраслейПострадавшихОтКоронавируснойИнфекции""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ЕНВД""
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ВидыТарифовСтраховыхВзносовУНФ.Ссылка,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.МС),
	|	1,
	|	2020,
	|	2100
	|ИЗ
	|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
	|ГДЕ
	|	ВидыТарифовСтраховыхВзносовУНФ.ИдентификаторОбъекта = ""ДляСубъектовМалогоПредпринимательства""
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	СоответствиеТарифаКатегории.ГодПо КАК ГодПо,
	...
	|ГДЕ
	|	СоответствиеТарифаКатегории.ГодПо >= 2012";
	Запрос.Выполнить();
...
Процедура СформироватьВТДанныеОФактеНачисленияВзносовВПФР(МенеджерВременныхТаблиц, Организация, НачалоПериода, ОкончаниеПериода)  Экспорт
	...
	|	СУММА(ВЫБОР
	|			КОГДА РасчетыСФондамиПоСтраховымВзносамОбороты.ВидОбязательногоСтрахованияСотрудников В (ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРПоСуммарномуТарифу))
	|				ТОГДА РасчетыСФондамиПоСтраховымВзносамОбороты.СуммаПриход
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ПФРНаОПС,
...
Процедура СоздатьВТСведенияОЗаработке2014(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияЗаработка, ПараметрыОтбора) Экспорт
	ВариантыИсточниковДанныхСведенийОЗаработке = ПерсонифицированныйУчетУНФ.ВариантыИсточниковДанныхСведенийОЗаработке();	
...
Процедура СоздатьВТСведенияОЗаработкеИзДанныхУчета2014(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияЗаработка, ПараметрыОтбора, ПостфиксВТРезульт = "")
	...
	Иначе
		...
		|	0 КАК ОблагаетсяВзносамиСвышеПредельнойВеличины,
		|	0 КАК ПоДоговорамГПХДоПредельнойВеличины,
		|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ПустаяСсылка) КАК КатегорияЗастрахованныхЛиц,
		|	ЛОЖЬ КАК ФиксЗаработок
...
Процедура СоздатьТаблицыСведенийОЗаработке(Организация, ОтчетныйПериод, ПараметрыПолученияЗаработка, ПараметрыОтбора, ПостфиксВТРезульт, ТаблицыЗаработка)
	...
	ОкончаниеПериода = ПерсонифицированныйУчетКлиентСерверУНФ.ОкончаниеОтчетногоПериодаПерсУчета(ОтчетныйПериод);
	...
	|	И СведенияОДоходах.ВидДохода <> ЗНАЧЕНИЕ(Справочник.ВидыДоходовПоСтраховымВзносамУНФ.НеЯвляетсяОбъектом)
...
Процедура СоздатьВТКорректируемыеДокументыПоЗастрахованнымЛицам(МенеджерВременныхТаблиц, КорректируемыеДокументы, ПараметрыОтбора)
	...
	|	ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.ПустаяСсылка)  КАК ТипДоговора,
	...
	|ВЫБРАТЬ
	|	СотрудникиДокумента.Сотрудник,
	|	ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ПустаяСсылка),
	|	ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.ПустаяСсылка),
	|	СотрудникиДокумента.Ссылка.ОтчетныйПериод,
	|	ВЫБОР
	|		КОГДА СотрудникиДокумента.Ссылка.ТипСведенийСЗВ = ЗНАЧЕНИЕ(Перечисление.ТипыСведенийСЗВ.Исходная)
	|			ТОГДА СотрудникиДокумента.Ссылка.ОтчетныйПериод
	...
	Если ВыборкаДанныхСотрудников.Следующий() Тогда
		...
		Если ЗначениеЗаполнено(ВыборкаДанныхСотрудников.ДатаНачалаПериода) Тогда	
			...
			Если НоваяСтрокаЗаписиОСтаже.Свойство("НомерОсновнойЗаписи") Тогда
				ПерсонифицированныйУчетКлиентСерверУНФ.ВыполнитьНумерациюЗаписейОСтаже(МассивСтрокЗаписиОСтаже);
			КонецЕсли;
		КонецЕсли;
...
Процедура СформироватьВТНачисленныхВзносахИзДокументов(МенеджерВТ, МассивДокументов, РасчетныйПериод, КорректирующиеСведения = Ложь)
	...
	Запрос.УстановитьПараметр("ТарифМоряков", РегламентированнаяОтчетностьПереопределяемый.СсылкаНаОбъектПоИдентификатору("Справочник.ВидыТарифовСтраховыхВзносовУНФ", "ДляЧленовЭкипажейМорскихСудовПодФлагомРФ"));
	Запрос.Текст =  
	"ВЫБРАТЬ
...
Процедура СформироватьВТОстаткиРасчетовСПФРПоСотрудникамИзДокументов(МенеджерВТ, Организация, ОтчетныйПериод, МассивДокументов = Неопределено)
	...
	|		СтраховыеВзносыПереданныеВПФРОстатки.КатегорияЗастрахованныхЛицУНФ КАК КатегорияЗастрахованныхЛиц,
	...
	|					И (ФизическоеЛицо, КатегорияЗастрахованныхЛицУНФ) В
	|						(ВЫБРАТЬ
...
Процедура СформироватьВТСДаннымиНачисленийДляРасчетаВзносов(МенеджерВТ, Организация, ОтчетныйПериод, ДатаАктуальности, МассивФизЛиц = Неопределено)Экспорт
	...
	|	ЕСТЬNULL(СоответствиеТарифаИВидаЗЛКатегории.КатегорияЗастрахованныхЛиц, ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ПустаяСсылка)) КАК КатегорияЗастрахованныхЛиц,
	|	ВЫБОР
	|		КОГДА &ОтчетныйГод > 2012
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.Трудовой)
	|		ИНАЧЕ ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.ПустаяСсылка)
...
Функция ТаблицаСРаспределениемУплаченныхВзносов(МенеджерВТ, Организация, ОтчетныйПериод, ДатаАктуальности)
	...
	|ВЫБРАТЬ
	|	СУММА(ВЫБОР
	|			КОГДА РасчетыПоСтраховымВзносамОбороты.ВидОбязательногоСтрахованияСотрудников = ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРСтраховая)
	|				ТОГДА РасчетыПоСтраховымВзносамОбороты.СуммаРасход
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ПФРСтраховаяРасход,
	|	СУММА(ВЫБОР
	|			КОГДА РасчетыПоСтраховымВзносамОбороты.ВидОбязательногоСтрахованияСотрудников = ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРНакопительная)
	|				ТОГДА РасчетыПоСтраховымВзносамОбороты.СуммаРасход
	|			ИНАЧЕ 0
	...
	|			&КонецПериодаУплаты,
	|			,
	|			(ВидОбязательногоСтрахованияСотрудников = ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРСтраховая)
	|				ИЛИ ВидОбязательногоСтрахованияСотрудников = ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРНакопительная))
	...
	|ВЫБРАТЬ
	|	СУММА(ВЫБОР
	|			КОГДА РасчетыПоСтраховымВзносамОстатки.ВидОбязательногоСтрахованияСотрудников = ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРСтраховая)
	|					И РасчетыПоСтраховымВзносамОстатки.СуммаОстаток < 0
	|				ТОГДА -РасчетыПоСтраховымВзносамОстатки.СуммаОстаток
	|			ИНАЧЕ 0
	|		КОНЕЦ),
	|	СУММА(ВЫБОР
	|			КОГДА РасчетыПоСтраховымВзносамОстатки.ВидОбязательногоСтрахованияСотрудников = ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРНакопительная)
	|					И РасчетыПоСтраховымВзносамОстатки.СуммаОстаток < 0
	|				ТОГДА -РасчетыПоСтраховымВзносамОстатки.СуммаОстаток
	|			ИНАЧЕ 0
	|		КОНЕЦ),
	|	""Переплата""
	|ИЗ
	|	РегистрНакопления.РасчетыСФондамиПоСтраховымВзносамУНФ.Остатки(
	|			&ОтчетныйПериод,
	|			(ВидОбязательногоСтрахованияСотрудников = ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРСтраховая)
	|				ИЛИ ВидОбязательногоСтрахованияСотрудников = ЗНАЧЕНИЕ(Перечисление.ВидыОбязательногоСтрахованияСотрудниковУНФ.ПФРНакопительная))
	...
	|	ВЫБОР
	|		КОГДА КатегорииУплатыПрошлыхПериодов.КатегорияЗастрахованныхЛиц В (ЗНАЧЕНИЕ(перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ПустаяСсылка), ЗНАЧЕНИЕ(перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.ЧЭС))
	|			ТОГДА ЗНАЧЕНИЕ(перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.НР)
	|		ИНАЧЕ ЕСТЬNULL(КатегорииУплатыПрошлыхПериодов.КатегорияЗастрахованныхЛиц, ЗНАЧЕНИЕ(перечисление.КатегорииЗастрахованныхЛицДляПФРУНФ.НР))
...
Процедура СформироватьВТСКорректировкойДанныхОВзносахПФР(МенеджерВТ, Организация, Дата, КорректируемыйПериод, КатегорияЗастрахованныхЛиц) Экспорт 
	...
	|	СтраховыеВзносыПереданныеВПФРОбороты.КатегорияЗастрахованныхЛицУНФ КАК КатегорияЗастрахованныхЛиц,
...
Процедура СформироватьТаблицуВТФизическиеЛицаРаботавшиеВОрганизации(МенеджерВременныхТаблиц, Организация, НачалоПериода, ОкончаниеПериода) Экспорт
	...
	|ПОМЕСТИТЬ ВТФизическиеЛицаРаботавшиеВОрганизации
	|ИЗ
	|	Документ.ПриемНаРаботуУНФ.Сотрудники КАК ПериодыРаботыСотрудниковДатаПриема
...
Процедура ПодготовитьВТТаблицаСтажа(МенеджерВТ, Организация, НачалоПериода, ОкончаниеПериода, ИмяВременнойТаблицы, МассивФизЛиц = Неопределено)Экспорт
	...
	Запрос.УстановитьПараметр("ОкончаниеПериода", ОкончаниеПериода);
	Запрос.УстановитьПараметр("Организация", Организация);
	Запрос.УстановитьПараметр("ТипДоговора", ?(Год(НачалоПериода) >= 2013, Перечисления.ТипыДоговоровСЗВ63УНФ.Трудовой, Перечисления.ТипыДоговоровСЗВ63УНФ.ПустаяСсылка()));
	...
	|			И (ПериодыРаботыСотрудниковДатаУвольнения.СтруктурнаяЕдиница = ЗНАЧЕНИЕ(Справочник.СтруктурныеЕдиницы.ПустаяСсылка))
	|			И (ПериодыРаботыСотрудниковДатаУвольнения.Регистратор ССЫЛКА Документ.УвольнениеУНФ)
	|ГДЕ
	|	ПериодыРаботыСотрудниковДатаПриема.Организация = &Организация
	|	И ПериодыРаботыСотрудниковДатаПриема.Регистратор ССЫЛКА Документ.ПриемНаРаботуУНФ
	|	И ПериодыРаботыСотрудниковДатаПриема.СтруктурнаяЕдиница <> ЗНАЧЕНИЕ(Справочник.СтруктурныеЕдиницы.ПустаяСсылка)
	|	И ПериодыРаботыСотрудниковДатаПриема.Период <> ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0)
	|	И ПериодыРаботыСотрудниковДатаПриема.Период <= &ОкончаниеПериода
	|	И (ПериодыРаботыСотрудниковДатаУвольнения.Период ЕСТЬ NULL
...
Процедура СформироватьТаблицуВТКадровыеДанныеФизическихЛицСПериодом(МенеджерВременныхТаблиц, ИмяВременнойТаблицыОтборовФизическихЛиц, АдреснаяИнформация = Ложь, ДатаПолученияДанных) Экспорт
	...
	Если АдреснаяИнформация Тогда
		...
		|		ГДЕ
		|			ФизическиеЛицаКонтактнаяИнформация.Вид = ЗНАЧЕНИЕ(Справочник.ВидыКонтактнойИнформации.АдресПоПропискеФизическиеЛица)) КАК АдресДляИнформированияФизическиеЛица
	...
	Иначе
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ФИОФизическихЛиц.СрезПоследних(&ДатаПолученияДанных) КАК ФИОФизическихЛиц
		...
		|		ПО ДокументыФизическихЛиц.Физлицо = ФИОФизическихЛиц.ФизическоеЛицо
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ФизическоеЛицо
		|;";
...
Функция КатегорииЗастрахованныхЛицОрганизации(Организация, ОтчетныйПериод) Экспорт
	...
	ТекстЗапроса = 
	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	ПрименяемыеТарифыСтраховыхВзносовУНФ.ВидТарифа КАК ВидТарифаСтраховыхВзносов
	...
	|ГДЕ
	|	ПрименяемыеТарифыСтраховыхВзносовУНФ.Период МЕЖДУ &ОтчетныйПериод И &ОкончаниеОтчетногоПериода
	|	И ПрименяемыеТарифыСтраховыхВзносовУНФ.ГоловнаяОрганизация = &Организация
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ
	|	ПрименяемыеТарифыСтраховыхВзносовУНФСрезПоследних.ВидТарифа
	|ИЗ
	|	РегистрСведений.ПрименяемыеТарифыСтраховыхВзносовУНФ.СрезПоследних(&ОтчетныйПериод, ГоловнаяОрганизация = &Организация) КАК ПрименяемыеТарифыСтраховыхВзносовУНФСрезПоследних
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	Если СписокКатегорийЗастрахованныхЛиц.Количество() = 0 Тогда
		СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.НР, "НАЕМ/РАБОТНИК");
		Если Год(ОтчетныйПериод) >= 2012 Тогда
			СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ВЖНР, "ВР. ПРОЖИВАЮЩИЙ/НАЕМ/РАБОТНИК");
			СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ВПНР, "ВР. ПРЕБЫВАЮЩИЙ/НАЕМ/РАБОТНИК");
		КонецЕсли;
		Если Год(ОтчетныйПериод) = 2010 Тогда
			СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ОЗОИ, "ОСОБАЯ/ЗОНА/ОРГАНИЗАЦИИ ИНВАЛИДОВ");
		ИначеЕсли Год(ОтчетныйПериод) < 2015 Тогда
			СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ООИ);
			Если Год(ОтчетныйПериод) >= 2012 Тогда
				СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ВЖОИ);
				СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ВПОИ);
			КонецЕсли;
		КонецЕсли;
	Иначе
		Если Год(ОтчетныйПериод) = 2010 Тогда
			Если СписокКатегорийЗастрахованныхЛиц.НайтиПоЗначению(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ОЗОИ) = Неопределено Тогда 	
				СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ОЗОИ, "ОСОБАЯ/ЗОНА/ОРГАНИЗАЦИИ ИНВАЛИДОВ");
			КонецЕсли;
		ИначеЕсли Год(ОтчетныйПериод) < 2015 Тогда
			Если СписокКатегорийЗастрахованныхЛиц.НайтиПоЗначению(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ООИ) = Неопределено Тогда 	
				СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ООИ);
			КонецЕсли;
			Если Год(ОтчетныйПериод) >= 2012 Тогда
				Если СписокКатегорийЗастрахованныхЛиц.НайтиПоЗначению(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ВЖОИ) = Неопределено Тогда 	
					СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ВЖОИ);
				КонецЕсли;
				Если СписокКатегорийЗастрахованныхЛиц.НайтиПоЗначению(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ВПОИ) = Неопределено Тогда 	
					СписокКатегорийЗастрахованныхЛиц.Добавить(Перечисления.КатегорииЗастрахованныхЛицДляПФРУНФ.ВПОИ);
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
...
Функция СохранитьФайлВыгрузкиСЗВМ(Документ) Экспорт
	...
	ТекстФайла = Документы.СведенияОЗастрахованныхЛицахСЗВ_М.СформироватьВыходнойФайл(Документ);
	ИмяСформированногоФайла = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Документ, "ИмяФайлаДляПФР");
...
Функция ДоходыЗаПериод2013(Организация, ОтчетныйПериод, КатегорияЗастрахованныхЛиц = Неопределено, ТипДоговора = Неопределено, МассивФизлиц = Неопределено) Экспорт
	...
	|		СведенияОДоходах.ВидТарифаСтраховыхВзносов КАК ВидТарифаСтраховыхВзносов,
	|		ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.Трудовой) КАК ТипДоговора,
	...
	|		МЕСЯЦ(СведенияОДоходах.Период),
	|		СведенияОДоходах.ВидТарифаСтраховыхВзносов,
	|		ЗНАЧЕНИЕ(Перечисление.ТипыДоговоровСЗВ63УНФ.ГражданскоПравовой),
...
Процедура ВписатьЗаписиОСтажеВНаборДанных2014(УзелПачкаВходящихДокументов, ФорматСтажевыйПериод, ВыборкаПоСотрудникам) Экспорт	
	...
	ПараметрыСтажаСПравомНаДосрочнуюПенсию = ПерсонифицированныйУчетУНФ.ПараметрыИсчисляемогоСтажаПредусматривающиеПравоНаДосрочнуюПенсию();
...
Функция ЗапросВТКадровыеДанныеСотрудников(ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, КадровыеДанные, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень, ИсточникиДанных, ИмяВТКадровыеДанныеСотрудников) Экспорт
	...
	Если ИмяВТКадровыеДанныеСотрудников = "ВТСотрудникиСДаннымиОПриеме" Тогда
		...
		|	ЕСТЬNULL(ТекущиеКадровыеДанныеСотрудниковУНФ.ДатаПриема, ДАТАВРЕМЯ(1, 1, 1)) КАК ДатаПриема,
		|	ПриемНаРаботуУНФ.Ссылка КАК ПриказОПриеме
		|ПОМЕСТИТЬ ВТТаблица
		|ИЗ
		...
		|		ПО (ТекущиеКадровыеДанныеСотрудниковУНФ.Сотрудник = ТаблицаОтборов.Сотрудник)
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ПриемНаРаботуУНФ.Сотрудники КАК ПриемНаРаботуУНФ
		|		ПО (ПриемНаРаботуУНФ.Сотрудник = ТекущиеКадровыеДанныеСотрудниковУНФ.Сотрудник)
		|			И (ТекущиеКадровыеДанныеСотрудниковУНФ.ДатаПриема = ПриемНаРаботуУНФ.Период)";
	Иначе
		Запрос.Текст = 
		"ВЫБРАТЬ
		...
		|	ТекущиеКадровыеДанныеСотрудниковУНФ.СтруктурнаяЕдиница КАК Подразделение,
		|	ТекущиеКадровыеДанныеСотрудниковУНФ.ТекущаяДолжность КАК Должность,
		|	NULL КАК ВидЗанятости,
		|	NULL КАК КлассУсловийТруда,
		|	ТекущиеКадровыеДанныеСотрудниковУНФ.ТекущаяТарифнаяСтавка КАК ТарифнаяСтавка,
		|	ТекущиеКадровыеДанныеСотрудниковУНФ.Организация КАК ГоловнаяОрганизация,
		|	0 КАК ПроцентСевернойНадбавки,
		|	ВЫБОР
		|		КОГДА ФИОФизическихЛиц.Фамилия ЕСТЬ NULL
		|			ТОГДА ТаблицаОтборов.Сотрудник.Наименование
		|		ИНАЧЕ ФИОФизическихЛиц.Фамилия + "" "" + ФИОФизическихЛиц.Имя + "" "" + ФИОФизическихЛиц.Отчество
		|	КОНЕЦ КАК ФИОПолные,
		|	ЕСТЬNULL(ФИОФизическихЛиц.Фамилия, """") КАК Фамилия,
		|	ЕСТЬNULL(ФИОФизическихЛиц.Имя, """") КАК Имя,
		|	ЕСТЬNULL(ФИОФизическихЛиц.Отчество, """") КАК Отчество,
		...
		|	ЕСТЬNULL(ТекущиеКадровыеДанныеСотрудниковУНФ.ДатаПриема, ДАТАВРЕМЯ(1, 1, 1)) КАК ДатаПриема,
		|	ЕСТЬNULL(ТекущиеКадровыеДанныеСотрудниковУНФ.ДатаУвольнения, ДАТАВРЕМЯ(1, 1, 1)) КАК ДатаУвольнения,
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ТекущиеКадровыеДанныеСотрудниковУНФ КАК ТекущиеКадровыеДанныеСотрудниковУНФ
		|		ПО (ТекущиеКадровыеДанныеСотрудниковУНФ.Сотрудник = ТаблицаОтборов.Сотрудник)
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ФИОФизическихЛиц.СрезПоследних КАК ФИОФизическихЛиц
		...
		|			И (АдресФизЛица.Вид = ЗНАЧЕНИЕ(Справочник.ВидыКонтактнойИнформации.АдресМестаПроживанияФизическиеЛица))";
	КонецЕсли;
...
//
// Возвращаемое значение:
//	Массив значений типа СправочникСсылка.ВидыТарифовСтраховыхВзносовУНФ.
//
Функция ДоступныеТарифыСтраховыхВзносов(ВидОрганизации, ПрименяетсяУСН, ПоказыватьТарифыПрименяемыеПоОтдельнымДоходам) Экспорт
	...
	Если ВидОрганизации = Неопределено Тогда
		Если ПрименяетсяУСН = Неопределено Тогда
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ОбщийНалоговыйРежим);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.УпрощенныйНалоговыйРежим);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.УпрощенныйНалоговыйРежимПроизводство);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.АУСН);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ДляСубъектовМалогоПредпринимательства);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ДляОтраслейПострадавшихОтКоронавируснойИнфекции);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.СельХозПроизводители);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ИндивидуальныйПредпринимательПрименяющийПатент);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацияИнвалидов);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ITОрганизации);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацииРазработчикиЭлектроннойПродукции);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.Мультипликаторы);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.СМИ);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.НекоммерческиеОрганизации);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.БлаготворительныеОрганизации);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.РезидентТехникоВнедренческойЗоны);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.УчастникПроектаИнновационныйЦентрСколково);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.РезидентОсобойЗоныВКалининградскойОбласти);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.РезидентПортаВладивосток);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.РезидентТерриторииОпережающегоСоциальноЭкономическогоРазвития);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.УчастникОсобойЗоныВКрыму);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ХозОбществаБюджетныхВУЗов);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацииОказывающиеИнжиниринговыеУслуги);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ЕСХН);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.НародныеХудожественныеПромыслы);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ИнновационныеНаучноТехнологическиеЦентры);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацииЗанимающиесяОбщепитом);
			ДоступныеТарифы.Добавить(Справочники.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацииКурильскихОстровов);
	...
	Если ПоказыватьТарифыПрименяемыеПоОтдельнымДоходам Тогда
		...
		|	Справочник.ВидыТарифовСтраховыхВзносовУНФ КАК ВидыТарифовСтраховыхВзносовУНФ
		|ГДЕ
		|	ВидыТарифовСтраховыхВзносовУНФ.ПрименяетсяПоОтдельнымДоходам
		|
		|УПОРЯДОЧИТЬ ПО
		...
		КонецЦикла;
	КонецЕсли;
	ПриПолученииДоступныхТарифовСтраховыхВзносов(ДоступныеТарифы);
...
//
// Параметры:
//		ДоступныеТарифы - Массив ссылок на элементы справочника ВидыТарифовСтраховыхВзносовУНФ
//
...
//
// Параметры:
//	ТарифСтраховыхВзносов - СправочникСсылка.ВидыТарифовСтраховыхВзносовУНФ -
//
// Возвращаемое значение:
//	Строка.
// 
Функция ОписаниеВидаТарифа(ТарифСтраховыхВзносов) Экспорт
	...
	ОписаниеТарифа = "";	
	Если ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ОбщийНалоговыйРежим") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.УпрощенныйНалоговыйРежим") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ЕНВД") Тогда
		ОписаниеТарифа = НСтр("ru='С 2017 года применяются ставки основного тарифа страховых взносов, установленные статьями 425 и 426 НК РФ (с 2011 по 2016 годы -  статьями 12 и 58.2 Федерального закона от 24 июля 2009 г. № 212-ФЗ)'")
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.СельХозПроизводители") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ЕСХН") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацияИнвалидов") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.НародныеХудожественныеПромыслы") Тогда
		ОписаниеТарифа = НСтр("ru='С 2017 года применяются ставки основного тарифа страховых взносов, установленные статьями 425 и 426 НК РФ (на 2010 год тариф был установлен пунктом 1 части 2 статьи 57, на 2011-2014 годы пунктом 1 части 1 статьи 58, в 2015 и 2016 годах применялись ставки основного тарифа страховых взносов, установленные статьями 12 и 58.2 Федерального закона от 24 июля 2009 г. № 212-ФЗ)'")
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.СМИ") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацииОказывающиеИнжиниринговыеУслуги") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ХозОбществаБюджетныхВУЗов") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.РезидентТехникоВнедренческойЗоны") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ITОрганизации") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ДляЧленовЭкипажейМорскихСудовПодФлагомРФ") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.УпрощенныйНалоговыйРежимПроизводство") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ДляФармацевтовАптек") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.НекоммерческиеОрганизации") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.БлаготворительныеОрганизации") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ИндивидуальныйПредпринимательПрименяющийПатент") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.УчастникПроектаИнновационныйЦентрСколково") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.УчастникОсобойЗоныВКрыму") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.РезидентТерриторииОпережающегоСоциальноЭкономическогоРазвития") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.РезидентПортаВладивосток") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.РезидентОсобойЗоныВКалининградскойОбласти") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.Мультипликаторы") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.УчастникСпециальныхАдминистративныхРайонов") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ДляСубъектовМалогоПредпринимательства") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ДляОтраслейПострадавшихОтКоронавируснойИнфекции") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацииРазработчикиЭлектроннойПродукции") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ИнновационныеНаучноТехнологическиеЦентры") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацииЗанимающиесяОбщепитом") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.ОрганизацииКурильскихОстровов") Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = ПредопределенноеЗначение("Справочник.ВидыТарифовСтраховыхВзносовУНФ.АУСН") Тогда
