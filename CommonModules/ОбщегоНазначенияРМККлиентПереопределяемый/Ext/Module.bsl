...
//
// Параметры:
//  СтруктураСозданияКода - Структура - переданная стуруктура для создания персонального кода
...
// Проверка профля группы доступа пользователя принадлежности профилей Кассир или СтрашийКассир
//
// Параметры:
//  ВыбраннаяГруппа - ОпределяемыйТип.ГруппаДоступаРМК - пользовать 1С.
//  ПрофильКассира - Булево - призак принадлежности пользователя к профилю кассир.
//
