...
Процедура ДополнитьОписанияКодовМаркировки(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля) Экспорт
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.НикотиносодержащаяПродукция Тогда
		...
		ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияDataMatrixGS1(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
		ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияDataMatrixGS1(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Набор);
		
		ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияDataMatrix(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Духи
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.ЛегкаяПромышленность Тогда
		
		ОписаниеКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Набор);
		
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Шины
		Или ВидПродукции = Перечисления.ВидыПродукцииИС.Велосипеды Тогда
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.КреслаКоляски Тогда
		...
		ОписаниеКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
		ОписаниеКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Набор);
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.МолочнаяПродукцияБезВЕТИС
		...
		ОписаниеКодаМаркировкиМолочнаяПродукция(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиМолочнаяПродукция(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
		ОписаниеКодаМаркировкиМолочнаяПродукция(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Набор);
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Фотоаппараты Тогда
		...
		ОписаниеКодаМаркировкиФотоаппаратов(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиФотоаппаратов(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Набор);
		
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.УпакованнаяВода Тогда
		
		ОписаниеКодаМаркировкиПродукцииУпакованнаяВода(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиПродукцииУпакованнаяВода(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
		
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Пиво Тогда
		
		ОписаниеКодаМаркировкиПродукцииПиво(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиПродукцииПиво(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
		
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.БАДы Тогда
		
		ОписаниеКодаМаркировкиПродукцииБАДы(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиПродукцииБАДы(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
		ОписаниеКодаМаркировкиПродукцииБАДы(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Набор);
		
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.Антисептики Тогда
		
		ОписаниеКодаМаркировкиПродукцииАнтисептики(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиПродукцииАнтисептики(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
		ОписаниеКодаМаркировкиПродукцииАнтисептики(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Набор);
		
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.СоковаяПродукция Тогда
	
		ОписаниеКодаМаркировкиПродукцииСоковаяПродукция(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиПродукцииСоковаяПродукция(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
		ОписаниеКодаМаркировкиПродукцииСоковаяПродукция(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Набор);
	
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.БезалкогольноеПиво Тогда

		ОписаниеКодаМаркировкиПродукцииБезалкогольноеПиво(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);

	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.МорепродуктыПодконтрольныеВЕТИС Тогда
		
		ОписаниеКодаМаркировкиПродукцииМорепродукты(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Потребительская);
		ОписаниеКодаМаркировкиПродукцииМорепродукты(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, Перечисления.ВидыУпаковокИС.Групповая);
...
// Формирует описание кода маркировки для продукции: Легкая промышленность, Духи, Шины, Велосипелы, Медицинские изделия.
Процедура ОписаниеКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
Процедура ОписаниеКодаМаркировкиФотоаппаратов(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
Процедура ОписаниеКодаМаркировкиМолочнаяПродукция(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
Процедура ОписаниеКодаМаркировкиПродукцииУпакованнаяВода(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
Процедура ОписаниеКодаМаркировкиПродукцииПиво(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
Процедура ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияDataMatrixGS1(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
Процедура ОписаниеКодаМаркировкиПродукцииНикотиносодержащаяПродукцияDataMatrix(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
// Формирует описание кода маркировки для БАДы
Процедура ОписаниеКодаМаркировкиПродукцииБАДы(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
	...
	ОписаниеКодаМаркировкиПродукцииБАДыСтандартныйКМ(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки);
	
КонецПроцедуры

// Формирует описание кода маркировки для БАДы - Стандартный КМ
Процедура ОписаниеКодаМаркировкиПродукцииБАДыСтандартныйКМ(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
	
	Алфавит = ДанныеОписанийКодаМаркировки.Алфавит;
	
	ОписаниеЭлементовКМ = Новый Структура;
	ОписаниеЭлементовКМ.Вставить("GTIN",          ОписаниеЭлементаКодаМаркировки("01", "GTIN",          14));
	ОписаниеЭлементовКМ.Вставить("СерийныйНомер", ОписаниеЭлементаКодаМаркировки("21", "СерийныйНомер", 13, Алфавит.БуквыЦифрыЗнаки));
...
// Формирует описание кода маркировки для Антисептики
Процедура ОписаниеКодаМаркировкиПродукцииАнтисептики(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
	...
	ОписаниеКодаМаркировкиПродукцииАнтисептикиСтандартныйКМ(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки);

КонецПроцедуры

// Формирует описание кода маркировки для Антисептики - Стандартный КМ
Процедура ОписаниеКодаМаркировкиПродукцииАнтисептикиСтандартныйКМ(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
Процедура ОписаниеКодаМаркировкиПродукцииМорепродукты(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
	...
	ОписаниеКодаМаркировкиПродукцииМорепродуктыСтандартныйКМ(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки);
	
КонецПроцедуры

// Формирует описание кода маркировки для Морепродукты - Стандартный КМ
Процедура ОписаниеКодаМаркировкиПродукцииМорепродуктыСтандартныйКМ(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
	
	Алфавит = ДанныеОписанийКодаМаркировки.Алфавит;
	
	ОписаниеЭлементовКМ = Новый Структура;
	ОписаниеЭлементовКМ.Вставить("GTIN",          ОписаниеЭлементаКодаМаркировки("01", "GTIN",          14));
	ОписаниеЭлементовКМ.Вставить("СерийныйНомер", ОписаниеЭлементаКодаМаркировки("21", "СерийныйНомер",  6, Алфавит.БуквыЦифрыЗнаки));
	ОписаниеЭлементовКМ.Вставить("КлючПроверки",  ОписаниеЭлементаКодаМаркировки("91", "КлючПроверки",   4, Алфавит.БуквыЦифрыЗнаки));
	ОписаниеЭлементовКМ.Вставить("Подпись",       ОписаниеЭлементаКодаМаркировки("92", "Подпись",       44, Алфавит.БуквыЦифрыЗнаки));
...
// Формирует описание кода маркировки для СоковаяПродукция
Процедура ОписаниеКодаМаркировкиПродукцииСоковаяПродукция(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
...
// Формирует описание кода маркировки для БезалкогольноеПиво
Процедура ОписаниеКодаМаркировкиПродукцииБезалкогольноеПиво(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля, ВидУпаковки)
