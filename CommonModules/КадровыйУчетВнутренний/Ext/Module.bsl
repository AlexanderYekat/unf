...
Функция ПутьКДаннымСведенийОКлассахУсловийТруда(ИмяПоля) Экспорт
	...
	Возврат КадровыйУчетБазовый.ПутьКДаннымСведенийОКлассахУсловийТруда(ИмяПоля);
...
Функция ПутьКДаннымСведенийОбУсловияхДоговоровОпеки(ИмяПоля) Экспорт
	...
	Возврат КадровыйУчетБазовый.ПутьКДаннымСведенийОбУсловияхДоговоровОпеки(ИмяПоля);
...
Функция ДобавитьПолеСведенийМестРаботыСотрудников(ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
	...
	Возврат КадровыйУчетБазовый.ДобавитьПолеСведенийМестРаботыСотрудников(ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных);
	
КонецФункции

Функция ПутьКДаннымСведенийМестРаботыСотрудников(Знач ИмяПоля) Экспорт
	
	Возврат КадровыйУчетБазовый.ПутьКДаннымСведенийМестРаботыСотрудников(ИмяПоля);
...
Функция ДанныеОтсутствийСотрудникаДляПособияПоБезработице(КадровыеДанныеСотрудников) Экспорт
	...
	Возврат КадровыйУчетБазовый.ДанныеОтсутствийСотрудникаДляПособияПоБезработице(КадровыеДанныеСотрудников);
...
Функция СвязанныеОбъектыДанныхФизическогоЛица(ДанныеФизическогоЛица) Экспорт
	...
	Возврат КадровыйУчетБазовый.СвязанныеОбъектыДанныхФизическогоЛица(ДанныеФизическогоЛица);
...
Функция ПриостановленияТрудовыхДоговоров(ТолькоРазрешенные, ТаблицаОтбора, Отбор) Экспорт
	...
	Возврат КадровыйУчетБазовый.ПриостановленияТрудовыхДоговоров(ТолькоРазрешенные, ТаблицаОтбора, Отбор);
	
КонецФункции

Функция ЗаполнитьДанныеДокументовПоИностраннымГражданам(ДанныеДляЗаполнения, СсылкаНаДокумент) Экспорт
	
	Возврат КадровыйУчетБазовый.ЗаполнитьДанныеДокументовПоИностраннымГражданам(ДанныеДляЗаполнения, СсылкаНаДокумент);
