...
Процедура ОписаниеПоказателей_РСВ_2023Кв1(ПоказателиОтчета) Экспорт
	 ОписаниеПоказателей_РСВ_2023(ПоказателиОтчета)
КонецПроцедуры

Процедура ОписаниеПоказателей_РСВ_2023Кв3(ПоказателиОтчета) Экспорт
	 ОписаниеПоказателей_РСВ_2023(ПоказателиОтчета, Истина)
КонецПроцедуры

Процедура ЗначенияПоказателей_РСВ_2023Кв1(ПараметрыОтчета, Контейнер) Экспорт
	
	ЗначенияПоказателей_РСВ_2023(ПараметрыОтчета, Контейнер)
	
КонецПроцедуры

Процедура ЗначенияПоказателей_РСВ_2023Кв3(ПараметрыОтчета, Контейнер) Экспорт
	
	ЗначенияПоказателей_РСВ_2023(ПараметрыОтчета, Контейнер, Истина)
	
КонецПроцедуры


Процедура ОписаниеПоказателей_РСВ_2023(ПоказателиОтчета, ВыделятьМеждународныеДоговоры = Ложь)
	...
	Если Не ВыделятьМеждународныеДоговоры Тогда
		Возврат
	КонецЕсли;
	...
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М101001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М102001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М103001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М104001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М105001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М106001", Истина, Истина);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М107001", Истина, Истина);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М107002", Истина, Истина);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М107003", Истина, Истина);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00105М107004", Истина, Истина);
	
КонецПроцедуры

Процедура ЗначенияПоказателей_РСВ_2023(ПараметрыОтчета, Контейнер, ВыделятьМеждународныеДоговоры = Ложь)
	...
	// очищаем разделы
	ПоказателиОтчета = Новый Структура;
	ОписаниеПоказателей_РСВ_2023(ПоказателиОтчета, ВыделятьМеждународныеДоговоры);
	...
	Иначе
		...
		Если ВыделятьМеждународныеДоговоры Тогда
			КлючиСтруктурыОписанийТаблиц = КлючиСтруктурыОписанийТаблиц 
	...
	// Раздел 3
	Если ВсеФизлица.Количество() > 0 Тогда
		КатегорииНулевыхДоходов = Новый Соответствие;
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.МС, Перечисления.КатегорииЗастрахованныхЛицДляПФР.НР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖМС, Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖНР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПМС, Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПНР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ОВЭД, Перечисления.КатегорииЗастрахованныхЛицДляПФР.НР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖОВ, Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖНР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПОВ, Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПНР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ИЦС, Перечисления.КатегорииЗастрахованныхЛицДляПФР.НР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖЦС, Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖНР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПЦС, Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПНР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ИНТЦ, Перечисления.КатегорииЗастрахованныхЛицДляПФР.НР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖТЦ, Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖНР);
		КатегорииНулевыхДоходов.Вставить(Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПТЦ, Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПНР);
		...
		Для каждого СтрокаРезультата Из ВсеФизлица Цикл
			...
			Если СтрокаРезультата.ФизическоеЛицо <> Неопределено И СтрокаРезультата.П000030001001 <> "1" Тогда
				КатегорияНулевыхДоходов = КатегорииНулевыхДоходов[СтрокаРезультата.КатегорияЗастрахованныхЛиц];
				КатегорияНулевыхДоходов = ?(КатегорияНулевыхДоходов = Неопределено, СтрокаРезультата.КатегорияЗастрахованныхЛиц, КатегорияНулевыхДоходов);
	...
	Раздел1Прил5 = Контейнер.Раздел1Прил5.Строки[0].ДанныеМногострочныхЧастей.П00105М1.Строки;	
...
Процедура РасчетПоказателейРСВ(ИмяРасчета, НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные = Ложь, ДатаАктуальности = Неопределено, МассивФизическихЛиц = Неопределено, ВыделятьМеждународныеДоговоры = Ложь) Экспорт
	...
	Если ИмяРасчета = "РасчетПоказателей_РСВ_2023Кв1" Тогда
		РасчетПоказателей_РСВ_2023(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, УточненнаяДатаАктуальности, МассивФизическихЛиц, ВыделятьМеждународныеДоговоры);
...
Процедура РасчетПоказателей_РСВ_2023(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, ДатаАктуальности, МассивФизическихЛиц, ВыделятьМеждународныеДоговоры = Ложь)
	...
	Если Не ВыделятьМеждународныеДоговоры Тогда
		ВыделятьМеждународныеДоговоры = ОписаниеТаблиц.Свойство("Подраздел4ЧисленностьЗастрахованных");
	КонецЕсли;
	Запрос.УстановитьПараметр("ВыделятьМеждународныеДоговоры", ВыделятьМеждународныеДоговоры);
	...
	Если ОписаниеТаблиц.Свойство("ЧисленностьЗастрахованныхВРазрезеТарифов2023") Или ОписаниеТаблиц.Свойство("ВсеТарифы2023") 
		...
		|	&ВыделятьМеждународныеДоговоры
		|		И СведенияОДоходах.ВидЗастрахованногоЛица = ЗНАЧЕНИЕ(Перечисление.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВременноПребывающиеИностранцыСтрахуемыеФСС) КАК ВключатьВПриложение5,
		...
		|	СУММА(СведенияОДоходах.ПФРПоСуммарномуТарифу + ВЫБОР
		|			КОГДА &ВыделятьМеждународныеДоговоры
		|				ТОГДА 0
		|			ИНАЧЕ СведенияОДоходах.ОПСпоМеждународнымДоговорам + СведенияОДоходах.ОМСпоМеждународнымДоговорам + СведенияОДоходах.ОССпоМеждународнымДоговорам
		|		КОНЕЦ) КАК ПФРПоСуммарномуТарифу,
		|	СУММА(СведенияОДоходах.ПФРССуммПревышения + ВЫБОР
		|			КОГДА &ВыделятьМеждународныеДоговоры
		|				ТОГДА 0
		|			ИНАЧЕ СведенияОДоходах.ОПСпоМеждународнымДоговорамСПревышения + СведенияОДоходах.ОМСпоМеждународнымДоговорамСПревышения + СведенияОДоходах.ОССпоМеждународнымДоговорамСПревышения
		|		КОНЕЦ) КАК ИсчисленоПФРССуммПревышения,
		|	СУММА(ВЫБОР
		|			КОГДА &ВыделятьМеждународныеДоговоры
		|				ТОГДА СведенияОДоходах.ОПСпоМеждународнымДоговорам
		|			ИНАЧЕ 0
		|		КОНЕЦ) КАК ОПСпоМеждународнымДоговорам,
		|	СУММА(ВЫБОР
		|			КОГДА &ВыделятьМеждународныеДоговоры
		|				ТОГДА СведенияОДоходах.ОПСпоМеждународнымДоговорамСПревышения
		|			ИНАЧЕ 0
		|		КОНЕЦ) КАК ОПСпоМеждународнымДоговорамСПревышения,
		|	СУММА(ВЫБОР
		|			КОГДА &ВыделятьМеждународныеДоговоры
		|				ТОГДА СведенияОДоходах.ОМСпоМеждународнымДоговорам
		|			ИНАЧЕ 0
		|		КОНЕЦ) КАК ОМСпоМеждународнымДоговорам,
		|	СУММА(ВЫБОР
		|			КОГДА &ВыделятьМеждународныеДоговоры
		|				ТОГДА СведенияОДоходах.ОМСпоМеждународнымДоговорамСПревышения
		|			ИНАЧЕ 0
		|		КОНЕЦ) КАК ОМСпоМеждународнымДоговорамСПревышения,
		|	СУММА(ВЫБОР
		|			КОГДА &ВыделятьМеждународныеДоговоры
		|				ТОГДА СведенияОДоходах.ОССпоМеждународнымДоговорам
		|			ИНАЧЕ 0
		|		КОНЕЦ) КАК ОССпоМеждународнымДоговорам,
		|	СУММА(ВЫБОР
		|			КОГДА &ВыделятьМеждународныеДоговоры
		|				ТОГДА СведенияОДоходах.ОССпоМеждународнымДоговорамСПревышения
		|			ИНАЧЕ 0
	...
	Если ОписаниеТаблиц.Свойство("Приложение5Физлица2023") Тогда
		...
		Если Результат.Выгрузить()[0].Количество > 0 Тогда
			...
			КадровыеДанные = "Фамилия, Имя, Отчество, Наименование, ИНН, СтраховойНомерПФР, Страна, ДокументСтранаВыдачи";
			...
			Запрос.Текст = 
			"ВЫБРАТЬ
			|	СУММА(СведенияОДоходах.НачисленоВсего) КАК П00105М107001,
			|	СУММА(ВЫБОР
			|			КОГДА МЕСЯЦ(СведенияОДоходах.Период) = &Месяц1
			|				ТОГДА СведенияОДоходах.НачисленоВсего
			|			ИНАЧЕ 0
			|		КОНЕЦ) КАК П00105М107002,
			|	СУММА(ВЫБОР
			|			КОГДА МЕСЯЦ(СведенияОДоходах.Период) = &Месяц2
			|				ТОГДА СведенияОДоходах.НачисленоВсего
			|			ИНАЧЕ 0
			|		КОНЕЦ) КАК П00105М107003,
			|	СУММА(ВЫБОР
			|			КОГДА МЕСЯЦ(СведенияОДоходах.Период) = &Месяц3
			|				ТОГДА СведенияОДоходах.НачисленоВсего
			|			ИНАЧЕ 0
			|		КОНЕЦ) КАК П00105М107004,
			|	СведенияОДоходах.ФизическоеЛицо КАК ФизическоеЛицо
			...
			|ВЫБРАТЬ
			|	Физлица.ФизическоеЛицо КАК ФизическоеЛицо,
			|	ЕСТЬNULL(ФИОФизлиц.Фамилия, """") КАК П00105М101001,
			|	ЕСТЬNULL(ФИОФизлиц.Имя, """") КАК П00105М102001,
			|	ЕСТЬNULL(ФИОФизлиц.Отчество, """") КАК П00105М103001,
			|	ЕСТЬNULL(ФИОФизлиц.ИНН, """") КАК П00105М104001,
			|	ЕСТЬNULL(ФИОФизлиц.СтраховойНомерПФР, """") КАК П00105М105001,
			|	ЕСТЬNULL(ВЫБОР
			...
			|		КОНЕЦ, """") КАК П00105М106001,
			|	ЕСТЬNULL(СводныеДоходы.П00105М107001, 0) КАК П00105М107001,
			|	ЕСТЬNULL(СводныеДоходы.П00105М107002, 0) КАК П00105М107002,
			|	ЕСТЬNULL(СводныеДоходы.П00105М107003, 0) КАК П00105М107003,
			|	ЕСТЬNULL(СводныеДоходы.П00105М107004, 0) КАК П00105М107004
			|ИЗ
	...
	Если ОписаниеТаблиц.Свойство("Раздел3Физлица2023") Или ОписаниеТаблиц.Свойство("Подраздел321Доходы2023") Или ОписаниеТаблиц.Свойство("Подраздел322Доходы2023") Тогда
		...
		Если ОписаниеТаблиц.Свойство("НомерКорректировки") И ЗначениеЗаполнено(ОписаниеТаблиц.НомерКорректировки) Тогда
			ПолучитьПереданныеДанныеОтчета(ОтчитывающаясяОрганизация, ОкончаниеПериода, Запрос.МенеджерВременныхТаблиц, ОписаниеТаблиц.НомерКорректировки, ?(ВыделятьМеждународныеДоговоры, "ФормаОтчета2023Кв3", "ФормаОтчета2023Кв1"));
		Иначе
		...
		|	ВЫБОР
		|		КОГДА &ВыделятьМеждународныеДоговоры
		|				И Физлица.ВидЗастрахованногоЛица = ЗНАЧЕНИЕ(Перечисление.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВременноПребывающиеИностранцыСтрахуемыеНаОПС)
		|			ТОГДА ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФР.МД)
		|		ИНАЧЕ ЕСТЬNULL(СоответствиеТарифаИВидаЗЛКатегории.КатегорияЗастрахованныхЛиц, ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФР.НР))
		...
		|	ВЫБОР
		|		КОГДА &ВыделятьМеждународныеДоговоры
		|				И СведенияОДоходах.ВидЗастрахованногоЛица = ЗНАЧЕНИЕ(Перечисление.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВременноПребывающиеИностранцыСтрахуемыеНаОПС)
		|			ТОГДА ЗНАЧЕНИЕ(Перечисление.КатегорииЗастрахованныхЛицДляПФР.МД)
		|		ИНАЧЕ СоответствиеТарифаИВидаЗЛКатегории.КатегорияЗастрахованныхЛиц
		|	КОНЕЦ КАК П00321М113001,
