...
// 
// Возвращаемое значение:
//  Структура - Новый параметры запроса получить грузоперевозчиков:
...
// 
// Возвращаемое значение:
//  Структура - Новый параметры запроса получить пункты выдачи клиента:
// * ОрганизацияБизнесСетиСсылка - Неопределено - 
// * ТипГрузоперевозки - Число - 
// * ТипЗагрузки - Число - 
//
...
// 
// Возвращаемое значение:
//  Структура - Новый параметры запроса установить тариф по умолчанию:
