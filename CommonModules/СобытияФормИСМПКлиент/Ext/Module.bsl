...
Процедура ОткрытьФормуВыбораОснованияДокументаИС(Форма, ОповещениеПриЗавершении, ИмяДокумента, ТипОбъекта) Экспорт
	...
	Если ТипОбъекта = Тип("ДокументСсылка.ЗаказНаЭмиссиюКодовМаркировкиСУЗ")
		...
		Или ТипОбъекта = Тип("ДокументСсылка.ПеремаркировкаТоваровИСМП")
		Или ТипОбъекта = Тип("ДокументСсылка.УточнениеСведенийОКодахМаркировкиИСМП")
		Или ТипОбъекта = Тип("ДокументСсылка.ОтчетИСМП") Тогда
	Иначе
		Возврат;
	КонецЕсли;
