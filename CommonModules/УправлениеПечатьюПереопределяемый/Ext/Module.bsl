...
Процедура ПередДобавлениемКомандПечати(ИмяФормы, КомандыПечати, СтандартнаяОбработка) Экспорт
	...
	Если ИмяФормы = "Справочник.ШтрихкодыУпаковокТоваров.Форма.ФормаЭлемента"
		...
		КомандаПечати.Обработчик    = "ИнтеграцияИСМПУнфКлиент.ПечатьШтрихкодовУпаковок";
...
Процедура ПриПолученииКомандПечати(Знач ПолноеИмяОбъектаМетаданных, КомандыПечати) Экспорт
	...
	Если ПолноеИмяОбъектаМетаданных = "Документ.НачислениеЗарплаты" Тогда
		
		Обработки.ПечатьДокументовБЗКБ.ДобавитьКомандыПечатиНачислениеЗарплаты(КомандыПечати);
...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	// ГОСИС
	ИнтеграцияИС.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	// Конец ГОСИС
