...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	ОтчетыУНФ.ДобавитьРеквизитыИКомандыОтправкиКонтактов(Форма);
    ОтчетыУНФ.ДобавитьКомандуКопироватьСтроки(Форма);
    ОтчетыУНФ.ДобавитьКомандуИзменитьВыделенное(Форма);
...
Процедура ПередЗагрузкойВариантаНаСервере(Форма, НовыеНастройкиКД) Экспорт
	...
	ОтчетыУНФ.ПередЗагрузкойВариантаНаСервере(Форма, НовыеНастройкиКД);		
