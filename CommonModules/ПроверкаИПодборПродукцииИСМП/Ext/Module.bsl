...
//
Процедура УправлениеЭлементамиОткрытияФормыПроверкиИПодбора(Форма, ВидПродукции, ВидимостьЭлементов) Экспорт
	...
	СтатусПроверкиИПодбора  = СтатусПроверкиИПодбораДокумента(Объект.Ссылка, ВидПродукции);
	...
	Если ПараметрыИнтеграции.ИспользоватьСтатусПроверкиПодбораДокумента Тогда
		...
		Если ПараметрыИнтеграции.ОтображатьОшибкиПроверкиСредствамиККТ Тогда
			ДополнитьПредставлениеКомандыПроверкиИПодбораНаличиемОшибокСредствамиККТ(Форма, ВидПродукции);
		КонецЕсли;
...
Процедура ПрименитьКешШтрихкодовУпаковок(Форма, ОбновлениеТаблицыТоваров = Ложь) Экспорт
	...
	Если ПараметрыИнтеграцииФормыПроверки.Свойство("ИмяКолонкиКоличество") Тогда
...
Функция РезультатыПроверкиУспешноСохранены(Форма, ВидПродукцииИС, ТекстОшибки) Экспорт
	...
	Исключение
		...
		НовоеСобытие.Вставить("Комментарий", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура ДополнитьПредставлениеКомандыПроверкиИПодбораНаличиемОшибокСредствамиККТ(Форма, ВидПродукции)
	
	ИмяКомандыПроверкаПодбор = ПроверкаИПодборПродукцииИС.ИмяКнопкиИКоманды(ВидПродукции);
	ПараметрыИнтеграции      = Форма.ПараметрыИнтеграцииГосИС.Получить(ВидПродукции);
	Объект                   = Форма[ПараметрыИнтеграции.ИмяРеквизитаФормыОбъект];
