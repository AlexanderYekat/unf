...
Процедура ПолучитьПрефиксообразующиеРеквизиты(Объекты) Экспорт
	...
	РегистрацияСведенийОЗастрахованномЛицеФСС = Объекты.Добавить();
	РегистрацияСведенийОЗастрахованномЛицеФСС.Объект = Метаданные.Документы.РегистрацияСведенийОЗастрахованномЛицеФСС;
	РегистрацияСведенийОЗастрахованномЛицеФСС.Реквизит = "ГоловнаяОрганизация";
	
	СреднийЗаработокСЭДО = Объекты.Добавить();
	СреднийЗаработокСЭДО.Объект = Метаданные.Документы.СреднийЗаработокСЭДО;
	СреднийЗаработокСЭДО.Реквизит = "ГоловнаяОрганизация";
	
	НесоответствиеСведенийОЗастрахованномЛицеСЭДО = Объекты.Добавить();
	НесоответствиеСведенийОЗастрахованномЛицеСЭДО.Объект = Метаданные.Документы.НесоответствиеСведенийОЗастрахованномЛицеСЭДО;
	НесоответствиеСведенийОЗастрахованномЛицеСЭДО.Реквизит = "ГоловнаяОрганизация";
