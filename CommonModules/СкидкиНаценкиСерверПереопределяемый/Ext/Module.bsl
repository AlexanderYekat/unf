...
// ИспользоватьПриВозврате - Признак использования скидки.
//
// Возвращаемое значение:
//   СписокЗначений из ПеречислениеСсылка.СпособыПредоставленияСкидокНаценок
//
Функция ПолучитьСписокЗначенийСпособовПредоставленияСкидки(ЗаполняемыйСписок = Неопределено, ИспользоватьПриВозврате = Ложь) Экспорт
