...
Процедура ЗаписатьОшибкуПолученияСведений(Знач Организация, Знач ДатаЗначения = Неопределено, Знач Показатель, ИмяСобытия, Ошибка)
	...
	ИмяСобытия = НСтр("ru = 'Электронный документооборот с контролирующими органами.'", ОбщегоНазначения.КодОсновногоЯзыка()) + ИмяСобытия;
	
	Комментарий = ИмяСобытия + НСтр("ru = ' %1 (%2) на дату %3. Ошибка: '") + Ошибка;
