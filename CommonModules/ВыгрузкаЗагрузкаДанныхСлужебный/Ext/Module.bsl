...
// Параметры:
//	ИнформацияОВыгрузке - ОбъектXDTO - см. процедуру "СохранитьОписаниеВыгрузки".
//  СтрогаяПроверка - Булево - если Истина, то проверяет на равенство, если Ложь, то версия в выгрузке должна быть
//                             меньше либа равна текущей
//
...
Процедура СохранитьОписаниеВыгрузки(Знач Контейнер)
	...
	ВыгрузкаЗагрузкаДанныхПереопределяемый.СохранитьОписаниеВыгрузки(
