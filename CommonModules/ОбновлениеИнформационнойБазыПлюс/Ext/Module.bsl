...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя = "Библиотека1СПлюс";
	Описание.Версия = ПлюсМагазинРасширений.ВерсияБиблиотеки();	
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Версия = "*";
	Обработчик.Процедура           = "ПлюсМагазинРасширений.АктуализироватьРасписаниеСинхронизации";
	Обработчик.ОбщиеДанные         = Истина;
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.РежимВыполнения     = "Оперативно";
	Обработчик.Комментарий         =
		НСтр("ru='Начальное заполнение. Обновление расписания синхронизации с магазином расширений 1С:Плюс.'");
КонецПроцедуры
