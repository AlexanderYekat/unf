...
Процедура ЗаполнитьПараметрыСканирования(ПараметрыСканирования) Экспорт
	...
	ПараметрыСканирования.Вставить("РасширеннаяВерсияГосИС",       Истина);
	ПараметрыСканирования.Вставить("ЭтоМаркировкаТоваровИСМП",     ТипЗнч(ПараметрыСканирования.СсылкаНаОбъект) = Тип("ДокументСсылка.МаркировкаТоваровИСМП"));
