...
Процедура ПриЗаполненииТиповОбщихДанныхПоддерживающихСопоставлениеСсылокПриЗагрузке(Типы) Экспорт
	...
	Типы.Добавить(Метаданные.Справочники.ВидыТарифовСтраховыхВзносовУНФ);
	...
	Типы.Добавить(Метаданные.Справочники.КлассификаторЗанятийУНФ);
...
Процедура ПриЗаполненииТиповИсключаемыхИзВыгрузкиЗагрузки(Типы) Экспорт
	...
	// РУНФ
	Типы.Добавить(Метаданные.Константы.РозницаВАвтономномРабочемМесте);
	// Конец РУНФ
...
Процедура ПослеЗагрузкиДанных(Контейнер) Экспорт
	...
	ВозможностиПриложения.ПослеЗагрузкиДанных(Контейнер);
...
Процедура ПриЗагрузкеПользователяИнформационнойБазы(Контейнер, Сериализация, ПользовательИБ, Отказ) Экспорт
	...
	ТелефонияСервер.ПриЗагрузкеПользователяИнформационнойБазы(Контейнер, Сериализация, ПользовательИБ, Отказ);
...
//  СовместимаСТекущейКонфигурацией - Булево - Истина, если совпадает.
//
Процедура ВыгрузкаВАрхивеСовместимаСТекущейКонфигурацией(Знач ИнформацияОВыгрузке, СовместимаСТекущейКонфигурацией) Экспорт
	
	Для Каждого ТекущееИмя Из ВозможностиПриложения.ВсеИменаСемействаКонфигураций() Цикл
		Если ИнформацияОВыгрузке.Configuration.Name = ТекущееИмя Тогда
			СовместимаСТекущейКонфигурацией = Истина;
		КонецЕсли;
	КонецЦикла;
	
КонецПроцедуры

// Сохраняет описание выгрузки информации о конфигурации.
// @skip-warning ПустойМетод - переопределяемый метод.
//
// Параметры:
//  ИнформацияОКонфигурации - ОбъектXDTO
//
Процедура СохранитьОписаниеВыгрузки(ИнформацияОКонфигурации) Экспорт
	
	ИнформацияОКонфигурации.Name = ВозможностиПриложения.ИмяКонфигурации();
	ИнформацияОКонфигурации.Presentation = ВозможностиПриложения.ПредставлениеКонфигурации();
