...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	УправлениеНебольшойФирмойКлиент.ПередНачаломРаботыСистемы();
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	Если НачалоРаботыСПрограммойКлиент.ПоказатьОкноНачалоРаботыСПрограммой(ПараметрыРаботыКлиента) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПриУстановкеЗаголовкаКлиентскогоПриложения(ЗаголовокПриложения, ПриЗапуске) Экспорт
	...
	ОбщегоНазначенияУНФКлиент.ПриУстановкеЗаголовкаКлиентскогоПриложения(ЗаголовокПриложения, ПриЗапуске);
