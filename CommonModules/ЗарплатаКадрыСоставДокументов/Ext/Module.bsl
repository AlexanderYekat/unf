...
Функция ОписаниеСоставаОбъектаПоМетаданнымФизическиеЛицаВТабличныхЧастях(МетаданныеОбъекта) Экспорт
	...
	Для Каждого ТабличнаяЧасть Из МетаданныеОбъекта.ТабличныеЧасти Цикл
		...
		Для Каждого Реквизит Из ТабличнаяЧасть.Реквизиты Цикл
			...
			// УНФ
			// В УНФ у документа ЗаявлениеОПредоставленииСведенийОТрудовойДеятельности составной тип данных реквизита "Сотрудники".
			// Возможность выбрать сотрудника оставилена для сохранения совместимости с документами, которые были оформлены до внедрения БЗКБ.
			Если МетаданныеОбъекта.Имя = "ЗаявленияОПредоставленииСведенийОТрудовойДеятельности" Тогда
				ПолеФизическоеЛицо = "Сотрудник";
			КонецЕсли;
			// Конец УНФ
