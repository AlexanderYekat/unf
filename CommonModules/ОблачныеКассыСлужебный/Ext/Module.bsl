...
//    * СообщениеОбОшибке - Строка, ФорматированнаяСтрока - сообщение об ошибке для пользователя.
//    * ИнформацияОбОшибке - Строка, ФорматированнаяСтрока - сообщение об ошибке для администратора.
//    * ДанныеОперации - см. НовыйДанныеОперацииПробитияЧека
...
Функция ПробитьЧек(ДокументОперации, ОблачнаяКасса, ДанныеЧека) Экспорт
	...
	РегистрыСведений.ДанныеОперацийОблачныхКасс.ЗаписатьДанныеПробитияЧека(
		ДокументОперации,
		РезультатПробития.ДанныеОперации.СтатусОперации,
		РезультатПробития.ДанныеОперации.ИдентификаторЧека,
...
Функция СтатусПробитияЧека(ДокументОперации, ВремяОжидания = 0) Экспорт
	...
	СвойстваДанныхОпераций = "ИдентификаторОперации,СтатусОперации,ИдентификаторЧека";
	...
	РегистрыСведений.ДанныеОперацийОблачныхКасс.ЗаписатьДанныеПробитияЧека(
		ДокументОперации,
		СтатусОперации.ДанныеОперации.СтатусОперации,
		СтатусОперации.ДанныеОперации.ИдентификаторЧека,
