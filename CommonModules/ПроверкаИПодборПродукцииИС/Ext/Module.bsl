...
Процедура ДополнитьТаблицуТоваров(Форма, ПараметрыИнтеграции, ПутьКРеквизиту, ДобавляемыеРеквизиты) Экспорт
	...
	Если ПараметрыИнтеграции.Получить("ДоступныОбъемноСортовыеКоды") = Истина Тогда
...
//   Форма             - ФормаКлиентскогоПриложения           - источник вызова.
//   ОбновляемаяСтрока - (См. ДанныеШтрихкодаДляДобавленияВКеш)
//   ДобавленныеШтрихкодыУпаковок - Неопределено, Массив      - уже добавленные штрихкоды упаковок (специфика документа маркировки)
Процедура ДополнитьКешИТаблицуШтрихкодовУпаковок(Форма, ОбновляемаяСтрока, ДобавленныеШтрихкодыУпаковок = Неопределено) Экспорт
...
//
Функция КоличествоПоДаннымКеша(Форма, ОбновляемаяСтрока, ИмяПоляКоличество = "Количество") Экспорт
...
Функция ИмяКнопкиИКоманды(ВидПродукции = Неопределено, ВозобновлениеПроверки = Ложь) Экспорт
