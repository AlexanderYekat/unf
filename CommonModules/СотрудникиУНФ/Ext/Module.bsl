...
Процедура ОтразитьСтраховыеВзносыДоходы(ДокументСсылка, ДополнительныеСвойства, Движения, Отказ) Экспорт
	...
	|	0 КАК Скидка
	|ИЗ
	|	Документ.НачислениеЗарплатыУНФ.НачисленияУдержания КАК ТаблицаНачисления
...
// Выполняет движения по регистру накопления РасчетыСФондамиПоСтраховымВзносамУНФ
// 
Процедура ОтразитьРасчетыСФондамиПоСтраховымВзносам(ДополнительныеСвойства, Движения, Отказ) Экспорт
	...
	Движения.РасчетыСФондамиПоСтраховымВзносамУНФ.Записывать = Истина;
	Движения.РасчетыСФондамиПоСтраховымВзносамУНФ.Загрузить(Таблица);
...
Функция РаспределитьПеречисленныйВзносПоФизическимЛицам(Ссылка, Организация, ДатаОперации, Сумма, ВидОбязательногоСтрахованияСотрудников) Экспорт
	...
	|	РасчетыСФондамиПоСтраховымВзносамУНФ.СуммаОстаток КАК Сумма
	|ПОМЕСТИТЬ ВТОстатки
	|ИЗ
	|	РегистрНакопления.РасчетыСФондамиПоСтраховымВзносамУНФ.Остатки(
	|			&ДатаОперации,
	|			Организация = &Организация И ВидОбязательногоСтрахованияСотрудников = &ВидОбязательногоСтрахованияСотрудников И ЭтоСтраховыеВзносы) КАК РасчетыСФондамиПоСтраховымВзносамУНФ
	|
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
