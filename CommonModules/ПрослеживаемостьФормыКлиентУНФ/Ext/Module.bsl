...
Процедура ОткрытьФормуПодбораРНПТ(
	...
	СтруктураПараметров.Вставить("Партия", ?(Не ИмяТаблицы = "Работы", ТекущиеДанные.Партия, Неопределено));
	...
	СтруктураПараметров.Вставить("РНПТВСоставеРабот", ИмяТаблицы = "Работы");
	...
	Если ТекущиеДанные.ПрослеживаемыйТовар И Не ПоставщикРезидентТаможенногоСоюза Тогда
		...
		Если Не ИмяТаблицы = "Работы" И Не ЗначениеЗаполнено(ТекущиеДанные.СтранаПроисхождения) Тогда
			ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения(
		...
		СтруктураПараметров.Вставить("ЕдиницаИзмерения",    ?(Не ИмяТаблицы = "Работы", ТекущиеДанные.ЕдиницаИзмерения, Неопределено));
		СтруктураПараметров.Вставить("СтранаПроисхождения", ?(Не ИмяТаблицы = "Работы", ТекущиеДанные.СтранаПроисхождения, Неопределено));
		
		ИмяТаблицыПрослеживаемости = "СведенияПрослеживаемости";
		
		Если ИмяТаблицы = "Работы" И ЭтоЗаказНаряд Тогда // BG
	...
	ИначеЕсли Не ИмяТаблицы = "Работы" Тогда
