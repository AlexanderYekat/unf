...
Процедура ПриСозданииНоменклатурыПоДаннымКонтрагента(Знач НаборНоменклатурыКонтрагентов, Знач ОповещениеОЗавершении, 
	...
	// КлиентЭДО начало
	СопоставлениеНоменклатурыКонтрагентовКЭДОКлиент.ПриСозданииНоменклатурыПоДаннымКонтрагента(НаборНоменклатурыКонтрагентов, ОповещениеОЗавершении, СтандартнаяОбработка);
	// КлиентЭДО конец
...
Процедура ОткрытьФормуНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность, Знач ОповещениеОЗакрытии) Экспорт
	...
	// КлиентЭДО начало
	СопоставлениеНоменклатурыКонтрагентовКЭДОКлиент.ОткрытьФормуНоменклатуры(Параметры, Владелец, Уникальность, ОповещениеОЗакрытии);
	// КлиентЭДО конец
...
Процедура ОткрытьФормуВыбораНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность) Экспорт
	...
	// КлиентЭДО начало
	СопоставлениеНоменклатурыКонтрагентовКЭДОКлиент.ОткрытьФормуВыбораНоменклатуры(Параметры, Владелец, Уникальность);
	// КлиентЭДО конец
