...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	ИнтеграцияСПлатежнымиСистемамиУНФ.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
	
	РаботаСБуферомОбмена.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	ПодключаемыеКомандыУНФ.УдалитьКомандыВида(Команды, "СвязанныеДокументы");
	ПодключаемыеКомандыУНФ.УдалитьКомандыВида(Команды, "Отправить");
	
	ПодключаемыеКомандыУНФ.ЗаполнитьПредставлениеКомандВидаЗаполнениеОбъектов(Команды);
	...
	ИнтеграцияСПлатежнымиСистемамиУНФ.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	
	РаботаСБуферомОбмена.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	
	ЗадачиСотрудника.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	НапоминанияПользователяУНФ.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	ЭлектроннаяПочтаУНФ.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
	ОтправкаSMSУНФ.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды)
