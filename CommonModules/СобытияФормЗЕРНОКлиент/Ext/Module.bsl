...
Процедура ОткрытьФормуВыбораОснованияДокументаИС(Форма, ОповещениеПриЗавершении, ИмяДокумента, ТипОбъекта) Экспорт
	...
	Если ТипОбъекта = Тип("ДокументСсылка.ФормированиеПартийЗЕРНО")
		Или ТипОбъекта = Тип("ДокументСсылка.ОформлениеСДИЗЗЕРНО")
		Или ТипОбъекта = Тип("ДокументСсылка.ВнесениеСведенийОСобранномУрожаеЗЕРНО")
		Или ТипОбъекта = Тип("ДокументСсылка.СписаниеПартийЗЕРНО")
		Или ТипОбъекта = Тип("ДокументСсылка.ПогашениеСДИЗЗЕРНО")
		Или ТипОбъекта = Тип("ДокументСсылка.ФормированиеПартийИзДругихПартийЗЕРНО") 
		Или ТипОбъекта = Тип("ДокументСсылка.ЗапросОстатковПартийЗЕРНО")
		Или ТипОбъекта = Тип("ДокументСсылка.ФормированиеПартийПриПроизводствеЗЕРНО") Тогда
	Иначе
		Возврат;
	КонецЕсли;
	...
	ИнтеграцияЗЕРНОКлиентСервер.ЗаполнитьСоответствиеПолейДокументовОснований(Форма, ТипОбъекта, СоответствиеПолей);
...
Процедура ПолеАдресаАвтоПодбор(Форма, ВидДанных,
	...
	ДанныеВыбора = ИнтеграцияЗЕРНОВызовСервера.СписокАвтоподбора(ВидДанных, ТекстДляАвтоПодбора);
