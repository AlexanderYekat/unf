...
// Конструктор параметров сброса количества в табличных частях документов
// Возвращаемое значение:
//  Структура:
//		* СбрасыватьКоличество - Булево
//		* НовоеКоличествоПриИзмененииНоменклатуры - Число
//		* ЗапрашиватьСбросКоличества - Булево
//
Функция ПараметрыСбросаКоличества() Экспорт
	
	ПараметрыСбросаКоличества = Новый Структура();
	ПараметрыСбросаКоличества.Вставить("СбрасыватьКоличество", Ложь);
	ПараметрыСбросаКоличества.Вставить("НовоеКоличествоПриИзмененииНоменклатуры", 0);
	ПараметрыСбросаКоличества.Вставить("ЗапрашиватьСбросКоличества", Ложь);
	
	// Настройки объединения строк
	ПараметрыСбросаКоличества.Вставить("ОбъединятьСтрокиПриДобавлении", Ложь);
	ПараметрыСбросаКоличества.Вставить("ДобавлятьНовуюСтроку", Ложь);
	ПараметрыСбросаКоличества.Вставить("ЗапрашиватьОбъединениеСтрок", Ложь);
	
	Возврат ПараметрыСбросаКоличества;
