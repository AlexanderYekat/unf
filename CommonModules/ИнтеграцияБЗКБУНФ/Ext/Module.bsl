...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	Вариант.Размещение.Вставить(ПодсистемаКадры, "Важный");
	Вариант.Описание =
	...
	ВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, ПодсистемаКадры, Истина);
	...
	Вариант.Размещение.Вставить(ПодсистемаЗарплата, "Важный");
	...
	ВариантыОтчетов.УстановитьРежимВыводаВПанеляхОтчетов(Настройки, ПодсистемаЗарплата, Истина);
	...
	Для Каждого Вариант Из ВариантыОтчета Цикл
		Если Вариант.Размещение.Получить(ПодсистемаЗарплата) <> Неопределено Тогда
			Вариант.Размещение[ПодсистемаЗарплата] = "СмТакже";
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
