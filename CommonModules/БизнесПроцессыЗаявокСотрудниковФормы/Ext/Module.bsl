...
Процедура ВывестиСвязанныеЗаявкиСотрудника(Форма) Экспорт
	...
	Для Индекс = 0 По Форма.СвязанныеЗаявки.Количество()-1 Цикл
		...
		ГруппаСвязаннаяЗаявка.Заголовок = СтрШаблон(НСтр("ru = 'Связанная заявка %1'"), Индекс + 1);
		...
		ЭлементСсылкаНаЗаявку.Заголовок = СтрШаблон(НСтр("ru = 'Связанная заявка %1'"), Индекс + 1);
		...
		ЭлементСостояниеЗаявки.Заголовок = СтрШаблон(НСтр("ru = 'Состояние заявки %1'"), Индекс + 1);
