...
Процедура ПриОпределенииИспользуемыхТиповЭлектронныхДокументов(ИспользуемыеТипы) Экспорт
	...
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ОбменСКонтрагентами.ТипыДокументов().АктОРасхождениях);
	ОбменСКонтрагентами.ДобавитьИспользуемыйТипДокумента(ИспользуемыеТипы, ОбменСКонтрагентами.ТипыДокументов().АктСверкиВзаиморасчетов);
...
Процедура ЗаполнитьСоответствиеВидовДоговоровКонтрагентов(Соответствие) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьСоответствиеВидовДоговоровКонтрагентов(Соответствие);
	
КонецПроцедуры

// В процедуре указывается соответствие строковых представлений видов договоров контрагентов (используемых в подсистеме)
// с прикладными значениями этих значений с противположным значением. Так если контрагент имеет договор с видом: 
...
Процедура ЗаполнитьСоответствиеВидовДоговоровПротивоположноеЗначениюКонтрагентов(Соответствие) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьСоответствиеВидовДоговоровПротивоположноеЗначениюКонтрагентов(Соответствие);
...
Процедура СоответствиеИсходящихТиповЭлектронныхДокументовДокументамИБ(СоответствиеТиповЭлектронныхДокументовДокументамИБ) Экспорт 
	...
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.АктОРасхождениях, НСтр("ru = 'Акт о расхождениях'"));
	СоответствиеТиповЭлектронныхДокументовДокументамИБ.Вставить(ТипыДокументов.АктСверкиВзаиморасчетов, НСтр("ru = 'Акт сверки взаиморасчетов'"));
...
Процедура СписокТиповДокументовПоТипуЭлектронногоДокумента(ТипДокумента, ОписанияОбъектовУчета) Экспорт
	...
	ИначеЕсли ТипДокумента = ТипыДокументов.АктОРасхождениях Тогда
		...
		ОписанияОбъектовУчета.Добавить(Документы.АктОРасхожденияхПолученный.ПустаяСсылка(),
	...
	ИначеЕсли ТипДокумента = ТипыДокументов.АктСверкиВзаиморасчетов Тогда
		...
		ОписанияОбъектовУчета.Добавить(Документы.СверкаВзаиморасчетов.ПустаяСсылка(),
			Метаданные.Документы.СверкаВзаиморасчетов.Представление());
...
Процедура ЗаполнитьДанныеАктОРасхождениях_ИнформацияПокупателя(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьДанныеАктОРасхождениях_ИнформацияПокупателя(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура НайтиСоздатьАктОРасхождениях_ФНС_2019(ДеревоДанных, ДокументУчета = Неопределено, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.НайтиСоздатьАктОРасхождениях_ФНС_2019(ДеревоДанных, ДокументУчета, СпособОбработки, ОписаниеОшибки);
...
Процедура ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияОтправителя(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияОтправителя(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияПолучателя(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьДанныеАктСверкиВзаиморасчетов_ИнформацияПолучателя(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура НайтиСоздатьАктСверкиВзаиморасчетов(ДеревоДанных, ДокументУчета = Неопределено, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.НайтиСоздатьАктСверкиВзаиморасчетов(ДеревоДанных, ДокументУчета, СпособОбработки, ОписаниеОшибки);
...
Процедура ЗаполнитьАктСверкиВзаиморасчетовПоДаннымПолучателя(ДанныеДокумента, ОбъектыУчета = Неопределено) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьАктСверкиВзаиморасчетовПоДаннымПолучателя(ДанныеДокумента, ОбъектыУчета);
...
Процедура ЗаполнитьДанныеПоСчетуНаОплату101(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьДанныеПоСчетуНаОплату101(Основание, Настройки, Данные, Описание, Отказ);
...
Процедура НайтиСоздатьСчетНаОплату101(ДеревоДанных, ДокументУчета = Неопределено, СпособОбработки = "", ОписаниеОшибки = "") Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.НайтиСоздатьСчетНаОплату101(ДеревоДанных, ДокументУчета, СпособОбработки, ОписаниеОшибки);
...
//  Отказ           - Булево - если нужно отказаться от создания электронного документа, необходимо установить значение
//                   в Истина. После этого дальнейшие действия по формированию документа производиться не будут, поэтому
...
//                              см. Обработка.ОбменСКонтрагентами.Макет.ПередачаВозвратТоваровМеждуОрганизациями.
//                              Выходной параметр.
...
//  УчетныйДокумент          - ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО - ссылка на учетный документ Запрос
//                                                                                 коммерческих предложений от клиента.
...
//  УчетныйДокумент          - ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО - Ссылка на учетный документ
...
Процедура СпособыОтраженияВУчетеТипаЭлектронногоДокумента(ТипДокумента, СпособыОтраженияВУчете) Экспорт 
	...
	Если ТипДокумента = ТипыДокументов.АктВыполненныхРабот  Тогда
		...
		СпособыОтраженияВУчете.Добавить("ПоступлениеИзПереработки", НСтр("ru = 'Отчет переработчика'"), Ложь);
	...
	ИначеЕсли ТипДокумента = ТипыДокументов.АктОРасхождениях Тогда
		...
		СпособыОтраженияВУчете.Добавить("АктОРасхожденияхПолученный", НСтр("ru = 'Акт о расхождениях (полученный)'"), Истина);
...
// Событие возникает при формировании ответов по электронным документам. Данные ответов по электронным документам
// сформированы, но не записаны. На данном этапе можно отказаться от записи ответов по электронным документам.
// Событие может выполняться в фоновом задании, в связи с этим не следует помещать данные во временное хранилище.
//
// Параметры:
//  ДанныеДляПроверки - ТаблицаЗначений - сформированные данные электронных документов.
...
// 
// Параметры:
//  ДокументыУчета - Массив Из ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО - документы учета, привязанные к
...
//     * ПрикладнойТипДокумента      - ОпределяемыйТип.ПрикладныеТипыЭлектронныхДокументовЭДО - Ссылка на прикладной тип
...
//                             объекта, в качестве представления представление объекта учета, которое может быть
...
Процедура ЗаполнитьДанныеПоДоговорномуДокументу101(СсылкаНаОбъект, КонструкторЭД, Отказ) Экспорт
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЗаполнитьДанныеПоДоговорномуДокументу101(СсылкаНаОбъект, КонструкторЭД, Отказ);
...
Процедура НайтиСоздатьДоговорнойДокумент101(КонструкторЭД, ДокументУчета = Неопределено,
	...
	УправлениеНебольшойФирмойЭлектронныеДокументыСервер.НайтиСоздатьДоговорнойДокумент101(КонструкторЭД, ДокументУчета, СпособОбработки, ОписаниеОшибки);
...
// Параметры:
//  Источник                       - Объект, ЛюбаяСсылка - документ или справочник источника.
//  ПараметрыЭлектронногоДокумента - ТаблицаЗначений - параметры источника, необходимые для определения настроек обмена
...
//                           см. ОбменСКонтрагентами.ВариантыФормированияУниверсальныхДокументов. Обязательный при
//                           указании типов: - ТоварнаяНакладная
//                            - АктВыполненныхРабот
//                            - АктНаПередачуПрав
//                            - СоглашениеОбИзмененииСтоимости
//                            - СчетФактура
...
Процедура ЗаполнитьПараметрыЭДПоИсточнику(Источник, ПараметрыЭлектронногоДокумента) Экспорт
	...
	Если ТипИсточника = Тип("ДокументСсылка.РасходнаяНакладная") 
		...
		Если УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ТребуетсяСформироватьУниверсальныйДокумент(Источник) Тогда
			Если УправлениеНебольшойФирмойЭлектронныеДокументыСервер.СчетФактураНеТребуется(Источник.Ссылка)
				ИЛИ НЕ УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ЕстьСчетФактура(Источник.Ссылка) Тогда
	...
	ИначеЕсли ТипИсточника = Тип("ДокументСсылка.СчетФактура") 
		...
		Если НЕ (ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ОтчетОПереработке") 
			ИЛИ ТипЗнч(ДокументОснование) = Тип("ДокументОбъект.ОтчетОПереработке")) Тогда
			
			Если УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ТребуетсяСформироватьУниверсальныйДокумент(ДокументОснование)
					И Не УправлениеНебольшойФирмойЭлектронныеДокументыСервер.НеобходимоСформироватьЭлектронныйДокументСчетФактура(Источник) Тогда
				ПараметрыЭД.ФормированиеУниверсальногоДокумента = 
						ОбменСКонтрагентами.ВариантыФормированияУниверсальныхДокументов().Обязательно;
			Иначе
				ПараметрыЭД.ФормированиеУниверсальногоДокумента = 
	...
	ИначеЕсли ТипИсточника = Тип("ДокументСсылка.АктОРасхождениях")
		ИЛИ ТипИсточника = Тип("ДокументОбъект.АктОРасхождениях") Тогда
		
		ПараметрыЭД.Тип = Перечисления.ТипыДокументовЭДО.АктОРасхождениях;
		ПараметрыЭД.Направление = НаправленияДокументов.Исходящий;
		ПараметрыЭД.Организация = Источник.Организация;
		ПараметрыЭД.Контрагент  = Источник.Контрагент;
		ПараметрыЭД.ДоговорКонтрагента = Источник.Договор;
		
	ИначеЕсли ТипИсточника = Тип("ДокументСсылка.АктОРасхожденияхПолученный")
		ИЛИ ТипИсточника = Тип("ДокументОбъект.АктОРасхожденияхПолученный") Тогда
	...
	ИначеЕсли ТипИсточника = Тип("ДокументСсылка.ОтчетОПереработке") 
		ИЛИ ТипИсточника = Тип("ДокументОбъект.ОтчетОПереработке") Тогда
	...
	ИначеЕсли ТипИсточника = Тип("ДокументСсылка.ОтчетПереработчика")
		ИЛИ ТипИсточника = Тип("ДокументОбъект.ОтчетПереработчика") Тогда
	...
	ИначеЕсли ТипИсточника = Тип("ДокументСсылка.СверкаВзаиморасчетов") Тогда
		
		ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
			Источник,
			"Организация, Контрагент");

		ПараметрыЭД.Тип                = Перечисления.ТипыДокументовЭДО.АктСверкиВзаиморасчетов;
		ПараметрыЭД.Направление        = НаправленияДокументов.Исходящий;
		ПараметрыЭД.Организация        = ЗначенияРеквизитов.Организация;
		ПараметрыЭД.Контрагент         = ЗначенияРеквизитов.Контрагент;
		
		Если Источник.ДанныеОрганизации.Количество() > 0 Тогда
			ПараметрыЭД.ДоговорКонтрагента = Источник.ДанныеОрганизации[0].Договор;
		КонецЕсли;
		
	ИначеЕсли ТипИсточника = Тип("ДокументОбъект.СверкаВзаиморасчетов") Тогда
	...
	ИначеЕсли ТипИсточника = Тип("СправочникСсылка.ДоговорыКонтрагентов") Тогда
		
		ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
			Источник, 
			"Организация, Владелец, Ссылка");
		
		ПараметрыЭД.Тип = Перечисления.ТипыДокументовЭДО.ДоговорныйДокумент;
		ПараметрыЭД.Направление = НаправленияДокументов.Исходящий;
		ПараметрыЭД.Организация = ЗначенияРеквизитов.Организация;
		ПараметрыЭД.Контрагент  = ЗначенияРеквизитов.Владелец;
		ПараметрыЭД.ДоговорКонтрагента = ЗначенияРеквизитов.Ссылка;
	...
	ИначеЕсли ТипИсточника = Тип("СправочникОбъект.ДоговорыКонтрагентов") Тогда
		...
		ПараметрыЭД.Направление = НаправленияДокументов.Исходящий;
		ПараметрыЭД.Организация = Источник.Организация;
		ПараметрыЭД.Контрагент  = Источник.Владелец;
		ПараметрыЭД.ДоговорКонтрагента = Источник.Ссылка;
...
Процедура ЗаполнитьДанныеПоКаталогуТоваровCML(Организация, ТоварыКаталога, ДеревоДанных, Отказ) Экспорт
	...
	СведенияОбОрганизации = УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ПолучитьДанныеЮрФизЛица(Организация,,, Ложь);
...
//                                             документа содержатся в подчененных строках. Сама строка обладает
...
Процедура ПриПолученииОписанияОснованияЭлектронногоДокумента(ОснованиеОбъект, Описание, СтандартнаяОбработка) Экспорт
	...
	Если ТипОснования = Тип("ДокументОбъект.РасходнаяНакладная") 
		ИЛИ ТипОснования = Тип("ДокументОбъект.СчетФактура")
		ИЛИ ТипОснования = Тип("ДокументСсылка.РасходнаяНакладная") 
		ИЛИ ТипОснования = Тип("ДокументСсылка.СчетФактура")
		ИЛИ ТипОснования = Тип("ДокументОбъект.ОтчетОПереработке")
		ИЛИ ТипОснования = Тип("ДокументСсылка.ОтчетОПереработке") Тогда
	...
	ИначеЕсли ТипОснования = Тип("ДокументОбъект.СчетНаОплату")
		Или ТипОснования = Тип("ДокументСсылка.СчетНаОплату") Тогда
	...
	ИначеЕсли ТипОснования = Тип("ДокументОбъект.ЗаказПокупателя")
		Или ТипОснования = Тип("ДокументСсылка.ЗаказПокупателя") Тогда
	...
	ИначеЕсли ТипОснования = Тип("ДокументОбъект.АктВыполненныхРабот")
		Или ТипОснования = Тип("ДокументСсылка.АктВыполненныхРабот") Тогда
	...
	ИначеЕсли ТипОснования = Тип("ДокументОбъект.АктОРасхождениях") 
		Или ТипОснования = Тип("ДокументСсылка.АктОРасхождениях") Тогда
	...
	ИначеЕсли ТипОснования = Тип("СправочникОбъект.ДоговорыКонтрагентов") 
		Или ТипОснования = Тип("СправочникСсылка.ДоговорыКонтрагентов") Тогда
		
		СтандартнаяОбработка = Ложь;
		
		Описание.Организация = ОснованиеОбъект.Организация;
		Описание.Контрагент  = ОснованиеОбъект.Владелец;
		Описание.Дата = ОснованиеОбъект.ДатаДоговора;
		Описание.Номер = ОснованиеОбъект.НомерДоговора;
...
Процедура ПодготовитьСтруктуруОбъектовКомандЭДО(СоставКомандЭДО) Экспорт
	...
	СоставКомандЭДО.Исходящие.Добавить("Документ.ОтчетОПереработке");
	СоставКомандЭДО.Исходящие.Добавить("Документ.СверкаВзаиморасчетов");
	...
	СоставКомандЭДО.Входящие.Добавить("Документ.ОтчетПереработчика");
	СоставКомандЭДО.Входящие.Добавить("Документ.СверкаВзаиморасчетов");
	...
	СоставКомандЭДО.БезПодписи.Добавить("Документ.ПередачаТоваровМеждуОрганизациями");
	СоставКомандЭДО.БезПодписи.Добавить("Документ.СчетФактура");
...
Процедура ЗаполнитьДанныеПоСчету(СсылкаНаОбъект, ДеревоДокумента, Отказ) Экспорт
	...
	СведенияОПоставщике = УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ПолучитьДанныеЮрФизЛица(РеквизитыШапки.Организация, РеквизитыШапки.ДатаДокумента,, Ложь);
	СведенияОПокупателе = УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ПолучитьДанныеЮрФизЛица(РеквизитыШапки.Контрагент, РеквизитыШапки.ДатаДокумента,, Ложь);
...
Процедура ЗаполнитьДанныеПоЗаказуТоваров(СсылкаНаОбъект, ДеревоДокумента, Отказ) Экспорт
	...
	Если ТипЗнч(СсылкаНаОбъект) = Тип("ДокументСсылка.ЗаказПоставщику") Тогда
		СведенияОПоставщике = УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ПолучитьДанныеЮрФизЛица(РеквизитыШапки.Контрагент, РеквизитыШапки.ДатаДокумента,, Ложь);
		СведенияОПокупателе = УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ПолучитьДанныеЮрФизЛица(РеквизитыШапки.Организация, РеквизитыШапки.ДатаДокумента,, Ложь);
	Иначе
		СведенияОПоставщике = УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ПолучитьДанныеЮрФизЛица(РеквизитыШапки.Организация, РеквизитыШапки.ДатаДокумента,, Ложь);
		СведенияОПокупателе = УправлениеНебольшойФирмойЭлектронныеДокументыСервер.ПолучитьДанныеЮрФизЛица(РеквизитыШапки.Контрагент, РеквизитыШапки.ДатаДокумента,, Ложь);
	КонецЕсли;
