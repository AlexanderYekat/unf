...
//		|				И ЕдиницаИзмеренияКилограммИС.Значение.Знаменатель <> 0
//		|		ТОГДА ВЫРАЗИТЬ(ЕдиницаИзмеренияКилограммИС.Значение.Числитель / ЕдиницаИзмеренияКилограммИС.Значение.Знаменатель КАК ЧИСЛО(18, 6))
//		|		ИНАЧЕ 0
...
//		|				И ЕдиницаИзмеренияЛитрИС.Значение.Знаменатель <> 0
//		|		ТОГДА ВЫРАЗИТЬ(ЕдиницаИзмеренияЛитрИС.Значение.Числитель / ЕдиницаИзмеренияЛитрИС.Значение.Знаменатель КАК ЧИСЛО(18, 6))
//		|		ИНАЧЕ 0
