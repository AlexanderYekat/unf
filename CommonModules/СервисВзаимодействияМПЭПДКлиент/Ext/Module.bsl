...
Функция ПараметрыДействийДляМобильногоПриложения(Документ, НаименованиеМП = Неопределено, ИдентификаторЗаписиМП = Неопределено) Экспорт
	...
	ИначеЕсли ТипЗнч(Документ) = Тип("ДокументСсылка.ЭлектронныйПутевойЛист") Тогда
		...
		Если РеквизитыДокумента.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул1") Тогда
			...
			ТолькоИзДокумента = Истина;
		ИначеЕсли РеквизитыДокумента.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул2")
			Или РеквизитыДокумента.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул6") Тогда
			ИндексАтомарнойРоли = 1;
			ИмяРеквизитаИдентификаторЭДО = "ИдентификаторМедорганизации";
		ИначеЕсли РеквизитыДокумента.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул3") Тогда
			ИмяРеквизитаИдентификаторЭДО = "ИдентификаторТехконтроль";
			ИндексАтомарнойРоли = 2;
		ИначеЕсли РеквизитыДокумента.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул4")
			Или РеквизитыДокумента.ТекущийТитул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул5") Тогда
	...
	ПараметрыФормы.Вставить("ИдентификаторЭДО", РеквизитыДокумента[ИмяРеквизитаИдентификаторЭДО]);
