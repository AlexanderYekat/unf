...
#КонецОбласти
#Область Скидки
Функция ДоступныеСкидкиПоВидуОплаты(ВидОплаты = Неопределено) Экспорт
	Запрос = Новый Запрос;
	Запрос.Текст =
	"ВЫБРАТЬ
	...
	|ГДЕ
	|	НЕ АвтоматическиеСкидки.ЕстьУсловияПоВидуОплаты
	...
	|		ПО АвтоматическиеСкидкиУсловияПредоставления.УсловиеПредоставления = УсловияПредоставленияСкидокНаценок.Ссылка
	|ГДЕ
	|	АвтоматическиеСкидки.ЕстьУсловияПоВидуОплаты
	|	И УсловияПредоставленияСкидокНаценок.ВидОплаты = &ВидОплаты
	|	И АвтоматическиеСкидки.Действует
	|	И НЕ АвтоматическиеСкидки.ПометкаУдаления";
