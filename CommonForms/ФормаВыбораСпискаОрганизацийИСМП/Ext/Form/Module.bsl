...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТолькоОднаОрганизация = Параметры.ТолькоОднаОрганизация;
	ЗаполнитьСписокОрганизаций();
	
	Если ТолькоОднаОрганизация Тогда
		Элементы.ТаблицаОрганизацииВыбратьВсе.Видимость   = Ложь;
		Элементы.ТаблицаОрганизацииИсключитьВсе.Видимость = Ложь;
	КонецЕсли;
...
Процедура ТаблицаОрганизацииВыбранаПриИзменении(Элемент)
	...
	Для Каждого СтрокаТаблицы Из ТаблицаОрганизации Цикл
		Если ТекущиеДанные.Организация <> СтрокаТаблицы.Организация Тогда
