...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// УНФ. Начало
	Если Параметры.Свойство("НеВыбиратьФорматВложений") Тогда
		Элементы.ГруппаДополнительныеПараметры.Видимость = Не Параметры.НеВыбиратьФорматВложений;
	КонецЕсли;
	
	// Если есть только один адрес электронной почты, то установим флаг в строке с этим адресом.
	ЗаполненоАдресов = 0;
