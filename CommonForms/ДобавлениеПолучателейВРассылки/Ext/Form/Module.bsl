...
Процедура ЗавершитьВыборАдреснойКниги(Команда)
	...
	ЕстьОшибки = ЭкспортироватьКонтактыВСервисРассылок();
	ВыбранныеАдресныеКниги = АдресныеКнигиСервиса.НайтиСтроки(Новый Структура("Выбран", Истина));
	
	Если ЕстьОшибки Тогда
		// Не закрывать форму чтобы вывести пользователю сообщения об ошибках.
		Возврат;
	КонецЕсли;
...
&НаСервере
Функция ЭкспортироватьКонтактыВСервисРассылок()
	ЕстьОшибки = Ложь;
	...
	Для каждого АдреснаяКнига Из ВыбранныеАдресныеКниги Цикл
		...
		Если НЕ ЗначениеЗаполнено(АдреснаяКнига.Идентификатор) Тогда
			...
			ЕстьОшибки = МассовыеРассылкиИнтеграция.СоздатьАдреснуюКнигуСервиса(ДанныеАдреснойКниги);
			Продолжить;
		...
		ДанныеАдреснойКниги.Получатели = ПолучателиАдреснойКниги;
		ЕстьОшибки = МассовыеРассылкиИнтеграция.ДобавитьПолучателейВАдреснуюКнигуСервиса(ДанныеАдреснойКниги);
