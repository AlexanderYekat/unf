...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ЭтоВыборКодаМаркировкиКегаНаОборудованииРозливаИСМП(ЭтотОбъект) Тогда
...
Процедура ВывестиПоясняющийТекст()
	...
	ИначеЕсли ЭтоВыборКодаМаркировкиКегаНаОборудованииРозливаИСМП(ЭтотОбъект) Тогда
...
Процедура УстановитьВидимостьДоступностьЭлементовПриСозданииНаСервере()
	...
	Элементы.КодМаркировки.Видимость = (КоличествоКодовМаркировкиНаОборудованииРозлива > 1);
	...
	Если ОбщегоНазначенияИСПовтИсп.ЭтоПродукцияИСМП(ВидПродукции) Тогда
		...
		Если МожетВыбыватьЧастично И ЧастичноеВыбытие Тогда
			...
			Если ВидПродукции = Перечисления.ВидыПродукцииИС.Пиво Тогда
				...
				КоличествоКодовМаркировкиНаОборудованииРозлива = КодыМаркировки.Количество();

				Если КоличествоКодовМаркировкиНаОборудованииРозлива > 1 Тогда
...
Процедура НастроитьЭлементыФормыЧастичногоВыбытия(Форма)
	...
	Элементы.РежимВыбытия.ТолькоПросмотр = Форма.ЧастичноеВыбытиеВыведено > 0 Или Форма.КоличествоКодовМаркировкиНаОборудованииРозлива > 0 Или ЭтоВыборКодаМаркировкиКегаНаОборудованииРозливаИСМП(Форма);
...
&НаКлиентеНаСервереБезКонтекста
Функция ЭтоВыборКодаМаркировкиКегаНаОборудованииРозливаИСМП(Форма)
	Возврат (Форма.КоличествоКодовМаркировкиНаОборудованииРозлива > 1
