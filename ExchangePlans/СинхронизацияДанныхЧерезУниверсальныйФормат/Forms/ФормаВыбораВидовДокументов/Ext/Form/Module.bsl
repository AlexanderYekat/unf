...
Процедура СформироватьДеревоВидовДокументов(МассивВыбранныхЗначений)
	...
	СтрокаДетальныеЗаписи = СтрокаВерхнегоУровня.Строки.Добавить();
	СтрокаДетальныеЗаписи.ИмяОбъектаМетаданных = МетаДокументы.ЗаказПокупателя.Имя + "Продажа";
	СтрокаДетальныеЗаписи.ПолноеИмяМетаданных = МетаДокументы.ЗаказПокупателя.ПолноеИмя();
	СтрокаДетальныеЗаписи.Представление = "Заказ-покупателя";
	...
	СтрокаВерхнегоУровня = ДеревоОтбора.Строки.Добавить();
	СтрокаВерхнегоУровня.Представление = "Работы";
	...
	ДобавитьСтрокуДереваВидовДокументов(МетаДокументы.КомплектацияЗапасов, СтрокаВерхнегоУровня);
	...
	ДобавитьСтрокуДереваВидовДокументов(МетаДокументы.ВнесениеНаличных, СтрокаВерхнегоУровня);
	ДобавитьСтрокуДереваВидовДокументов(МетаДокументы.ВыемкаНаличных, СтрокаВерхнегоУровня);
