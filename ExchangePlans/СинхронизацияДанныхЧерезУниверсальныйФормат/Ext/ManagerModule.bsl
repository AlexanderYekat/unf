...
Процедура ПриПолученииВариантовНастроекОбмена(ВариантыНастроекОбмена, ПараметрыКонтекста) Экспорт
	...
	Если ПараметрыКонтекста.ИмяКорреспондента = "БухгалтерияПредприятия"
		ИЛИ НЕ ЗначениеЗаполнено(ПараметрыКонтекста.ИмяКорреспондента) Тогда
		ВариантНастройки = ВариантыНастроекОбмена.Добавить();
		ВариантНастройки.ИдентификаторНастройки        = "ОбменУНФ_БП3";
		ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
		ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	КонецЕсли;
	...
	Если ОбщегоНазначенияУНФ.ЭтоУНФ() Тогда
		...
		ВариантНастройки = ВариантыНастроекОбмена.Добавить();
		ВариантНастройки.ИдентификаторНастройки        = "ОбменРТ30";
		ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
		ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
		...
		Если ПараметрыКонтекста.ИмяКорреспондента = "ЗарплатаИУправлениеПерсоналом"
			...
			ВариантНастройки = ВариантыНастроекОбмена.Добавить();
			ВариантНастройки.ИдентификаторНастройки        = "ОбменЗУПУНФ";
			ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
			ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	...
	Иначе
		Если ПараметрыКонтекста.ИмяКорреспондента = "УправлениеНебольшойФирмой"
			ИЛИ НЕ ЗначениеЗаполнено(ПараметрыКонтекста.ИмяКорреспондента) Тогда
			ВариантНастройки = ВариантыНастроекОбмена.Добавить();
			ВариантНастройки.ИдентификаторНастройки        = "ОбменУНФРТ30";
			ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
			ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
		КонецЕсли;
	КонецЕсли;
...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	Если ИдентификаторНастройки = "ОбменБП30" ИЛИ ИдентификаторНастройки = "ОбменУНФ_БП3" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""1С:%1""
		|и ""1С:Бухгалтерия предприятия, редакция 3.0"".  В синхронизации участвуют документы и нормативно-справочная информация.'");
		ПодробнаяИнформацияПоОбмену = "https://its.1c.ru/db/metod81#content:7296:hdoc";
	ИначеЕсли ИдентификаторНастройки = "ОбменКасса" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит настроить полную синхронизацию данных между программами ""1С:%1"" и ""1С:Касса"".
		|В случае использования 1С:Касса только в качестве внешнего рабочего места кассира воспользуйтесь помощником: Настройки → Интеграции → 1С:РМК, 1С:Касса, 1С:Мобильная касса.'");
	ИначеЕсли ИдентификаторНастройки = "ОбменРТ" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""1С:%1""
		|и ""1С:Розница, редакция 2.3"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ИдентификаторНастройки = "ОбменРТ30" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""1С:%1""
		|и ""1С:Розница, редакция 3.0"". В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ИдентификаторНастройки = "ОбменЗУПУНФ" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""1С:%1""
		|и ""Зарплата и управление персоналом, редакция 3.1"". В синхронизации задействованы: основная нормативно-справочная информация в направлении как отправки, так и получения;
		|документы платежных ведомостей только в направлении получения.'");
	ИначеЕсли ИдентификаторНастройки = "КабинетКлиента" Тогда
		...
		ПодробнаяИнформацияПоОбмену = "https://its.1c.ru/db/metod81#browse:13:-1:2115:2503:2512:2535:2536";
	ИначеЕсли ИдентификаторНастройки = "ОбменУТ11" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""1С:%1""
		|и ""1С:Управление торговлей, редакция 11.5"".  В синхронизации участвуют документы и нормативно-справочная информация.'");
	ИначеЕсли ИдентификаторНастройки = "ОбменУНФРТ30" Тогда
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""1С:%1""
		|и ""1С:Управление нашей фирмой, редакция 3.0"".  В синхронизации участвуют документы и нормативно-справочная информация.'");
	Иначе
	...
	СинонимМетаданных = Метаданные.Синоним;
	Если ОбщегоНазначенияУНФ.ЭтоРозница() Тогда
		СинонимМетаданных = НСтр("ru = 'Розница, редакция 3.0'");
	КонецЕсли;
	
	Если СтрНайти(КраткаяИнформацияПоОбмену, "%1") > 0 Тогда
		КраткаяИнформацияПоОбмену = СтрШаблон(КраткаяИнформацияПоОбмену, СинонимМетаданных);
	КонецЕсли;
	...
	Если ИдентификаторНастройки = "ОбменБП30" ИЛИ ИдентификаторНастройки = "ОбменУНФ_БП3" Тогда
		...
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Бухгалтерия предприятия, ред. 3.0'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Бухгалтерия предприятия, ред. 3.0""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Бухгалтерия предприятия, ред. 3.0""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Бухгалтерия предприятия, ред. 3.0'");
	ИначеЕсли ИдентификаторНастройки = "ОбменКасса" Тогда
	...
	ИначеЕсли ИдентификаторНастройки = "ОбменРТ" Тогда
		...
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Розница, ред. 2.3 (EnterpriseData)'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Розница, ред. 2.3""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Розница, ред. 2.3""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Розница, ред. 2.3'");
	ИначеЕсли ИдентификаторНастройки = "ОбменРТ30" Тогда
		ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "Розница";
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Розница, ред. 3.0 (EnterpriseData)'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Розница, ред. 3.0""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Розница, ред. 3.0""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Розница, ред. 3.0'");
	ИначеЕсли ИдентификаторНастройки = "ОбменЗУПУНФ" Тогда
		ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "ЗарплатаИУправлениеПерсоналом";
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Зарплата и управление персоналом, редакция 3.1 (EnterpriseData)'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Зарплата и управление персоналом, ред. 3.1""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Зарплата и управление персоналом, ред. 3.1""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Зарплата и управление персоналом, ред. 3.1'");
	ИначеЕсли ИдентификаторНастройки = "КабинетКлиента" Тогда
	...
	ИначеЕсли ИдентификаторНастройки = "ОбменУТ11" Тогда
		...
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Управление торговлей, ред. 11.5'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Управление торговлей, ред. 11.5""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Управление торговлей, ред. 11.5""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Управление торговлей, ред. 11.5'");
	ИначеЕсли ИдентификаторНастройки = "ОбменУНФРТ30" Тогда
		ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "УправлениеНебольшойФирмой";
		ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = НСтр("ru = '1С:Управление нашей фирмой, ред. 3.0'");
		ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru = 'Настройка синхронизации с программой ""1С:Управление нашей фирмой, ред. 3.0""'");
		ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru = 'Синхронизация с программой ""1С:Управление нашей фирмой, ред. 3.0""'");
		ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         НСтр("ru = '1С:Управление нашей фирмой, ред. 3.0'");
	Иначе
...
Функция ИмяПланаОбменаСтаройНастройки(ВариантНастройки) Экспорт
	...
	Если СокрЛП(ВариантНастройки) = "ОбменБП30" ИЛИ СокрЛП(ВариантНастройки) = "ОбменУНФ_БП3" Тогда
