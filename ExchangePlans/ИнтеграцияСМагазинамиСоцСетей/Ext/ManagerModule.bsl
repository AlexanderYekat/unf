...
Функция ПолучитьОписаниеУзлаОбмена(СсылкаНаУзелОбмена) Экспорт
	...
	|	ИнтеграцияСМагазинамиСоцСетей.ИсточникДляПодстановкиВЗаказы КАК ИсточникДляПодстановкиВЗаказы,
	|	ИнтеграцияСМагазинамиСоцСетей.ИспользоватьПодборкиТоваров КАК ИспользоватьПодборкиТоваров,
	|	ЕСТЬNULL(ПоследняяУспешнаяОперацияОбменаДляМагазинаСоцСетей.ТребуетсяРучноеПодтверждение, ЛОЖЬ) КАК ТребуетсяРучноеПодтверждение,
	|	ИнтеграцияСМагазинамиСоцСетей.СкладДляПодстановкиВЗаказы КАК СкладДляПодстановкиВЗаказы,
	|	ИнтеграцияСМагазинамиСоцСетей.РезервироватьТовар КАК РезервироватьТовар,
	|	ИнтеграцияСМагазинамиСоцСетей.ДобавитьКНаименованиюХарактеристикиНаименованиеНоменклатуры КАК ДобавитьКНаименованиюХарактеристикиНаименованиеНоменклатуры,
	|	ИнтеграцияСМагазинамиСоцСетей.ПричинаОтмены КАК ПричинаОтмены
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ ПЕРВЫЕ 1
	|	ВЫРАЗИТЬ(СопоставлениеИдентификаторовМагазиновСоцСетей.Ссылка КАК Документ.ЗаказПокупателя).Дата КАК ДатаДокумента,
	|	СопоставлениеИдентификаторовМагазиновСоцСетей.Идентификатор КАК ИдентификаторЗаказа
	|ИЗ
	|	РегистрСведений.СопоставлениеИдентификаторовМагазиновСоцСетей КАК СопоставлениеИдентификаторовМагазиновСоцСетей
	|ГДЕ
	|	СопоставлениеИдентификаторовМагазиновСоцСетей.УзелИнформационнойБазы = &УзелОбмена
	|	И СопоставлениеИдентификаторовМагазиновСоцСетей.ТипИдентификатора = ""order""
	|	И СопоставлениеИдентификаторовМагазиновСоцСетей.Ссылка ССЫЛКА Документ.ЗаказПокупателя
	|
	|УПОРЯДОЧИТЬ ПО
	|	ДатаДокумента УБЫВ";
	...
	ОписаниеУзелОбмена.Вставить("ТекущаяДата" , ТекущаяДатаСеанса());
	...
	ОписаниеУзелОбмена.Вставить("ИсточникДляПодстановкиВЗаказы", ВыборкаДетальныеЗаписи.ИсточникДляПодстановкиВЗаказы);
	ОписаниеУзелОбмена.Вставить("ИспользоватьПодборкиТоваров", ВыборкаДетальныеЗаписи.ИспользоватьПодборкиТоваров);
	ОписаниеУзелОбмена.Вставить("ТребуетсяРучноеПодтверждение", ВыборкаДетальныеЗаписи.ТребуетсяРучноеПодтверждение);
	ОписаниеУзелОбмена.Вставить("СкладДляПодстановкиВЗаказы", ВыборкаДетальныеЗаписи.СкладДляПодстановкиВЗаказы);
	ОписаниеУзелОбмена.Вставить("РезервироватьТовар", ВыборкаДетальныеЗаписи.РезервироватьТовар);
	ОписаниеУзелОбмена.Вставить("ПричинаОтмены", ВыборкаДетальныеЗаписи.ПричинаОтмены);
	ОписаниеУзелОбмена.Вставить("ДобавитьКНаименованиюХарактеристикиНаименованиеНоменклатуры", ВыборкаДетальныеЗаписи.ДобавитьКНаименованиюХарактеристикиНаименованиеНоменклатуры);
	...
	Если НЕ ЗначениеЗаполнено(ОписаниеУзелОбмена.ВалютаПоУмолчанию) Тогда
		ОписаниеУзелОбмена.Вставить("ВалютаПоУмолчанию" , Константы.ВалютаУчета.Получить());
	КонецЕсли;
	...
	Если НЕ РезультатЗапроса[6].Пустой() Тогда
		...
		ВыборкаДетальныеЗаписи.Следующий();
		ИдентификаторЗаказа = ВыборкаДетальныеЗаписи.ИдентификаторЗаказа;
	КонецЕсли;
	ОписаниеУзелОбмена.Вставить("ИдентификаторЗаказа" , ИдентификаторЗаказа); 
	
	ОписаниеУзелОбмена.Вставить("Метаданные" , Строка(Метаданные.ПланыОбмена.ИнтеграцияСМагазинамиСоцСетей));
...
Функция ВыполнитьМассивОпераций(МассивВсехОпераций, ОписаниеУзелОбмена)
	...
	Для Каждого СтрОперация Из МассивВсехОпераций Цикл
		...
		МассивСкриптов.Добавить(СтрШаблон(ШаблонВыполненияМассиваОперация, СтрокаСкрипта));
...
Функция ВыполнитьМассивСкриптов(МассивСкриптов, МассивВсехОпераций, ОписаниеУзелОбмена,СтрокаПараметров = "")
	...
	Для Каждого СтрокаСкрипта Из МассивСкриптов Цикл 
		...
		ИначеЕсли ОтветМассив = Неопределено Тогда
		...
		Для Н = 0 По ОтветМассив.ВГраница() Цикл
			...
			Если ОписаниеОперации.Результат = Ложь Тогда
				...
				Если СтрНайти(НРег(СтруктураЗапросаHTTP.ТелоОтвета),"photo not found or already assigned to another item") <> 0 Тогда
					...
					Если ОписаниеОперации.Описание.Свойство("main_photo_id") Тогда
						МассивИдентификаторовФайлов.Добавить(ОписаниеОперации.Описание.main_photo_id);
					КонецЕсли;
					
					Если МассивИдентификаторовФайлов.Количество() Тогда
						УдалитьФайлыТовараПоИдентификаторам(МассивИдентификаторовФайлов, ОписаниеУзелОбмена.Ссылка);
					КонецЕсли;
					
					Если ОписаниеОперации.Описание.Свойство("name") Тогда
						ОписаниеОперации.Ошибка = СтрШаблон("Ошибка обработки фотографии товара ""%1""", ОписаниеОперации.Описание.name);
					КонецЕсли;
					
				ИначеЕсли СтрНайти(НРег(СтруктураЗапросаHTTP.ТелоОтвета), "item not found") <> 0 Тогда
					СтруктураОшибки.ЗарегистрироватьСсылкиКОбмену.Добавить(ОписаниеОперации.Ссылка);
					
					МассивИдентификаторов = Новый Массив;
					Если ОписаниеОперации.Описание.Свойство("item_id") Тогда
						МассивИдентификаторов = СтрРазделить(ОписаниеОперации.Описание.item_id,",");
					КонецЕсли;
					
					УдалитьТоварыПоИдентификаторам(МассивИдентификаторов, ОписаниеУзелОбмена.Ссылка);
					
					ПредставлениеТовара = "";
					Если ОписаниеОперации.Описание.Свойство("name") Тогда
						ПредставлениеТовара = ОписаниеОперации.Описание.name;
					ИначеЕсли ОписаниеОперации.Описание.Свойство("item_id") Тогда
						ПредставлениеТовара = ОписаниеОперации.Описание.item_id;
					КонецЕсли;
					
					Если ЗначениеЗаполнено(ПредставлениеТовара) Тогда
						ОписаниеОперации.Ошибка = СтрШаблон("Идентификатор не найден в ВК. Товар ""%1""", ПредставлениеТовара);
					КонецЕсли;
					
				ИначеЕсли СтрНайти(НРег(СтруктураЗапросаHTTP.ТелоОтвета),"One of the parameters specified was missing or invalid: nothing to change") <> 0 Тогда
					ОписаниеОперации.Результат = 1;
					ОписаниеОперации.Ошибка = "";
				Иначе
		...
		Если СтрОперация.Результат <> Неопределено Тогда
			...
			Иначе
				...
				Если (СтрОперация.ИмяМетода = "market.add" Или СтрОперация.ИмяМетода = "market.edit"
					Или  СтрОперация.ИмяМетода = "market.addAlbum" Или СтрОперация.ИмяМетода = "market.editAlbum")
					И (СтрОперация.Свойство("Хеш") Или СтрОперация.Свойство("Хэш")) Тогда
					
					Если СтрОперация.Свойство("Хеш") Тогда
						ДобавитьХешКонтролируемыхРеквизитовМагазина(ОписаниеУзелОбмена.Ссылка, СтрОперация.Ссылка, СтрОперация.Хеш);
					ИначеЕсли СтрОперация.Свойство("Хэш") Тогда
						ДобавитьХешКонтролируемыхРеквизитовМагазина(ОписаниеУзелОбмена.Ссылка, СтрОперация.Ссылка, СтрОперация.Хэш);
					КонецЕсли;
...
Процедура СоздатьОбновитьНаборыСвойствИЗначений(ОписаниеУзелОбмена, СпособОбменаСМагазином) Экспорт
	...
	Если ТипЗнч(РезультатМассив) = Тип("Массив") Тогда
...
Функция ПолучитьТекстВыгрузкиТоваров()
	...
	|ГДЕ
	|	НоменклатураХарактеристикДляМагазинаСоцСетей.УзелИнформационнойБазы = &УзелОбмена
	|	И СопоставлениеИдентификаторовМагазиновСоцСетей.Идентификатор ЕСТЬ NULL
	|	И НоменклатураХарактеристикДляМагазинаСоцСетей.Характеристика <> ЗНАЧЕНИЕ(Справочник.ХарактеристикиНоменклатуры.ПустаяСсылка)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|
	|ВЫБРАТЬ
	|	НоменклатураХарактеристикДляМагазинаСоцСетей.Номенклатура
	|ИЗ
	|	РегистрСведений.НоменклатураХарактеристикДляМагазинаСоцСетей КАК НоменклатураХарактеристикДляМагазинаСоцСетей
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СопоставлениеИдентификаторовМагазиновСоцСетей КАК СопоставлениеИдентификаторовМагазиновСоцСетей
	|		ПО НоменклатураХарактеристикДляМагазинаСоцСетей.УзелИнформационнойБазы = СопоставлениеИдентификаторовМагазиновСоцСетей.УзелИнформационнойБазы
	...
	|		ПО ВТ_ВсяНоменклатураДоступнаДляОбмена.Номенклатура = ВТ_Номенклатура.Номенклатура
	|			И ВТ_ВсяНоменклатураДоступнаДляОбмена.Характеристика = ВТ_Номенклатура.Характеристика
	|ГДЕ
	|	&ВыгружатьОстаток
	...
	|				ИЛИ ЕСТЬNULL(ВТ_Номенклатура.ИзменениеРеквизиты, ЛОЖЬ) = ИСТИНА
	|				ИЛИ ЕСТЬNULL(ВТ_Номенклатура.ИзменениеЦена, ЛОЖЬ) = ИСТИНА
	|				ИЛИ ЕСТЬNULL(ВТ_Номенклатура.ИзменениеФайлы, ЛОЖЬ) = ИСТИНА))
	|	И НЕ ВТ_ВсяНоменклатураДоступнаДляОбмена.ПометкаУдаления
	|	И НЕ ВТ_ВсяНоменклатураДоступнаДляОбмена.Недействителен
	|;
	|
	...
	|		ПО ВТ_ВсяНоменклатура.Номенклатура = ЦеныНоменклатурыСрезПоследнихОсновнаяЦена.Номенклатура
	|			И ВТ_ВсяНоменклатура.Характеристика = ЦеныНоменклатурыСрезПоследнихОсновнаяЦена.Характеристика
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЦеныНоменклатуры.СрезПоследних(
	|				&ТекущаяДата,
	|				(Номенклатура, Характеристика) В
	|						(ВЫБРАТЬ
	...
	|		ПО ВТ_ВсяНоменклатура.Номенклатура = ЦеныНоменклатурыСрезПоследнихСтараяЦена.Номенклатура
	|			И ВТ_ВсяНоменклатура.Характеристика = ЦеныНоменклатурыСрезПоследнихСтараяЦена.Характеристика
	|ГДЕ
	|	&ВыгружатьЦены
	|;
	|
...
Процедура ВыполнитьОбменИнтерактивно(СсылкаНаУзелОбмена, ЭтоПолныйОбмен = Ложь, ЭтоФоновоеЗадание = Ложь) Экспорт
	...
	Попытка
		...
		Если ОписаниеУзелОбмена.ТребуетсяРучноеПодтверждение И ЭтоФоновоеЗадание Тогда
			
			ДлительныеОперации.СообщитьПрогресс(20, НСтр("ru = 'Отправка статусов заказов...Капча
			|Загрузка заказов...'"));
		...
		Если ОписаниеУзелОбмена.ТребуетсяРучноеПодтверждение И ЭтоФоновоеЗадание Тогда
			...
			ДлительныеОперации.СообщитьПрогресс(80, НСтр("ru = 'Отправка статусов заказов...ОК
			|Загрузка заказов...ОК
			|Проверка файлов номенклатур...ОК
		...
		Иначе
			...
			ОперацияУспешна = ВыгрузитьНоменклатуру(ОписаниеУзелОбмена, СпособОбменаСМагазином,Ложь, ЭтоКапча);
		...
		ОбработкаПослеВыполнения(СсылкаНаУзелОбмена, ЭтоКапча);
...
Процедура ОбработкаПослеВыполнения(СсылкаНаУзелОбмена, ЭтоКапча)
КонецПроцедуры
...
Процедура ОбработатьОшибку(ОписаниеУзелОбмена, ПредставлениеОшибки)
	...
	ЗаписьЖурналаРегистрации("ИнтеграцияСМагазином", УровеньЖурналаРегистрации.Ошибка,ОписаниеУзелОбмена.Ссылка.Метаданные(),ОписаниеУзелОбмена.Ссылка, ОписаниеОшибки);
...
Процедура СоздатьОтправитьEmail(ОписаниеУзелОбмена, ТемаПисьма, ТелоПисьма, ЭтоОшибка = Ложь)
	...
	Попытка
		...
		Если ЭтоОшибка И ОписаниеУзелОбмена.ОтправлятьСкрытуюКопиюВПоддержку И СтрНайти(ТелоПисьма, "captcha_sid") = 0 Тогда
			НоваяСтрока = НовоеСобытие.Участники.Добавить();
			НоваяСтрока.Контакт = "Команда разработки приложения <sbm@1c.ru>";
	...
	Исключение
		...
		ПредставлениеОшибки = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
		ЗаписьЖурналаРегистрации("ИнтеграцияСМагазином", УровеньЖурналаРегистрации.Ошибка,
		ОписаниеУзелОбмена.Ссылка.Метаданные(),ОписаниеУзелОбмена.Ссылка, ПредставлениеОшибки);
...
Процедура ОбработатьПодборкиТоваров(ОписаниеУзелОбмена, ЭтоПолныйОбмен = Ложь) Экспорт
	...
	Если ОписаниеУзелОбмена.ИспользоватьПодборкиТоваров = Ложь Тогда
		Возврат;
	КонецЕсли;
	...
	|	СопоставлениеИдентификаторовМагазинаПодборка.УзелИнформационнойБазы КАК УзелИнформационнойБазы,
	|	СопоставлениеИдентификаторовМагазинаПодборка.ТипИдентификатора КАК ТипИдентификатора
	|ИЗ
	|	Справочник.ВиртуальныеКаталогиТоваровМагазиновСоцСетей КАК ВиртуальныеКаталогиТоваровМагазиновСоцСетей
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.СопоставлениеИдентификаторовМагазиновСоцСетей КАК СопоставлениеИдентификаторовМагазинаПодборка
	...
	|ГДЕ
	|	НЕ СопоставлениеИдентификаторовМагазинаПодборка.Идентификатор В (&МассивИдентификаторов)";
	
	МассивИдентификаторов = Новый Массив;
	Для Каждого Стр Из МассивПодборок Цикл
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		МЗ.ТипИдентификатора = ВыборкаДетальныеЗаписи.ТипИдентификатора;
		МЗ.Ссылка = ВыборкаДетальныеЗаписи.Ссылка;
		МЗ.Удалить();
	КонецЦикла;
	...
	"ВЫБРАТЬ
	|	ВиртуальныеКаталогиТоваровМагазиновСоцСетей.Ссылка КАК Ссылка,
	|	СопоставлениеИдентификаторовМагазинаПодборка.Идентификатор КАК Идентификатор
	|ИЗ
	|	Справочник.ВиртуальныеКаталогиТоваровМагазиновСоцСетей КАК ВиртуальныеКаталогиТоваровМагазиновСоцСетей
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.СопоставлениеИдентификаторовМагазиновСоцСетей КАК СопоставлениеИдентификаторовМагазинаПодборка
	|		ПО ВиртуальныеКаталогиТоваровМагазиновСоцСетей.Ссылка = СопоставлениеИдентификаторовМагазинаПодборка.Ссылка
	...
	|			И (СопоставлениеИдентификаторовМагазинаПодборка.ТипИдентификатора = ""album"")
	|ГДЕ
	|	ВиртуальныеКаталогиТоваровМагазиновСоцСетей.Логотип <> ЗНАЧЕНИЕ(Справочник.ВиртуальныеКаталогиТоваровМагазиновСоцСетейПрисоединенныеФайлы.ПустаяСсылка)";
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ПарметрСтрокой = "&album_id=" + ВыборкаДетальныеЗаписи.Идентификатор;
		
		МассивТоваров = ПолучитьВсеТоварыИзМагазина(ОписаниеУзелОбмена,Истина ,Истина, ПарметрСтрокой);
		Для Каждого ОписаниеНоменклатура Из МассивТоваров Цикл
			
			НовСтр = ТаблицаСоставаПодборок.Добавить();
			НовСтр.ИдентификаторПодборки = ВыборкаДетальныеЗаписи.Идентификатор;
			НовСтр.ВиртуальныйКаталог = ВыборкаДетальныеЗаписи.Ссылка;
			НовСтр.ИдентификаторТовара = ОписаниеНоменклатура.Идентификатор;
			
			Если ЗначениеЗаполнено(ОписаниеНоменклатура.ИдентификаторНоменклатуры) Тогда
				НовСтр = ТаблицаСоставаПодборок.Добавить();
				НовСтр.ИдентификаторПодборки = ВыборкаДетальныеЗаписи.Идентификатор;
				НовСтр.ВиртуальныйКаталог = ВыборкаДетальныеЗаписи.Ссылка;
				НовСтр.ИдентификаторТовара = ОписаниеНоменклатура.ИдентификаторНоменклатуры;
			КонецЕсли;
			
			Для Каждого СтрИдентификаторХарактеристики Из ОписаниеНоменклатура.МассивХарактеристик Цикл
				
				НовСтр = ТаблицаСоставаПодборок.Добавить();
				НовСтр.ИдентификаторПодборки = ВыборкаДетальныеЗаписи.Идентификатор;
				НовСтр.ВиртуальныйКаталог = ВыборкаДетальныеЗаписи.Ссылка;
				НовСтр.ИдентификаторТовара = СтрИдентификаторХарактеристики;
	...
	|ГДЕ
	|	НоменклатураХарактеристикДляМагазинаСоцСетейВиртуальныеКаталоги.УзелИнформационнойБазы = &УзелИнформационнойБазы
	...
	Если НЕ РезультатЗапросаСоставПодборок.Пустой() Тогда
		...
		Пока ВыборкаДетальныеЗаписиПодборка.Следующий() Цикл
			...
			Если МассивДляДобавления.Количество() Тогда
				Для Каждого СтрИдентификатор Из МассивДляДобавления Цикл
					АдресРесурса = "/method/market.addToAlbum";
					ЗаполнитьОсновныеПараметры(АдресРесурса,ОписаниеУзелОбмена);
					
					АдресРесурса = АдресРесурса + СтрШаблон("&owner_id=-%1&album_ids=%2&item_id=%3", ОписаниеУзелОбмена.ИдентификаторГруппы,ВыборкаДетальныеЗаписиПодборка.ИдентификаторПодборки, СтрИдентификатор);
					
					Ответ = ВыполнитьЗапросИПроверить_ПолучитьОтвет(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса, 0, Ложь, Ложь);
					
					Если СтрНайти(СтруктураЗапросаHTTP.ТелоОтвета, "Item not found: For album") <> 0 Тогда
						УдалитьТоварыПоИдентификаторам(СтрИдентификатор, ОписаниеУзелОбмена.Ссылка);
					КонецЕсли;
			...
			Если УдалениеУспешно И ДобавлениеУспешно
				И (МассивДляДобавления.Количество() > 0 Или МассивДляУдаления.Количество() > 0) Тогда
...
Процедура СоздатьРегламентноеЗаданиеОбмена(СсылкаНаУзелОбмена) Экспорт
	...
	Если ОбщегоНазначения.ЗначениеРеквизитаОбъекта( СсылкаНаУзелОбмена, "ИспользоватьРегламентныеЗадания" ) <> Истина Тогда
		Возврат;
	КонецЕсли;
	...
	Если Задание = Неопределено Тогда
		...
		РасписаниеРегламентногоЗадания = ПолучитьРасписаниеРегламентногоЗадания(СсылкаНаУзелОбмена);
...
Функция ПолучитьРасписаниеРегламентногоЗадания(СсылкаНаУзелОбмена)
	
	РасписаниеРегламентногоЗадания = Неопределено;
	
	Если СсылкаНаУзелОбмена.РасписаниеРегламентногоЗадания <> "" Тогда
		Попытка
			РасписаниеРегламентногоЗадания = ЗначениеИзСтрокиВнутр(СсылкаНаУзелОбмена.РасписаниеРегламентногоЗадания);
		Исключение
		КонецПопытки;
	КонецЕсли;
...
Процедура УдалитьРегламентноеЗаданиеОбмена(СсылкаНаУзелОбмена, ПересоздатьЗадание = Ложь) Экспорт
...
Функция ВыгрузитьНоменклатуру(ОписаниеУзелОбмена, знач СпособОбменаСМагазином, ЭтоПовтор = Ложь, ЭтоКапча = Ложь) Экспорт
	...
	ОбработатьЦеныТоваров(СоответствиеИдентификаторов, РезультатЗапросаЦена, ОписаниеУзелОбмена.ВыгружатьЦены);
	
	// Обработка остаток номенклатуры
	ОбработатьОстаткиТоваров(СоответствиеИдентификаторов, РезультатЗапросаОстаток, ОписаниеУзелОбмена.ВыгружатьОстаток);
	...
	// Обработка номенклатуры
	ОбработатьТоварыПриВыгрузке(СоответствиеИдентификаторов, РезультатЗапросаНоменклатура, ОписаниеУзелОбмена, МассивИсключенияНоменклатуры, СпособОбменаСМагазином);
	...
	Для Каждого КлючЗначение Из СоответствиеИдентификаторов Цикл 
		...
		Если ТребуетсяУдаление И ОписаниеНоменклатуры.Свойство("item_id") Тогда
			ОписаниеОперации = Новый Структура;
	...
	Если РезультатВыполнения <> Неопределено Тогда
		...
		Если РезультатВыполнения.ЭтоКапча Тогда
			...
			Если ЗарегистрироватьСсылкиКОбмену.Количество() Тогда
				ПланыОбмена.ЗарегистрироватьИзменения(ОписаниеУзелОбмена.Ссылка, ЗарегистрироватьСсылкиКОбмену);
			КонецЕсли;
		...
		Иначе
			...
			ЗарегистрироватьСсылкиКОбмену = РезультатВыполнения.ЗарегистрироватьСсылкиКОбмену;
	...
	Если ЗарегистрироватьСсылкиКОбмену.Количество() Тогда
		...
		Если НЕ ЭтоПовтор Тогда
			...
			ВыгрузитьНоменклатуру(ОписаниеУзелОбмена, СпособОбменаСМагазином, Истина, ЭтоКапча);
...
Процедура ПродолжитьОтложеннуюОперациюВФоне(Параметры, АдресХранилища = Неопределено) Экспорт
	...
	ПродолжитьОтложеннуюОперацию(ИмяОперации, ОписаниеОперацииСкрипта,СохраненнаяОперация.ПеременныеОперации, ОписаниеУзелОбмена, ЭтоКапча);
	
	ОбработкаПослеВыполнения(Параметры.СсылкаНаУзелОбмена, ЭтоКапча);
	
КонецПроцедуры

Процедура ПродолжитьОтложеннуюОперацию(ИмяОперации, ОписаниеОперацииСкрипта, ПеременныеОперации, ОписаниеУзелОбмена, ЭтоКапча) Экспорт
	...
	Если ИмяОперации = "ВыгрузитьНоменклатуру" Тогда
		РезультатОперации = ПродолжитьОперациюВыгрузитьНоменклатуру(ОписаниеОперацииСкрипта, ПеременныеОперации, ОписаниеУзелОбмена, ЭтоКапча);
	КонецЕсли; 
...
Функция ПродолжитьОперациюВыгрузитьНоменклатуру(ОписаниеОперацииСкрипта, ПеременныеОперации, ОписаниеУзелОбмена, ЭтоКапча) Экспорт
	...
	Если ЗарегистрироватьСсылкиКОбмену.Количество() Тогда
		...
		Если НЕ ПеременныеОперации.ЭтоПовтор Тогда
			...
			ВыгрузитьНоменклатуру(ОписаниеУзелОбмена, ПеременныеОперации.СпособОбменаСМагазином, Истина, ЭтоКапча);
...
Процедура ОбработатьТоварыПриВыгрузке(СоответствиеИдентификаторов, РезультатЗапросаНоменклатура, ОписаниеУзелОбмена, МассивИсключенияНоменклатуры, СпособОбменаСМагазином)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если ОписаниеНоменклатуры = Неопределено Тогда
			// Техническая ошибка
			ТоварПредставление = ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( КлючТовара );
			
			ОшибкаТекст = "ОбработатьТоварыПриВыгрузке: Техническая ошибка: КлючТовара не найден в СоответствиеИдентификаторов: "
			+ ТоварПредставление;
			
			УчетнаяЗапись = ОбменСВнешнимиСистемамиЛогирование.ПолучитьЗначениеПоля( ОписаниеУзелОбмена, "Ссылка", Неопределено );
			...
			ЛогПараметры.Вставить( "ДанныеСсылка", КлючТовара );
			
			ОбменСВнешнимиСистемамиЛогирование.ЗаписатьВЛог( ОшибкаТекст, УчетнаяЗапись, Истина, ЛогПараметры );
			Продолжить;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ИдентификаторФайлКартинки)
			...
			ЛогПараметры.Вставить( "ДанныеСсылка", КлючТовара );
			ТоварПредставление = ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( КлючТовара );
			ЛогКомментарий = "ОбработатьТоварыПриВыгрузке: Длина наименования должна быть больше 4 символов, "
			+ "описания больше 10 символов и заполнено основное изображение. Товар не выгружен: " + ТоварПредставление;
		...
		НаименованиеТовара = "" + Новый УникальныйИдентификатор;		Если ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.НаименованиеДляПечатиХарактеристика) Тогда			НаименованиеТовара = ?(ОписаниеУзелОбмена.ДобавитьКНаименованиюХарактеристикиНаименованиеНоменклатуры, ВыборкаДетальныеЗаписи.Наименование + ", ", "")			+ СокрЛП(ВыборкаДетальныеЗаписи.НаименованиеДляПечатиХарактеристика);		ИначеЕсли ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.НаименованиеХарактеристика) Тогда			НаименованиеТовара = ?(ОписаниеУзелОбмена.ДобавитьКНаименованиюХарактеристикиНаименованиеНоменклатуры, ВыборкаДетальныеЗаписи.Наименование + ", ", "")			+ СокрЛП(ВыборкаДетальныеЗаписи.НаименованиеХарактеристика);		Иначе			НаименованиеТовара = СокрЛП(ВыборкаДетальныеЗаписи.Наименование);		КонецЕсли;				ОписаниеОсновныхПолей.Вставить("name", ОбработатьНаименование(СокрЛП(НаименованиеТовара)));		
		Если ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.АртикулХарактеристика) Тогда
			ОписаниеОсновныхПолей.Вставить("sku", XMLСтрока(ВыборкаДетальныеЗаписи.АртикулХарактеристика));
		Иначе
...
Функция ОбработатьНаименование(Наименование)
	
	// Некоторые символы на сервере ВКонтакте кодируются не 1 к 1, а по схеме:
	// " - 6 символов
	// & - 5 символов
	// \ - 6 символов
	// ' - 5 символов
	...
	КолСимволов = СтрДлина(Наименование);
	
	НайденныеСпецСимволы = Новый Массив;
	Для Каждого Стр Из ПолучитьМассивЗаменСимволов() Цикл
		
		Стр.ЧислоВхождений = СтрЧислоВхождений(Наименование, Символ(Стр.КодСимвола));
		Если Стр.ЧислоВхождений > 0 Тогда
			КолСимволов = КолСимволов + Стр.ЧислоВхождений * (Стр.Количество - 1);
			НайденныеСпецСимволы.Добавить(Стр);
		КонецЕсли;
		
	КонецЦикла;
	
	Если НайденныеСпецСимволы.Количество() И КолСимволов > 100 Тогда
		
		Для Каждого Стр Из НайденныеСпецСимволы Цикл
			Наименование = СтрЗаменить(Наименование, Символ(Стр.КодСимвола), Символ(Стр.КодСимволаЗамены));
			КолСимволов = КолСимволов - (Стр.ЧислоВхождений * (Стр.Количество - 1));
			
			Если КолСимволов <= 100 Тогда
				Прервать;
			КонецЕсли;
	...
	Возврат XMLСтрока(Наименование);
	
КонецФункции

Функция ПолучитьМассивЗаменСимволов()
	
	Массив = Новый Массив(10);
	
	// Некоторые символы на сервере ВКонтакте кодируются не 1 к 1, а по схеме:
	// № - 7 символов
	Массив[0] = ДобавитьМассивЗаменСимволов(8470, 7, -1, 0);
	// & - 5 символов
	Массив[1] = ДобавитьМассивЗаменСимволов(38, 5, -1, 0);
	// $ - 6 символов
	Массив[2] = ДобавитьМассивЗаменСимволов(36, 6, -1, 0);
	// \ - 6 символов
	Массив[3] = ДобавитьМассивЗаменСимволов(92, 6, 32, 0);
	// , - 5 символов
	Массив[4] = ДобавитьМассивЗаменСимволов(44, 5, -1, 0);
	// ! - 5 символов
	Массив[5] = ДобавитьМассивЗаменСимволов(33, 5, 46, 0);
	// > - по 4 символа
	Массив[6] = ДобавитьМассивЗаменСимволов(62, 4, 96, 0);
	// < - по 4 символа
	Массив[7] = ДобавитьМассивЗаменСимволов(60, 4, 96, 0);
	// ' - 5 символов
	Массив[8] = ДобавитьМассивЗаменСимволов(39, 5, 96, 0);
	// " - 6 символов
	Массив[9] = ДобавитьМассивЗаменСимволов(34, 6, 96, 0);
	
	Возврат Массив;
	
КонецФункции

Функция ДобавитьМассивЗаменСимволов(КодСимвола, Количество, КодСимволаЗамены, ЧислоВхождений)
	
	Структура = Новый Структура;
	Структура.Вставить("КодСимвола", КодСимвола);
	Структура.Вставить("Количество", Количество);
	Структура.Вставить("КодСимволаЗамены", КодСимволаЗамены);
	Структура.Вставить("ЧислоВхождений", ЧислоВхождений);
...
Процедура ОбработатьОстаткиТоваров(СоответствиеИдентификаторов, РезультатЗапросаОстаток, ВыгружатьОстаток)
	
	Если Не ВыгружатьОстаток Тогда
		Возврат;
	КонецЕсли;
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.КоличествоОстаток) Тогда
			ОписаниеНоменклатуры.Вставить("stock_amount", XMLСтрока(Цел(ВыборкаДетальныеЗаписи.КоличествоОстаток)));
		Иначе
			ОписаниеНоменклатуры.Вставить("stock_amount", "0");
		КонецЕсли;
...
Процедура ОбработатьЦеныТоваров(СоответствиеИдентификаторов, РезультатЗапросаЦена, ВыгружатьЦены)
	
	Если Не ВыгружатьЦены Тогда
		Возврат;
	КонецЕсли;
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл 
		...
		Если ВыгружатьЦены Тогда
			...
			Иначе
				ОписаниеНоменклатуры.Вставить("price", "0");
			КонецЕсли;
		КонецЕсли;
		
		Попытка
			Если ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.СтараяЦена) И ВыборкаДетальныеЗаписи.СтараяЦена > ВыборкаДетальныеЗаписи.ОсновнаяЦена Тогда
...
Процедура ПроверитьОбъединитьХарактеристикуВГруппы(МассивХарактеристик, ОписаниеУзелОбмена, СпособОбменаСМагазином)
	...
	Если ОписаниеУзелОбмена.ВариантВыгрузкиХарактеристик =
		...
		Для Каждого ОписаниеОперации Из МассивОперация Цикл
			...
			Если ТипЗнч(МассивНоменклатурДляОбработки) = Тип("Массив") Тогда
...
Процедура УдалитьТоварыПоИдентификаторам(МассивИдентификаторов, УзелИнформационнойБазы)
...
Функция ЗагрузитьФайлVK(ОписаниеУзелОбмена, ОписаниеФайла, ЭтоОсновнойФайл = Ложь, СтруктураЗапросаHTTPДляФайла) Экспорт
	...
	Если НЕ (ТипЗнч(ОписаниеФайла.Высота) = Тип("Число") И ТипЗнч(ОписаниеФайла.Ширина) = Тип("Число")) Тогда
		Возврат Неопределено;
	КонецЕсли;
	...
	ПараметрыКонтекст.Вставить( "ТелоСтроковоеПредставление", "<Двоичные данные>" );
	ПараметрыКонтекст.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.ВыгрузкаИзображенийИз1С );
	
	ОтветСоответствие = ВыполнитьЗапросИПроверить(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, "", , , , ПараметрыКонтекст );
	Если ОтветСоответствие = Неопределено Тогда
		Возврат Неопределено;
	КонецЕсли;
...
Функция ПолучитьКатегорийТоваров(ОписаниеУзелОбмена) Экспорт
	...
	// Метод /method/market.getCategories работает некорректно, возвращает только некоторые устаревшие категории,
	// техническая поддержка ВКонтакте не называет сроки исправления
...
Функция ПолучитьИспользуемыеКатегорииТоваров(ОписаниеУзелОбмена, МассивТоваров = Неопределено) Экспорт
...
Функция ПолучитьПодборкиТоваров(ОписаниеУзелОбмена) Экспорт
	...
	ПараметрыКонтекст = Новый Структура;
	ПараметрыКонтекст.Вставить( "УчетнаяЗапись", ОбменСВнешнимиСистемамиЛогирование.ПолучитьЗначениеПоля( ОписаниеУзелОбмена, "Ссылка", Неопределено ));
	ПараметрыКонтекст.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.Прочее );
	
	РезультатМассив = ПолучитьОбщиеДанныеРекурсивно(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса, , , , ПараметрыКонтекст );
...
Функция ИзменитьЗаказы(ОписаниеУзелОбмена) Экспорт
	...
	|	ИнтеграцияСМагазинамиСоцСетейСтатусыЗаказов.КодСтатуса КАК КодСтатуса,
	|	ИнтеграцияСМагазинамиСоцСетейСтатусыЗаказов.СостояниеЗаказаПокупателя КАК СостояниеЗаказаПокупателя,
	|	ЗНАЧЕНИЕ(Перечисление.ВариантыЗавершенияЗаказа.ПустаяСсылка) КАК ВариантЗавершения
	...
	|	И НЕ ИнтеграцияСМагазинамиСоцСетейСтатусыЗаказов.КодСтатуса В (""4"", ""5"")
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	""4"",
	|	ЗНАЧЕНИЕ(Справочник.СостоянияЗаказовПокупателей.Завершен),
	|	ЗНАЧЕНИЕ(Перечисление.ВариантыЗавершенияЗаказа.Успешно)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	""5"",
	|	ЗНАЧЕНИЕ(Справочник.СостоянияЗаказовПокупателей.Завершен),
	|	ЗНАЧЕНИЕ(Перечисление.ВариантыЗавершенияЗаказа.Отменен)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ_НовыеСтатусы.Заказ КАК Заказ,
	|	ВТ_НовыеСтатусы.Идентификатор КАК Идентификатор,
	|	ВТ_НовыеСтатусы.КодСтатусаМагазинаОтправленный КАК КодСтатусаМагазинаОтправленный,
	|	ВТ_НовыеСтатусы.СостояниеЗаказа КАК СостояниеЗаказа,
	|	ВТ_НовыеСтатусы.ВариантЗавершения КАК ВариантЗавершения,
	|	ВТ_Статусы.КодСтатуса КАК КодСтатусаМагазина
	|ИЗ
	|	ВТ_НовыеСтатусы КАК ВТ_НовыеСтатусы
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_Статусы КАК ВТ_Статусы
	|		ПО ВТ_НовыеСтатусы.СостояниеЗаказа = ВТ_Статусы.СостояниеЗаказаПокупателя
	|			И ВТ_НовыеСтатусы.ВариантЗавершения = ВТ_Статусы.ВариантЗавершения
	|ГДЕ
	|	ВТ_НовыеСтатусы.КодСтатусаМагазинаОтправленный <> ВТ_Статусы.КодСтатуса
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
Процедура ЗагрузитьЗаказы(ОписаниеУзелОбмена) Экспорт
	...
	Если ЗначениеЗаполнено(ОписаниеУзелОбмена.ИдентификаторЗаказа) Тогда
		ОписаниеПроверкиЗначения = Новый Структура("display_order_id", ОписаниеУзелОбмена.ИдентификаторЗаказа);
	Иначе
		ОписаниеПроверкиЗначения = Неопределено;
	КонецЕсли;

	ПараметрыКонтекст = Новый Структура;
	ПараметрыКонтекст.Вставить( "УчетнаяЗапись", ОбменСВнешнимиСистемамиЛогирование.ПолучитьЗначениеПоля( ОписаниеУзелОбмена, "Ссылка", Неопределено ));
	ПараметрыКонтекст.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.ЗагрузкаЗаказовВ1С );
	
	РезультатМассив = ПолучитьОбщиеДанныеРекурсивно(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, 
	АдресРесурса, 0, Истина, ОписаниеПроверкиЗначения, ПараметрыКонтекст);
	...
	Для Каждого ОписаниеЗаказа Из РезультатМассив Цикл
		...
		АдресРесурса = "/method/market.getOrderItems";
		ЗаполнитьОсновныеПараметры(АдресРесурса,ОписаниеУзелОбмена);
		
		АдресРесурса = АдресРесурса + СтрШаблон("&extended=1&user_id=%1&order_id=%2", XMLСтрока(ОписаниеЗаказа.Получить("user_id")), XMLСтрока(ОписаниеЗаказа.Получить("id")));
		
		СтруктураЗапросаHTTP = ПодготовитьHTTPЗапрос(АдресРесурса);

		РезультатМассивТоваров = ПолучитьОбщиеДанныеРекурсивно(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, 
		АдресРесурса, 0, Истина, , ПараметрыКонтекст );
		
		ВалютаДокумента = ОписаниеУзелОбмена.ВалютаПоУмолчанию;
		
		ТоварыУслуги = Новый Массив;
		СуммаТоваров = 0;
		Для Каждого ОписаниеСтроки Из РезультатМассивТоваров Цикл
		...
		СтруктураЗаказа.Вставить("status" , XMLСтрока(ИнтеграцияСМагазинамиСоцСетейСервер.ПроверитьНаТипЗначение(ОписаниеЗаказа.Получить("status"),Тип("Число"),0)));
		Если СтруктураЗаказа.status = "5" Тогда
			СтруктураЗаказа.Вставить("СостояниеЗаказа" , Справочники.СостоянияЗаказовПокупателей.Завершен);
			СтруктураЗаказа.Вставить("ВариантЗавершения" , Перечисления.ВариантыЗавершенияЗаказа.Отменен);
			СтруктураЗаказа.Вставить("ПричинаОтмены" , ОписаниеУзелОбмена.ПричинаОтмены);
		ИначеЕсли СтруктураЗаказа.status = "4" Тогда
			СтруктураЗаказа.Вставить("СостояниеЗаказа" , Справочники.СостоянияЗаказовПокупателей.Завершен);
			СтруктураЗаказа.Вставить("ВариантЗавершения" , Перечисления.ВариантыЗавершенияЗаказа.Успешно);
		Иначе
			СтруктураЗаказа.Вставить("СостояниеЗаказа" , ОписаниеУзелОбмена.СтатусыЗаказов.Получить(СтруктураЗаказа.status));
			
			Если Не ЗначениеЗаполнено(СтруктураЗаказа.СостояниеЗаказа) Тогда
				СтруктураЗаказа.Удалить("СостояниеЗаказа");
			КонецЕсли;
		...
		СтруктураЗаказа.Вставить("ИсточникПривлечения" , ОписаниеУзелОбмена.ИсточникДляПодстановкиВЗаказы);
		СтруктураЗаказа.Вставить("КраткийНомер" , ПолучитьИдентификаторСтрокой(ОписаниеЗаказа.Получить("id")));
		
		Если ЗначениеЗаполнено(ОписаниеУзелОбмена.СкладДляПодстановкиВЗаказы) Тогда
			СтруктураЗаказа.Вставить("СтруктурнаяЕдиницаРезерв" , ОписаниеУзелОбмена.СкладДляПодстановкиВЗаказы);
		КонецЕсли;
	...
	Если МассивСтрок.Количество() Тогда
		...
		МассивНоменклатурДляОбработки = Новый Массив;
		МассивПовторений = ВернутьМассивИзВложений(МассивСтрок, 75);
		Для Каждого МассивСтрок Из МассивПовторений Цикл
			...
			МассивНоменклатурДляОбработкиПорция = ПолучитьОбщиеДанные(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса);
			Если ТипЗнч(МассивНоменклатурДляОбработкиПорция) = Тип("Массив") Тогда
				Для Каждого ЭлементМассива Из МассивНоменклатурДляОбработкиПорция Цикл
					МассивНоменклатурДляОбработки.Добавить(ЭлементМассива);
				КонецЦикла;
			КонецЕсли;
		КонецЦикла;
	...
	Для Каждого КлючЗначение Из СоответствиеВсехКонтрагентов Цикл
		...
		НовСтр.НомерТелефонаДляПоиска = УбратьРазделителиВНомерТелефона(НовСтр.Телефон);
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если Договор = Неопределено Тогда
			Договор = Справочники.ДоговорыКонтрагентов.ПоДокументуКонтрагентуОрганизацииИВидуОперации(
			ДокументОбъект.Ссылка, ДокументОбъект.Контрагент, ДокументОбъект.Организация,
		...
		Для Каждого СтрТовары Из ОписаниеЗаказа.ТоварыУслуги Цикл 
			...
			Если ОписаниеУзелОбмена.РезервироватьТовар Тогда
				НовСтр.Резерв = СтрТовары.Количество;
			КонецЕсли;
		...
		ЗаполнитьНомерДокументаВКонтакте(ДокументОбъект, ОписаниеЗаказа);
		...
		НоваяЗапись.ЗаказПокупателя = СсылкаНаДокумент;
		НоваяЗапись.НомерЗаказаНаСайте = ВыборкаДетальныеЗаписи.Идентификатор;
		НоваяЗапись.ДатаЗаказаНаСайте = ВыборкаДетальныеЗаписи.Дата;
		НоваяЗапись.УзелОбмена = ОписаниеУзелОбмена.Ссылка;
		...
		Если МассивСпособов.Найти(ОписаниеУзелОбмена.СпособУстановкиДатыОтгрузкиЗаказа) = Неопределено
			...
			Исключение
				...
				ОбработатьОшибку(ОписаниеУзелОбмена, ТекстСообщения);
				ДокументОбъект.Записать(РежимЗаписиДокумента.Запись);
			КонецПопытки;
			ПланыОбмена.УдалитьРегистрациюИзменений(ОписаниеУзелОбмена.Ссылка, СсылкаНаДокумент);
		КонецЕсли;
...
Процедура ЗаполнитьНомерДокументаВКонтакте(ДокументОбъект, ОписаниеЗаказа)
	
	НомерВК = ПолучитьНомерДокументаВКонтакте(ОписаниеЗаказа.КраткийНомер, ДокументОбъект.Организация);
	...
	|	И ЗаказПокупателя.Дата >= &НачалоГода
	|	И ЗаказПокупателя.Дата <= &КонецГода";
	
	Запрос.УстановитьПараметр("НачалоГода", НачалоГода(ДокументОбъект.Дата));
	Запрос.УстановитьПараметр("КонецГода", КонецГода(ДокументОбъект.Дата));
	Запрос.УстановитьПараметр("Номер", НомерВК);
	
	РезультатЗапроса = Запрос.Выполнить();
	
	Если РезультатЗапроса.Пустой() Тогда
		ДокументОбъект.Номер = НомерВК;
	Иначе
...
Функция ПолучитьДатуОбъектыПоПравилу(ОписаниеУзелОбмена, ДатаОбъекта)
	...
	Если ОписаниеУзелОбмена.СпособУстановкиДатыОтгрузкиЗаказа = ПредопределенноеЗначение("Перечисление.СпособыУстановкиДатыДляМагазинаСоцСетей.ТекущаяДата") Тогда
		...
		ДатаОтгрузки = ТекущаяДатаСеанса() + ОписаниеУзелОбмена.СпособУстановкиДатыОтгрузкиЗаказаКоличествоДней * 86400;
...
Функция УбратьРазделителиВНомерТелефона(Знач НомерТелефона)
	...
	Для Н = 1 По СтрДлина(НомерТелефона) Цикл
		ТекСимвол = Сред(НомерТелефона, Н, 1);
...
Функция СоздатьКонтрагента(ОписаниеУзелОбмена, Наименование, МассивКонтактнойИнформации)
	...
	НовыйКонтрагент.ИсточникПривлеченияПокупателя = ОписаниеУзелОбмена.ИсточникДляПодстановкиВЗаказы;
...
Функция ЗагрузитьНоменклатуру(ПараметрыФоновогоЗадания, ФоновоеЗаданиеАдресХранилища = "") Экспорт
	...
	ПараметрыКонтекст = Новый Структура;
	Результат = ОбработатьНоменклатуру(МассивНоменклатурДляОбработки, ОписаниеУзелОбмена, , ПараметрыКонтекст);
...
Функция ПолучитьВсеТоварыИзМагазина(ОписаниеУзелОбмена, ПолучатьВсеДанные = Истина, КраткаяИнформация = Ложь, ПараметрыСтрокой = "") Экспорт
	...
	АдресРесурса = АдресРесурса + СтрШаблон("&with_disabled=1&extended=%1&count=100&owner_id=-%2" + ПараметрыСтрокой, ?(ПолучатьВсеДанные,1,0), ОписаниеУзелОбмена.ИдентификаторГруппы);
	
	СтруктураЗапросаHTTP = ПодготовитьHTTPЗапрос(АдресРесурса);

	ПараметрыКонтекст = Новый Структура;
	ПараметрыКонтекст.Вставить( "УчетнаяЗапись", ОбменСВнешнимиСистемамиЛогирование.ПолучитьЗначениеПоля( ОписаниеУзелОбмена, "Ссылка", Неопределено ));
	ПараметрыКонтекст.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.ЗагрузкаТоваровВ1С );
	
	МассивНоменклатурДляОбработки = ПолучитьОбщиеДанныеРекурсивно(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса, , , , ПараметрыКонтекст);
...
Функция ОбработатьТоварыИзМагазина(ОписаниеУзелОбмена, МассивНоменклатурДляОбработки, ПолучатьВсеДанные = Истина, КраткаяИнформация = Ложь) Экспорт
	...
	Для Каждого КлючЗначение Из СоответствиеХарактеристик Цикл 
		...
		Для Каждого МассивСтрок Из МассивПовторений Цикл 
			...
			Если ТипЗнч(МассивХарактеристикДляОбработки) = Тип("Массив") Тогда
...
Функция ВернутьМассивИзВложений(МассивОригинал, КоличествоЭлементов)
	
	ВсегоЭлементоа = МассивОригинал.Количество();
	
	МассивНовый = Новый Массив;
	МассивПорция = Новый Массив;
	Счетчик = 0;
	Для Каждого ЭлементМассива Из МассивОригинал Цикл
		
		Счетчик = Счетчик + 1;
		МассивПорция.Добавить(ЭлементМассива);
		
		Если Счетчик = КоличествоЭлементов Тогда
			МассивНовый.Добавить(МассивПорция);
			МассивПорция = Новый Массив;
			Счетчик = 0;
		КонецЕсли;
	...
	Если Счетчик <> КоличествоЭлементов И МассивПорция.Количество() Тогда
		МассивНовый.Добавить(МассивПорция);
	КонецЕсли;
...
Функция РазделительНаименованияКатегорийПолучить()
	Возврат " · ";
КонецФункции
...
Функция ОбработатьТовар(ОписаниеТовара, ОписаниеУзелОбмена, КраткаяИнформация = Истина, ЭтоХарактеритика = Ложь) Экспорт
	...
	ОписаниеНоменклатура.Вставить("ИдентификаторыКатегорийОтбор", "");
	
	РазделительИдентификаторовВложенныхКатегорий = РазделительИдентификаторовВложенныхКатегорийПолучить();
	
	НаименованиеКатегорииПолное = "";
	
	ОписаниеКатегории = ОписаниеТовара.Получить("category");
	ВложенныеКатегории = Новый Массив;
	Если ОписаниеКатегории <> Неопределено Тогда
		
		ИдентификаторКатегории = ПолучитьИдентификаторСтрокой(ОписаниеКатегории.Получить("id"));
		НаименованиеКатегории = ОписаниеКатегории.Получить( "name" );
		
		// текущая категория товара
		ОписаниеНоменклатура.Вставить("ИдентификаторКатегории", ИдентификаторКатегории);
		ОписаниеНоменклатура.Вставить("НаименованиеКатегории", НаименованиеКатегории );
		
		НаименованиеКатегорииПолное = НаименованиеКатегории;
		
		// +заполним все вложенные категории товара и текущую в массив
		РазделительНаименованияКатегорий = РазделительНаименованияКатегорийПолучить();
		КатегорияЭлемент = Новый Структура( "ИдентификаторКатегории, НаименованиеКатегории", ИдентификаторКатегории, НаименованиеКатегории );
		ВложенныеКатегории.Добавить( КатегорияЭлемент );
		ИдентификаторыКатегорийОтбор = РазделительИдентификаторовВложенныхКатегорий + ИдентификаторКатегории + РазделительИдентификаторовВложенныхКатегорий;
		
		КатегорияТекущийЭлемент = ОписаниеКатегории.Получить( "parent" );
		Пока КатегорияТекущийЭлемент <> Неопределено Цикл
			
			ИдентификаторКатегории = ПолучитьИдентификаторСтрокой( КатегорияТекущийЭлемент.Получить( "id" ) );
			НаименованиеКатегории = КатегорияТекущийЭлемент.Получить( "name" );
			
			НаименованиеКатегорииПолное = НаименованиеКатегории + РазделительНаименованияКатегорий + НаименованиеКатегорииПолное;
			
			ИдентификаторыКатегорийОтбор = ИдентификаторыКатегорийОтбор + ИдентификаторКатегории + РазделительИдентификаторовВложенныхКатегорий;

			КатегорияЭлемент = Новый Структура( "ИдентификаторКатегории, НаименованиеКатегории", ИдентификаторКатегории, НаименованиеКатегории );
			ВложенныеКатегории.Добавить( КатегорияЭлемент );

			КатегорияТекущийЭлемент = КатегорияТекущийЭлемент.Получить( "parent" );
			
		КонецЦикла;
		ОписаниеНоменклатура.Вставить("ИдентификаторыКатегорийОтбор", ИдентификаторыКатегорийОтбор);
		// -заполним все вложенные категории товара и текущую в массив
		
	КонецЕсли;
	
	ОписаниеНоменклатура.Вставить("ВложенныеКатегории", ВложенныеКатегории);
	ОписаниеНоменклатура.Вставить("НаименованиеКатегории", НаименованиеКатегорииПолное);// Замена на полное наименование
...
Функция ОбработатьНоменклатуру(МассивНоменклатурДляОбработки, ОписаниеУзелОбмена, ЭтоЗагрузкаЗаказа = Ложь, ПараметрыКонтекст = Неопределено )
	
	Если ПараметрыКонтекст = Неопределено Тогда
		ПараметрыКонтекст = Новый Структура;
	КонецЕсли;
	
	ЗагруженныеДанные = Новый ТаблицаЗначений;
	ЗагруженныеДанные.Колонки.Добавить( "Номенклатура", Новый ОписаниеТипов( "СправочникСсылка.Номенклатура" ) );
	ЗагруженныеДанные.Колонки.Добавить( "Характеристика", Новый ОписаниеТипов( "СправочникСсылка.ХарактеристикиНоменклатуры" ) );
	ЗагруженныеДанные.Колонки.Добавить( "СозданаНоменклатура", Новый ОписаниеТипов( "Булево" ) );
	ЗагруженныеДанные.Колонки.Добавить( "СозданаХарактеристика", Новый ОписаниеТипов( "Булево" ) );
	ЗагруженныеДанные.Колонки.Добавить( "Цена", Новый ОписаниеТипов( "Число", Новый КвалификаторыЧисла( 20, 3, ДопустимыйЗнак.Неотрицательный )) );
	ЗагруженныеДанные.Колонки.Добавить( "Остаток", Новый ОписаниеТипов( "Число", Новый КвалификаторыЧисла( 20, 3, ДопустимыйЗнак.Любой )) );
	ЗагруженныеДанные.Колонки.Добавить( "Изображения", Новый ОписаниеТипов( "Массив" ) );
	...
	Для Каждого КлючЗначение Из СоответствиеВсехНоменклатур Цикл 
		...
		Если ЗначениеЗаполнено(ОписаниеНоменклатура.ИдентификаторНоменклатуры) Тогда
			ОписаниеНоменклатура.Вставить("ЭтоНовый" , Ложь);
			Продолжить;
		КонецЕсли;
		...
		Если НоменклатураХарактеристика = Неопределено Тогда 
			...
			ЗагруженныеДанныеСтрока = ЗагруженныеДанные.Добавить();
			ЗагруженныеДанныеСтрока.Номенклатура = НоменклатураОбъект.Ссылка;
			ЗагруженныеДанныеСтрока.СозданаНоменклатура = Истина;
			ЗагруженныеДанныеСтрока.Изображения = Новый Массив;

			НоменклатураПредставление = ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( НоменклатураОбъект );
			ОбщегоНазначения.СообщитьПользователю( "Импорт товаров из ВКонтакте: Записан новый элемент справочника ""Номенклатура"": " + НоменклатураПредставление );
			...
			Если ОбменСВнешнимиСистемамиЛогированиеПовтИсп.ЛогированиеВключено( УчетнаяЗапись ) Тогда
				ЛогКомментарий = "ОбработатьНоменклатуру: Записан новый элемент справочника ""Номенклатура"": " + НоменклатураПредставление;
				ЛогПараметры = Новый Структура;
				ЛогПараметры.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.ЗагрузкаТоваровВ1С );
				ЛогПараметры.Вставить( "ДанныеСсылка", НоменклатураОбъект.Ссылка );
	...
	Для Каждого КлючЗначение Из СоответствиеВсехНоменклатур Цикл 
		...
		Если НоменклатураХарактеристика = Неопределено Тогда 
			...
			ЗагруженныеДанныеСтрока = ЗагруженныеДанные.Добавить();
			ЗагруженныеДанныеСтрока.Номенклатура = ХарактеристикаОбъект.Владелец;
			ЗагруженныеДанныеСтрока.Характеристика = ХарактеристикаОбъект.Ссылка;
			ЗагруженныеДанныеСтрока.СозданаХарактеристика = Истина;
			ЗагруженныеДанныеСтрока.Изображения = Новый Массив;

			ХарактеристикаПредставление = ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( ХарактеристикаОбъект );
			ОбщегоНазначения.СообщитьПользователю( "Импорт товаров из ВКонтакте: Записан новый элемент справочника ""Характеристики номенклатуры"": " + ХарактеристикаПредставление );
			
			УчетнаяЗапись = ОписаниеУзелОбмена.Ссылка;
			Если ОбменСВнешнимиСистемамиЛогированиеПовтИсп.ЛогированиеВключено( УчетнаяЗапись ) Тогда
				ЛогКомментарий = "ОбработатьНоменклатуру: Записан новый элемент справочника ""Характеристики номенклатуры"": " + ХарактеристикаПредставление;
				ЛогПараметры = Новый Структура;
				ЛогПараметры.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.ЗагрузкаТоваровВ1С );
				ЛогПараметры.Вставить( "ДанныеСсылка", ХарактеристикаОбъект.Ссылка );
				ОбменСВнешнимиСистемамиЛогирование.ЗаписатьВЛог( ЛогКомментарий, УчетнаяЗапись, , ЛогПараметры );
			КонецЕсли;
	...
	Если ОписаниеУзелОбмена.ЗагружатьЦены Тогда
		Для Каждого КлючЗначение Из СоответствиеВсехНоменклатур Цикл 
			...
			Если ЗначениеЗаполнено(ОписаниеНоменклатура.ЦенаСтарая)
				...
				ТоварПредставление = ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( МЗ.Номенклатура )
				+ ?(ЗначениеЗаполнено(МЗ.Характеристика), ", " + ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( МЗ.Характеристика ), "" );
				
				ОбщегоНазначения.СообщитьПользователю( "Импорт товаров из ВКонтакте: " + ТоварПредставление + ": Записана цена """ + МЗ.ВидЦен + """: " +  МЗ.Цена );
				
				УчетнаяЗапись = ОписаниеУзелОбмена.Ссылка;
				Если ОбменСВнешнимиСистемамиЛогированиеПовтИсп.ЛогированиеВключено( УчетнаяЗапись ) Тогда
					ЛогКомментарий = "ОбработатьНоменклатуру: " + ТоварПредставление + ": Записана цена """ + МЗ.ВидЦен + """: " +  МЗ.Цена;
					ЛогПараметры = Новый Структура;
					ЛогПараметры.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.ЗагрузкаЦенВ1С );
					ЛогПараметры.Вставить( "ДанныеСсылка", МЗ.Номенклатура );
					ОбменСВнешнимиСистемамиЛогирование.ЗаписатьВЛог( ЛогКомментарий, УчетнаяЗапись, , ЛогПараметры );
				КонецЕсли;
			...
			Если ЗначениеЗаполнено(ОписаниеНоменклатура.Цена)
				...
				ЗагруженныеДанныеСтроки = ЗагруженныеДанные.НайтиСтроки( Новый Структура( "Номенклатура, Характеристика",
				ОписаниеНоменклатура.Номенклатура,  ОписаниеНоменклатура.Характеристика ) );
				Если ЗагруженныеДанныеСтроки.Количество() = 0 Тогда
					ЗагруженныеДанныеСтрока = ЗагруженныеДанные.Добавить();
					ЗагруженныеДанныеСтрока.Номенклатура = ОписаниеНоменклатура.Номенклатура;
					ЗагруженныеДанныеСтрока.Характеристика = ОписаниеНоменклатура.Характеристика;
					ЗагруженныеДанныеСтрока.Изображения = Новый Массив;
				Иначе
					ЗагруженныеДанныеСтрока = ЗагруженныеДанныеСтроки[ 0 ];
				КонецЕсли;
				ЗагруженныеДанныеСтрока.Цена = ОписаниеНоменклатура.Цена;
	...
	Если ОписаниеУзелОбмена.ЗагружатьОстатки И Не ЭтоЗагрузкаЗаказа Тогда
		...
		Для Каждого КлючЗначение Из СоответствиеВсехНоменклатур Цикл 
			...
			Если ОписаниеНоменклатура.Остаток > 0 Тогда
				...
				Иначе
					ЗагруженныеДанныеСтрока = ЗагруженныеДанныеСтроки[ 0 ];
				КонецЕсли;
				ЗагруженныеДанныеСтрока.Остаток = ОписаниеНоменклатура.Остаток;
		...
		Если МассивОстатков.Количество() Тогда
			...
			ДокументВводОстатков.РазделУчета = Перечисления.РазделыУчета.Запасы;
			...
			ДокументПредставление = ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( ДокументВводОстатков );
			
			ОбщегоНазначения.СообщитьПользователю( "Импорт товаров из ВКонтакте: Загрузка остатков товаров: Записан документ: " + ДокументПредставление );
			
			УчетнаяЗапись = ОписаниеУзелОбмена.Ссылка;
			Если ОбменСВнешнимиСистемамиЛогированиеПовтИсп.ЛогированиеВключено( УчетнаяЗапись ) Тогда
				ЛогКомментарий = "ОбработатьНоменклатуру: Загрузка остатков товаров: Записан документ: " + ДокументПредставление;
				ЛогПараметры = Новый Структура;
				ЛогПараметры.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.ЗагрузкаОстатковВ1С );
				ЛогПараметры.Вставить( "ДанныеСсылка", ДокументВводОстатков.Ссылка );
				ОбменСВнешнимиСистемамиЛогирование.ЗаписатьВЛог( ЛогКомментарий, УчетнаяЗапись, , ЛогПараметры );
			КонецЕсли;
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если ВыборкаДетальныеЗаписи.ТребуетсяСоздать Тогда
			...
			ЗагруженныеДанныеСтроки = ЗагруженныеДанные.НайтиСтроки( Новый Структура( "Номенклатура, Характеристика",
			ВыборкаДетальныеЗаписи.Номенклатура,  ВыборкаДетальныеЗаписи.Характеристика ) );
			Если ЗагруженныеДанныеСтроки.Количество() = 0 Тогда
				ЗагруженныеДанныеСтрока = ЗагруженныеДанные.Добавить();
				ЗагруженныеДанныеСтрока.Номенклатура = ВыборкаДетальныеЗаписи.Номенклатура;
				ЗагруженныеДанныеСтрока.Характеристика = ВыборкаДетальныеЗаписи.Характеристика;
				ЗагруженныеДанныеСтрока.Изображения = Новый Массив;
			Иначе
				ЗагруженныеДанныеСтрока = ЗагруженныеДанныеСтроки[ 0 ];
			КонецЕсли;
			ЗагруженныеДанныеСтрока.Изображения.Добавить( ФайлКартинки );
	...
	ПараметрыКонтекст.Вставить( "ЗагруженныеДанные", ОбщегоНазначения.ТаблицаЗначенийВМассив( ЗагруженныеДанные ) );

	ДлительныеОперации.СообщитьПрогресс(100, "Обработка завершена успешно.", ПараметрыКонтекст );
...
Функция СоздатьФайлИзВнешнейСистемы(ОписаниеУзелОбмена, ОписаниеФайла, ВладелецФайлов, Характеристика = Неопределено, ЭтоФайлВиртуальногоКаталога = Ложь) Экспорт
	...
	ВладелецФайловПредставление = ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( ВладелецФайлов );
	ФайлКартинкиПредставление = ОбменСВнешнимиСистемамиЛогирование.ОбъектПредставление( ФайлКартинки );
	ОбщегоНазначения.СообщитьПользователю( "Импорт товаров из ВКонтакте: " + ВладелецФайловПредставление + ": Записан новый файл: " + ФайлКартинкиПредставление );
	
	УчетнаяЗапись = ОписаниеУзелОбмена.Ссылка;
	Если ОбменСВнешнимиСистемамиЛогированиеПовтИсп.ЛогированиеВключено( УчетнаяЗапись ) Тогда
		ЛогКомментарий = "СоздатьФайлИзВнешнейСистемы:  " + ВладелецФайловПредставление + ": Записан новый файл: " + ФайлКартинкиПредставление;
		ЛогПараметры = Новый Структура;
		ЛогПараметры.Вставить( "Действие", Перечисления.ОбменСВнешнимиСистемамиЛогированиеДействия.ЗагрузкаИзображенийВ1С );
		ЛогПараметры.Вставить( "ДанныеСсылка", ФайлКартинки );
		ОбменСВнешнимиСистемамиЛогирование.ЗаписатьВЛог( ЛогКомментарий, УчетнаяЗапись, , ЛогПараметры );
	КонецЕсли;
	...
	Исключение
		...
		ЛогКомментарий = "СоздатьФайлИзВнешнейСистемы: " + ВладелецФайловПредставление
		+ ": Ошибка при получении размеров изображения: " + ФайлКартинкиПредставление
		+ ": " + ТекстОшибки;
	...
	ДобавитьДополнительныеПоляФайлам(ФайлКартинки, КартинкаВысота, КартинкаШирина);
...
Функция ПолучитьОбщиеДанныеРекурсивно(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса, знач Смещение = 0, знач ИспользоватьСмещение = Истина, 
ОписаниеПроверкиЗначения = Неопределено, ПараметрыКонтекст = Неопределено)
	
	Результат = Новый Массив;
	
	Пока Истина Цикл 
		
		РезультатДанные = ПолучитьОбщиеДанные(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса, Смещение, Истина, ПараметрыКонтекст);
		...
		Если ОписаниеПроверкиЗначения <> Неопределено Тогда
			
			ПрерватьОперацию = Ложь;
			
			Для Каждого СтрРезультат Из РезультатДанные Цикл
				
				Для Каждого КлючЗначение Из ОписаниеПроверкиЗначения Цикл
					
					ЗначениеПроверки = СтрРезультат.Получить(КлючЗначение.Ключ);
					Если ЗначениеПроверки <> Неопределено И ЗначениеПроверки = КлючЗначение.Значение Тогда
						ПрерватьОперацию = Истина;
					КонецЕсли;
				КонецЦикла;
			КонецЦикла;
			
			Если ПрерватьОперацию Тогда
				Прервать;
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
...
Функция ПолучитьОбщиеДанные(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса, Смещение = 0, ИспользоватьСмещение = Ложь, ПараметрыКонтекст = Неопределено) Экспорт
	
	ОтветСоответствие = ВыполнитьЗапросИПроверить_ПолучитьОтвет(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса, Смещение, ИспользоватьСмещение, , ПараметрыКонтекст);
	Если ОтветСоответствие = Неопределено Тогда
		Возврат Неопределено;
	КонецЕсли;
...
ПараметрыКонтекст = Неопределено)
	...
	РезультатСоответствие = ИнтеграцияСМагазинамиСоцСетейСервер.ВыполнитьHTTPЗапросОбработатьJSON(СтруктураЗапросаHTTP, ПараметрыКонтекст );
...
Функция ВыполнитьЗапросИПроверить_ПолучитьОтвет(ОписаниеУзелОбмена,СтруктураЗапросаHTTP, АдресРесурса, Смещение = 0, ИспользоватьСмещение = Ложь, 
ОповещатьПользователя = Истина, ПараметрыКонтекст = Неопределено)
	
	РезультатСоответствие = ВыполнитьЗапросИПроверить(ОписаниеУзелОбмена, СтруктураЗапросаHTTP, АдресРесурса, Смещение, ИспользоватьСмещение, ОповещатьПользователя, ПараметрыКонтекст);
	Если РезультатСоответствие = Неопределено Тогда
		Возврат Неопределено;
	КонецЕсли;
...
Функция ПодготовитьHTTPЗапрос(АдресРесурса , ИмяМетода = "get") Экспорт
	...
	СтруктураЗапросаHTTP.ИнтервалОжиданияПередПовторением = 2;
