...
Функция ВариантыНастроек() Экспорт 
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "ОплатаСБП", 
		НСтр("ru = 'Оплата СБП'")));
	Возврат Результат;
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ОплатаСБП, "ОплатаСБП");
	Вариант.Описание = НСтр("ru = 'Отчет отображает сведения о продажах по сервису быстрых платежей в розничной торговле.'");
