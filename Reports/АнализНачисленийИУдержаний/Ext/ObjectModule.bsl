...
Процедура ПередНачаломКомпоновкиРезультата()
	...
	ДобавитьПолеГоловнаяОрганизация();
...
Процедура ДобавитьПолеГоловнаяОрганизация()
	
	ПолеГоловнаяОрганизация = СхемаКомпоновкиДанных.ВычисляемыеПоля.Найти("Организация.ГоловнаяОрганизация");
	Если ПолеГоловнаяОрганизация = Неопределено Тогда
		ПолеГоловнаяОрганизация = СхемаКомпоновкиДанных.ВычисляемыеПоля.Добавить();
		ПолеГоловнаяОрганизация.Выражение = "ВЫБОР КОГДА ПолучитьФункциональнуюОпцию(""ИспользоватьНесколькоОрганизаций"") ТОГДА Организация.ГоловнаяОрганизация ИНАЧЕ Организация КОНЕЦ";
		ПолеГоловнаяОрганизация.Заголовок = "Организация.Головная организация";
		ПолеГоловнаяОрганизация.ПутьКДанным = "Организация.ГоловнаяОрганизация";
	КонецЕсли;
