...
Процедура ПриЗагрузкеВариантаНаСервере(Настройки)
	...
	Если ЗначениеЗаполнено(ЭтаФорма.ОрганизацияБизнесСетиСсылка) Тогда
		...
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.УстановитьЗначениеПараметра("ПараметрОрганизация", ЭтаФорма.ОрганизацияБизнесСетиСсылка);
	//!!!!! УНФ -
	Иначе
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	//!!!!! УНФ +
	Если ЗначениеЗаполнено(Параметры.ОрганизацияБизнесСетиСсылка) Тогда
		ЭтаФорма.ОрганизацияБизнесСетиСсылка = Параметры.ОрганизацияБизнесСетиСсылка;
	КонецЕсли;
	//!!!!! УНФ -
КонецПроцедуры
